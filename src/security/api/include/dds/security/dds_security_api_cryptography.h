...
typedef DDS_Security_boolean (*DDS_Security_crypto_transform_encode_datawriter_submessage)(
  ...
  DDS_Security_long * receiving_datareader_crypto_list_index, DDS_Security_SecurityException * ex);
...
typedef DDS_Security_boolean (*DDS_Security_crypto_transform_encode_rtps_message)(
  ...
  DDS_Security_long * receiving_participant_crypto_list_index, DDS_Security_SecurityException * ex);
...
typedef DDS_Security_boolean (*DDS_Security_crypto_transform_decode_datareader_submessage)(
  dds_security_crypto_transform * instance, DDS_Security_OctetSeq * plain_rtps_message,
