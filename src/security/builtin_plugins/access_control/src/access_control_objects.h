...
#define ACCESS_CONTROL_OBJECT_HANDLE(o) \
  ((o) ? ACCESS_CONTROL_OBJECT(o)->handle : DDS_SECURITY_HANDLE_NIL)
...
void access_control_table_remove_object(
  struct AccessControlTable * table, AccessControlObject * object);
AccessControlObject * access_control_table_remove(
  struct AccessControlTable * table, int64_t handle);
