...
static int set_remote_datawriter_tokens(void)
{
  ...
  if (result) result = retrieve_datawriter_keys(&tokens);
...
static int set_remote_datareader_tokens(void)
{
  ...
  result = crypto->crypto_key_exchange->create_local_datareader_crypto_tokens(
    crypto->crypto_key_exchange, &tokens, local_reader_crypto, remote_writer_crypto, &exception);

  if (result) result = retrieve_datareader_keys(&tokens);
  if (result) {
    result = crypto->crypto_key_exchange->set_remote_datareader_crypto_tokens(
      crypto->crypto_key_exchange, local_writer_crypto, remote_reader_crypto, &tokens, &exception);
  }
...
static void suite_preprocess_secure_submsg_init(void)
{
  ...
  CU_ASSERT_FATAL(
    (plugins = load_plugins(
       NULL /* Access Control */, NULL /* Authentication */, &crypto /* Cryptography   */, NULL)) !=
    NULL);
...
static void suite_preprocess_secure_submsg_fini(void)
{
  ...
  if (remote_writer_crypto) {
    crypto->crypto_key_factory->unregister_datawriter(
      crypto->crypto_key_factory, remote_writer_crypto, &exception);
    reset_exception(&exception);
  }
  if (remote_reader_crypto) {
    crypto->crypto_key_factory->unregister_datareader(
      crypto->crypto_key_factory, remote_reader_crypto, &exception);
    reset_exception(&exception);
  }
  if (local_reader_crypto) {
    crypto->crypto_key_factory->unregister_datareader(
      crypto->crypto_key_factory, local_reader_crypto, &exception);
    reset_exception(&exception);
  }
  if (local_writer_crypto) {
    crypto->crypto_key_factory->unregister_datawriter(
      crypto->crypto_key_factory, local_writer_crypto, &exception);
    reset_exception(&exception);
  }
...
static void create_encoded_submsg(
  DDS_Security_OctetSeq * msg, DDS_Security_CryptoTransformKeyId key_id,
  DDS_Security_CryptoTransformKind transform_kind, unsigned char msg_id,
...
CU_Test(
  ...
  .init = suite_preprocess_secure_submsg_init, .fini = suite_preprocess_secure_submsg_fini)
{
  DDS_Security_boolean result;
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  ...
  create_encoded_submsg(
    &message, writer_key_message.sender_key_id, writer_key_message.transformation_kind,
    VALID_DDSI_RTPS_SMID_SEC_PREFIX, DDSRT_BOSEL_NATIVE);

  result = crypto->crypto_transform->preprocess_secure_submsg(
    crypto->crypto_transform, &writer_crypto, &reader_crypto, &category, &message,
    local_participant_handle, remote_participant_handle, &exception);

  if (!result)
    printf(
      "preprocess_secure_submsg: %s\n",
      exception.message ? exception.message : "Error message missing");
  ...
  create_encoded_submsg(
    &message, writer_key_message.sender_key_id, writer_key_message.transformation_kind,
    VALID_DDSI_RTPS_SMID_SEC_PREFIX, DDSRT_BOSEL_BE);
...
CU_Test(
  ddssec_builtin_preprocess_secure_submsg, reader_happy_day,
  .init = suite_preprocess_secure_submsg_init, .fini = suite_preprocess_secure_submsg_fini)
{
  DDS_Security_boolean result;
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  ...
  create_encoded_submsg(
    &message, reader_key_message.sender_key_id, reader_key_message.transformation_kind,
    VALID_DDSI_RTPS_SMID_SEC_PREFIX, DDSRT_BOSEL_NATIVE);
...
CU_Test(
  ddssec_builtin_preprocess_secure_submsg, invalid_args,
  .init = suite_preprocess_secure_submsg_init, .fini = suite_preprocess_secure_submsg_fini)
{
  DDS_Security_boolean result;
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  ...
  create_encoded_submsg(
    &message, writer_key_message.sender_key_id, reader_key_message.transformation_kind,
    VALID_DDSI_RTPS_SMID_SEC_PREFIX, DDSRT_BOSEL_NATIVE);

  /* remote_participant_handle = DDS_SECURITY_HANDLE_NIL */
  result = crypto->crypto_transform->preprocess_secure_submsg(
    crypto->crypto_transform, &writer_crypto, &reader_crypto, &category, &message,
    local_participant_handle, 0, &exception);
  ...
  result = crypto->crypto_transform->preprocess_secure_submsg(
    crypto->crypto_transform, &writer_crypto, &reader_crypto, &category, &message,
    local_participant_handle, 1, &exception);
...
CU_Test(
  ddssec_builtin_preprocess_secure_submsg, invalid_message,
  .init = suite_preprocess_secure_submsg_init, .fini = suite_preprocess_secure_submsg_fini)
{
  DDS_Security_boolean result;
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  ...
  /* unknown key id */
  create_encoded_submsg(
    &message, writer_key_payload.sender_key_id, writer_key_payload.transformation_kind,
    VALID_DDSI_RTPS_SMID_SEC_PREFIX, DDSRT_BOSEL_NATIVE);
  result = crypto->crypto_transform->preprocess_secure_submsg(
    crypto->crypto_transform, &writer_crypto, &reader_crypto, &category, &message,
    local_participant_handle, remote_participant_handle, &exception);
  ...
  /* invalid transformation kind */
  {
    ...
    create_encoded_submsg(
      &message, writer_key_message.sender_key_id, kind, VALID_DDSI_RTPS_SMID_SEC_PREFIX,
      DDSRT_BOSEL_NATIVE);
  ...
  /* not expected submessage id */
  {
    DDS_Security_CryptoTransformKind kind = {5, 1, 3, 6};
    create_encoded_submsg(
      &message, writer_key_message.sender_key_id, kind, INVALID_DDSI_RTPS_SMID_SEC_PREFIX,
      DDSRT_BOSEL_NATIVE);
    result = crypto->crypto_transform->preprocess_secure_submsg(
      crypto->crypto_transform, &writer_crypto, &reader_crypto, &category, &message,
      local_participant_handle, remote_participant_handle, &exception);
...
CU_Test(
  ddssec_builtin_preprocess_secure_submsg, volatile_secure,
  .init = suite_preprocess_secure_submsg_init, .fini = suite_preprocess_secure_submsg_fini)
{
  DDS_Security_boolean result;
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  ...
  local_writer_crypto_vol = crypto->crypto_key_factory->register_local_datawriter(
    crypto->crypto_key_factory, local_participant_handle, &datawriter_properties,
    &datawriter_security_attributes, &exception);
  CU_ASSERT_FATAL(local_writer_crypto_vol != 0);

  local_reader_crypto_vol = crypto->crypto_key_factory->register_local_datareader(
    crypto->crypto_key_factory, local_participant_handle, &datareader_properties,
    &datareader_security_attributes, &exception);
  CU_ASSERT_FATAL(local_reader_crypto_vol != 0);

  remote_writer_crypto_vol = crypto->crypto_key_factory->register_matched_remote_datawriter(
    crypto->crypto_key_factory, local_reader_crypto_vol, remote_participant_handle,
    shared_secret_handle, &exception);
  CU_ASSERT_FATAL(remote_writer_crypto_vol != 0);

  remote_reader_crypto_vol = crypto->crypto_key_factory->register_matched_remote_datareader(
    crypto->crypto_key_factory, local_writer_crypto_vol, remote_participant_handle,
    shared_secret_handle, true, &exception);
  CU_ASSERT_FATAL(remote_reader_crypto_vol != 0);

  create_encoded_submsg(
    &message, key_id, reader_key_message.transformation_kind, VALID_DDSI_RTPS_SMID_SEC_PREFIX,
    DDSRT_BOSEL_NATIVE);
  ...
  CU_ASSERT(exception.code == 0);
  CU_ASSERT(exception.message == NULL);
  CU_ASSERT(((remote_datawriter_crypto *)writer_crypto)
              ->is_builtin_participant_volatile_message_secure_writer);
  CU_ASSERT(((local_datareader_crypto *)reader_crypto)
              ->is_builtin_participant_volatile_message_secure_reader);
  CU_ASSERT(category == DDS_SECURITY_DATAWRITER_SUBMESSAGE);
  ...
  if (remote_writer_crypto_vol) {
    crypto->crypto_key_factory->unregister_datawriter(
      crypto->crypto_key_factory, remote_writer_crypto_vol, &exception);
    reset_exception(&exception);
  }
  if (remote_reader_crypto_vol) {
    crypto->crypto_key_factory->unregister_datareader(
      crypto->crypto_key_factory, remote_reader_crypto_vol, &exception);
    reset_exception(&exception);
  }
  if (local_reader_crypto_vol) {
    crypto->crypto_key_factory->unregister_datareader(
      crypto->crypto_key_factory, local_reader_crypto_vol, &exception);
    reset_exception(&exception);
  }
  if (local_writer_crypto_vol) {
    crypto->crypto_key_factory->unregister_datawriter(
      crypto->crypto_key_factory, local_writer_crypto_vol, &exception);
    reset_exception(&exception);
  }
