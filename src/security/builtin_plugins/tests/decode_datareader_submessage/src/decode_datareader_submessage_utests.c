...
static void prepare_endpoint_security_attributes_and_properties(
  DDS_Security_EndpointSecurityAttributes * attributes, DDS_Security_PropertySeq * properties,
  ...
  DDS_Security_DatareaderCryptoHandle nodeB_remote_reader_crypto)
{
  ...
  result = crypto->crypto_key_exchange->create_local_datareader_crypto_tokens(
    crypto->crypto_key_exchange, &tokens, nodeA_local_reader_crypto, nodeA_remote_writer_crypto,
    &exception);

  if (result) {
    result = crypto->crypto_key_exchange->set_remote_datareader_crypto_tokens(
      crypto->crypto_key_exchange, nodeB_local_writer_crypto, nodeB_remote_reader_crypto, &tokens,
      &exception);
  }
  ...
  if (result) {
    result = crypto->crypto_key_exchange->create_local_datawriter_crypto_tokens(
      crypto->crypto_key_exchange, &tokens, nodeB_local_writer_crypto, nodeB_remote_reader_crypto,
      &exception);
  }

  if (result) {
    result = crypto->crypto_key_exchange->set_remote_datawriter_crypto_tokens(
      crypto->crypto_key_exchange, nodeA_local_reader_crypto, nodeA_remote_writer_crypto, &tokens,
      &exception);
  }
...
static void set_submsg_header(
  struct submsg_header * submsg, unsigned char id, unsigned char flags, uint16_t length)
{
  submsg->id = id;
  submsg->flags = flags;
  ...
  DDS_Security_CryptoTransformKind_Enum transformation_kind)
{
  ...
  prepare_endpoint_security_attributes_and_properties(
    &datareader_security_attributes, &datareader_properties, transformation_kind, false);
  prepare_endpoint_security_attributes_and_properties(
    &datawriter_security_attributes, &datawriter_properties, transformation_kind, false);

  nodeA_local_reader_crypto =
    register_local_datareader(&datareader_security_attributes, &datareader_properties);
  CU_ASSERT_FATAL(nodeA_local_reader_crypto != 0);

  nodeB_local_writer_crypto =
    register_local_datawriter(&datawriter_security_attributes, &datawriter_properties);
  ...
  result = set_remote_datareader_tokens(
    nodeA_local_reader_crypto, nodeA_remote_writer_crypto, nodeB_local_writer_crypto,
  ...
  result = crypto->crypto_transform->encode_datareader_submessage(
    crypto->crypto_transform, &encoded_buffer, &plain_buffer, nodeA_local_reader_crypto,
    &writer_list, &exception);

  if (!result) {
    printf(
      "encode_datareader_submessage: %s\n",
      exception.message ? exception.message : "Error message missing");
  }
  ...
  result = crypto->crypto_transform->decode_datareader_submessage(
    crypto->crypto_transform, &decoded_buffer, &encoded_buffer, nodeB_local_writer_crypto,
    nodeB_remote_reader_crypto, &exception);

  if (!result) {
    printf(
      "decode_datareader_submessage: %s\n",
      exception.message ? exception.message : "Error message missing");
  }
...
CU_Test(
  ddssec_builtin_decode_datareader_submessage, encoded_256,
...
CU_Test(
  ddssec_builtin_decode_datareader_submessage, encoded_128,
  .init = suite_decode_datareader_submessage_init, .fini = suite_decode_datareader_submessage_fini)
{
...
CU_Test(
  ddssec_builtin_decode_datareader_submessage, not_encoded_256,
  .init = suite_decode_datareader_submessage_init, .fini = suite_decode_datareader_submessage_fini)
{
...
CU_Test(
  ddssec_builtin_decode_datareader_submessage, not_encoded_128,
  .init = suite_decode_datareader_submessage_init, .fini = suite_decode_datareader_submessage_fini)
{
  ...
  DDS_Security_CryptoTransformKind_Enum transformation_kind)
{
  ...
  prepare_endpoint_security_attributes_and_properties(
    &datareader_security_attributes, &datareader_properties, transformation_kind, true);
  prepare_endpoint_security_attributes_and_properties(
    &datawriter_security_attributes, &datawriter_properties, transformation_kind, true);
  ...
  for (i = 0; i < LIST_SIZE; i++) {
    ...
    result = set_remote_datareader_tokens(
      local_reader_crypto, remote_writer_crypto, local_writer_crypto, remote_reader_crypto);
    CU_ASSERT_FATAL(result);
  ...
  result = crypto->crypto_transform->encode_datareader_submessage(
    crypto->crypto_transform, &encoded_buffer, &plain_buffer, local_reader_crypto,
    &remote_writer_list, &exception);
  ...
  for (i = 0; i < LIST_SIZE; i++) {
    result = crypto->crypto_transform->decode_datareader_submessage(
      crypto->crypto_transform, &decoded_buffer, &encoded_buffer, local_writer_list._buffer[i],
      remote_reader_list._buffer[i], &exception);
...
CU_Test(
  ddssec_builtin_decode_datareader_submessage, signed_256,
  .init = suite_decode_datareader_submessage_init, .fini = suite_decode_datareader_submessage_fini)
{
...
CU_Test(
  ddssec_builtin_decode_datareader_submessage, signed_128,
  .init = suite_decode_datareader_submessage_init, .fini = suite_decode_datareader_submessage_fini)
{
...
CU_Test(
  ddssec_builtin_decode_datareader_submessage, only_signed_256,
  .init = suite_decode_datareader_submessage_init, .fini = suite_decode_datareader_submessage_fini)
{
...
CU_Test(
  ddssec_builtin_decode_datareader_submessage, only_signed_128,
  .init = suite_decode_datareader_submessage_init, .fini = suite_decode_datareader_submessage_fini)
{
...
CU_Test(
  ddssec_builtin_decode_datareader_submessage, invalid_args,
  .init = suite_decode_datareader_submessage_init, .fini = suite_decode_datareader_submessage_fini)
{
  DDS_Security_boolean result;
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  ...
  prepare_endpoint_security_attributes_and_properties(
    &datareader_security_attributes, &datareader_properties, CRYPTO_TRANSFORMATION_KIND_AES256_GMAC,
    false);
  prepare_endpoint_security_attributes_and_properties(
    &datawriter_security_attributes, &datawriter_properties, CRYPTO_TRANSFORMATION_KIND_AES256_GMAC,
    false);
  ...
  /* Encrypt the datawriter submessage. */
  result = crypto->crypto_transform->encode_datareader_submessage(
    crypto->crypto_transform, &encoded_buffer, &plain_buffer, local_reader_crypto, &writer_list,
    &exception);
  ...
  result = crypto->crypto_transform->decode_datareader_submessage(
    crypto->crypto_transform, &decoded_buffer, &encoded_buffer, 0, remote_reader_crypto,
    &exception);
  ...
  result = crypto->crypto_transform->decode_datareader_submessage(
    crypto->crypto_transform, &decoded_buffer, &encoded_buffer, 1, remote_reader_crypto,
    &exception);
  ...
  result = crypto->crypto_transform->decode_datareader_submessage(
    crypto->crypto_transform, &decoded_buffer, &encoded_buffer, local_writer_crypto, 0, &exception);
  ...
  result = crypto->crypto_transform->decode_datareader_submessage(
    crypto->crypto_transform, &decoded_buffer, &encoded_buffer, local_writer_crypto, 1, &exception);
...
CU_Test(
  ddssec_builtin_decode_datareader_submessage, invalid_data,
  .init = suite_decode_datareader_submessage_init, .fini = suite_decode_datareader_submessage_fini)
{
  DDS_Security_boolean result;
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  ...
  prepare_endpoint_security_attributes_and_properties(
    &datareader_security_attributes, &datareader_properties, CRYPTO_TRANSFORMATION_KIND_AES256_GCM,
    true);
  prepare_endpoint_security_attributes_and_properties(
    &datawriter_security_attributes, &datawriter_properties, CRYPTO_TRANSFORMATION_KIND_AES256_GCM,
    true);
  ...
  /* Incorrect prefix id */
  {
    ...
    result = crypto->crypto_transform->decode_datareader_submessage(
      crypto->crypto_transform, &decoded_buffer, &corrupt_buffer, local_writer_crypto,
      remote_reader_crypto, &exception);
...
CU_Test(
  ddssec_builtin_decode_datareader_submessage, volatile_sec,
  .init = suite_decode_datareader_submessage_init, .fini = suite_decode_datareader_submessage_fini)
{
  DDS_Security_boolean result;
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  ...
  prepare_endpoint_security_attributes_and_properties(
    &datareader_security_attributes, NULL, CRYPTO_TRANSFORMATION_KIND_AES256_GCM, false);
  prepare_endpoint_security_attributes_and_properties(
    &datawriter_security_attributes, NULL, CRYPTO_TRANSFORMATION_KIND_AES256_GCM, false);
  ...
  datareader_properties._buffer[0].value =
    ddsrt_strdup("BuiltinParticipantVolatileMessageSecureReader");
  ...
  datawriter_properties._buffer[0].value =
    ddsrt_strdup("BuiltinParticipantVolatileMessageSecureWriter");
  ...
  local_reader_crypto = crypto->crypto_key_factory->register_local_datareader(
    crypto->crypto_key_factory, local_participant_handle, &datareader_properties,
    &datareader_security_attributes, &exception);
  CU_ASSERT_FATAL(local_reader_crypto != 0);

  remote_writer_crypto = crypto->crypto_key_factory->register_matched_remote_datawriter(
    crypto->crypto_key_factory, local_reader_crypto, remote_participant_handle,
    shared_secret_handle, &exception);
  CU_ASSERT_FATAL(remote_writer_crypto != 0);

  remote_reader_crypto = crypto->crypto_key_factory->register_matched_remote_datareader(
    crypto->crypto_key_factory, local_writer_crypto, remote_participant_handle,
  ...
  /* Decrypt the datareader submessage */
  result = crypto->crypto_transform->decode_datareader_submessage(
    crypto->crypto_transform, &decoded_buffer, &encoded_buffer, local_writer_crypto,
    remote_reader_crypto, &exception);
