...
static const char * SUBJECT_NAME_PERMISSIONS_CA =
  "C=NL, ST=Some-State, O=ADLINK Technolocy Inc., CN=adlinktech.com";
...
static int fill_peer_credential_token(
  DDS_Security_AuthenticatedPeerCredentialToken * token, const char * permission_filename)
{
  int result = 1;
  char * permission_uri;
...
CU_Test(
  ddssec_builtin_validate_remote_permissions, valid_permissions,
  .init = suite_validate_remote_permissions_init, .fini = suite_validate_remote_permissions_fini)
{
...
CU_Test(
  ddssec_builtin_validate_remote_permissions, permissions_unknown_ca,
  .init = suite_validate_remote_permissions_init, .fini = suite_validate_remote_permissions_fini)
{
  DDS_Security_PermissionsHandle result;
  DDS_Security_PermissionsToken permissions_token;
...
CU_Test(
  ddssec_builtin_validate_remote_permissions, permissions_not_signed,
  .init = suite_validate_remote_permissions_init, .fini = suite_validate_remote_permissions_fini)
{
  DDS_Security_PermissionsHandle result;
  DDS_Security_PermissionsToken permissions_token;
...
CU_Test(
  ddssec_builtin_validate_remote_permissions, invalid_credential_token,
  .init = suite_validate_remote_permissions_init, .fini = suite_validate_remote_permissions_fini)
{
  DDS_Security_PermissionsHandle result;
  DDS_Security_PermissionsToken permissions_token;
...
CU_Test(
  ddssec_builtin_validate_remote_permissions, invalid_xml,
  .init = suite_validate_remote_permissions_init, .fini = suite_validate_remote_permissions_fini)
{
  DDS_Security_PermissionsHandle result;
  DDS_Security_PermissionsToken permissions_token;
...
CU_Test(
  ddssec_builtin_validate_remote_permissions, permissions_expired,
  .init = suite_validate_remote_permissions_init, .fini = suite_validate_remote_permissions_fini)
{
  DDS_Security_PermissionsHandle result;
  DDS_Security_PermissionsToken permissions_token;
  ...
  CU_ASSERT_NSTRING_EQUAL_FATAL(
    DDS_SECURITY_ERR_VALIDITY_PERIOD_EXPIRED_MESSAGE, exception.message,
    strlen(DDS_SECURITY_ERR_VALIDITY_PERIOD_EXPIRED_MESSAGE) - 16);
  reset_exception(&exception);
...
CU_Test(
  ddssec_builtin_validate_remote_permissions, permissions_not_yet,
  .init = suite_validate_remote_permissions_init, .fini = suite_validate_remote_permissions_fini)
{
  DDS_Security_PermissionsHandle result;
  DDS_Security_PermissionsToken permissions_token;
  ...
  CU_ASSERT_NSTRING_EQUAL_FATAL(
    DDS_SECURITY_ERR_VALIDITY_PERIOD_NOT_STARTED_MESSAGE, exception.message,
    strlen(DDS_SECURITY_ERR_VALIDITY_PERIOD_NOT_STARTED_MESSAGE) - 14);
  reset_exception(&exception);
...
CU_Test(
  ddssec_builtin_validate_remote_permissions, permissions_unknown_subject_name,
  .init = suite_validate_remote_permissions_init, .fini = suite_validate_remote_permissions_fini)
{
  DDS_Security_PermissionsHandle result;
  DDS_Security_PermissionsToken permissions_token;
  ...
  fill_permissions_token(&permissions_token);
  r =
    fill_peer_credential_token(&credential_token, "Test_Permissions_missing_subject_component.p7s");
  CU_ASSERT_FATAL(r);
...
CU_Test(
  ddssec_builtin_validate_remote_permissions, permissions_different_subject,
  .init = suite_validate_remote_permissions_init, .fini = suite_validate_remote_permissions_fini)
{
  DDS_Security_PermissionsHandle result;
  DDS_Security_PermissionsToken permissions_token;
  ...
  fill_permissions_token(&permissions_token);
  r = fill_peer_credential_token(
    &credential_token, "Test_Permissions_different_subject_representation.p7s");
  CU_ASSERT_FATAL(r);
...
CU_Test(
  ddssec_builtin_validate_remote_permissions, corrupted_signature,
  .init = suite_validate_remote_permissions_init, .fini = suite_validate_remote_permissions_fini)
{
  DDS_Security_PermissionsHandle result;
  DDS_Security_PermissionsToken permissions_token;
