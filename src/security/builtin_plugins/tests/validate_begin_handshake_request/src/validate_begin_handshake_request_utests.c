...
static const DDS_Security_BinaryProperty_t * find_binary_property(
...
static int validate_remote_identities(void)
{
  int res = 0;
  DDS_Security_ValidationResult_t result;
...
static void fill_local_participant_data(DDS_Security_OctetSeq * pdata, uint32_t length)
{
  uint32_t i;
...
static void release_local_participant_data(DDS_Security_OctetSeq * pdata)
{
  if (pdata) {
...
static bool validate_handshake_token(
  DDS_Security_HandshakeMessageToken * token, const DDS_Security_OctetSeq * challenge)
{
...
CU_Test(ddssec_builtin_validate_begin_handshake_request, happy_day_challenge)
{
  ...
  result = auth->begin_handshake_request(
    auth, &handshake_handle, &handshake_token, local_identity_handle, remote_identity_handle2,
    &local_participant_data, &exception);
...
CU_Test(ddssec_builtin_validate_begin_handshake_request, happy_day_future_challenge)
{
  ...
  result = auth->begin_handshake_request(
    auth, &handshake_handle, &handshake_token, local_identity_handle, remote_identity_handle1,
    &local_participant_data, &exception);
...
CU_Test(ddssec_builtin_validate_begin_handshake_request, invalid_arguments)
{
  ...
  result = auth->begin_handshake_request(
    auth, NULL, &handshake_token, local_identity_handle, remote_identity_handle1,
    &local_participant_data, &exception);
  ...
  result = auth->begin_handshake_request(
    auth, &handshake_handle, NULL, local_identity_handle, remote_identity_handle1,
    &local_participant_data, &exception);
  ...
  result = auth->begin_handshake_request(
    auth, &handshake_handle, &handshake_token, 0x1234598, remote_identity_handle1,
    &local_participant_data, &exception);
  ...
  result = auth->begin_handshake_request(
    auth, &handshake_handle, &handshake_token, local_identity_handle, 0x1234598,
    &local_participant_data, &exception);
  ...
  result = auth->begin_handshake_request(
    auth, &handshake_handle, &handshake_token, local_identity_handle, remote_identity_handle1, NULL,
    &exception);
