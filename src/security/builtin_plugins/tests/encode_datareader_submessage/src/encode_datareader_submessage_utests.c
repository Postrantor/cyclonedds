...
static void prepare_endpoint_security_attributes_and_properties(
  ...
  uint32_t transformation_kind, bool is_origin_authenticated)
{
...
static session_key_material * get_datareader_session(
  DDS_Security_DatareaderCryptoHandle reader_crypto)
{
...
static master_key_material * get_datawriter_key_material(
  DDS_Security_DatawriterCryptoHandle writer_crypto)
{
...
static bool check_writer_sign(
  DDS_Security_DatareaderCryptoHandle writer_crypto, uint32_t session_id, uint32_t key_id,
...
static bool check_writer_signing(
...
static void encode_datareader_submessage_not_signed(uint32_t transformation_kind)
{
  ...
  result = crypto->crypto_transform->encode_datareader_submessage(
    crypto->crypto_transform, &encoded_buffer, &plain_buffer, reader_crypto, &writer_list,
    &exception);
...
CU_Test(
  ddssec_builtin_encode_datareader_submessage, encode_256,
  .init = suite_encode_datareader_submessage_init, .fini = suite_encode_datareader_submessage_fini)
{
  encode_datareader_submessage_not_signed(CRYPTO_TRANSFORMATION_KIND_AES256_GCM);
}

CU_Test(
  ddssec_builtin_encode_datareader_submessage, encode_128,
  .init = suite_encode_datareader_submessage_init, .fini = suite_encode_datareader_submessage_fini)
{
...
CU_Test(
  ddssec_builtin_encode_datareader_submessage, no_encode_256,
  .init = suite_encode_datareader_submessage_init, .fini = suite_encode_datareader_submessage_fini)
{
...
CU_Test(
  ddssec_builtin_encode_datareader_submessage, no_encode_128,
  .init = suite_encode_datareader_submessage_init, .fini = suite_encode_datareader_submessage_fini)
{
...
static void encode_datareader_submessage_sign(uint32_t transformation_kind)
{
  ...
  buffer = &plain_buffer;
  result = crypto->crypto_transform->encode_datareader_submessage(
    crypto->crypto_transform, &encoded_buffer, buffer, reader_crypto, &writer_list, &exception);
  ...
  CU_ASSERT(check_writer_signing(
    &writer_list, footer, session_id, header->session_id, session_keys->key_size));
...
CU_Test(
  ddssec_builtin_encode_datareader_submessage, encode_sign_256,
  .init = suite_encode_datareader_submessage_init, .fini = suite_encode_datareader_submessage_fini)
{
...
CU_Test(
  ddssec_builtin_encode_datareader_submessage, encode_sign_128,
  .init = suite_encode_datareader_submessage_init, .fini = suite_encode_datareader_submessage_fini)
{
...
CU_Test(
  ddssec_builtin_encode_datareader_submessage, no_encode_sign_256,
  .init = suite_encode_datareader_submessage_init, .fini = suite_encode_datareader_submessage_fini)
{
...
CU_Test(
  ddssec_builtin_encode_datareader_submessage, no_encode_sign_128,
  .init = suite_encode_datareader_submessage_init, .fini = suite_encode_datareader_submessage_fini)
{
...
CU_Test(
  ddssec_builtin_encode_datareader_submessage, invalid_args,
  .init = suite_encode_datareader_submessage_init, .fini = suite_encode_datareader_submessage_fini)
{
  DDS_Security_boolean result;
  ...
  /* writer crypto 0 */
  result = crypto->crypto_transform->encode_datareader_submessage(
    crypto->crypto_transform, &encoded_buffer, &plain_buffer, 0, &writer_list, &exception);
  ...
  result = crypto->crypto_transform->encode_datareader_submessage(
    crypto->crypto_transform, &encoded_buffer, &plain_buffer, 1, &writer_list, &exception);
  ...
  writer_list._buffer[0] = 0;
  result = crypto->crypto_transform->encode_datareader_submessage(
    crypto->crypto_transform, &encoded_buffer, &plain_buffer, writer_crypto, &writer_list,
    &exception);
