...
CU_Test(
  ddssec_builtin_create_local_datawriter_crypto_tokens, happy_day,
  .init = suite_create_local_datawriter_crypto_tokens_init,
  .fini = suite_create_local_datawriter_crypto_tokens_fini)
{
...
CU_Test(
  ddssec_builtin_create_local_datawriter_crypto_tokens, invalid_args,
  .init = suite_create_local_datawriter_crypto_tokens_init,
  .fini = suite_create_local_datawriter_crypto_tokens_fini)
{
  DDS_Security_boolean result;
  ...
  result = crypto->crypto_key_exchange->create_local_datawriter_crypto_tokens(
    crypto->crypto_key_exchange, NULL, local_writer_crypto, remote_reader_crypto, &exception);
  ...
  result = crypto->crypto_key_exchange->create_local_datawriter_crypto_tokens(
    crypto->crypto_key_exchange, &tokens, 0, remote_reader_crypto, &exception);
  ...
  result = crypto->crypto_key_exchange->create_local_datawriter_crypto_tokens(
    crypto->crypto_key_exchange, &tokens, local_writer_crypto, 0, &exception);
  ...
  result = crypto->crypto_key_exchange->create_local_datawriter_crypto_tokens(
    crypto->crypto_key_exchange, &tokens, 1, remote_reader_crypto, &exception);
  ...
  result = crypto->crypto_key_exchange->create_local_datawriter_crypto_tokens(
    crypto->crypto_key_exchange, &tokens, local_writer_crypto, 1, &exception);
