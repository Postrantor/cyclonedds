...
CU_Test(
  ddssec_builtin_register_local_datawriter, happy_day, .init = suite_register_local_datawriter_init,
  .fini = suite_register_local_datawriter_fini)
{
...
CU_Test(
  ddssec_builtin_register_local_datawriter, builtin_endpoint,
  .init = suite_register_local_datawriter_init, .fini = suite_register_local_datawriter_fini)
{
  DDS_Security_DatawriterCryptoHandle result;
...
CU_Test(
  ddssec_builtin_register_local_datawriter, special_endpoint_name,
  .init = suite_register_local_datawriter_init, .fini = suite_register_local_datawriter_fini)
{
  DDS_Security_DatawriterCryptoHandle result;
  ...
  assert(result != 0);  // for Clang's static analyzer
  CU_ASSERT_FATAL(
    ((local_datawriter_crypto *)result)->is_builtin_participant_volatile_message_secure_writer);
...
CU_Test(
  ddssec_builtin_register_local_datawriter, invalid_participant,
  .init = suite_register_local_datawriter_init, .fini = suite_register_local_datawriter_fini)
{
  DDS_Security_DatawriterCryptoHandle result;
  ...
  result = crypto->crypto_key_factory->register_local_datawriter(
    ...
    &datawriter_properties, &datawriter_security_attributes, &exception);
