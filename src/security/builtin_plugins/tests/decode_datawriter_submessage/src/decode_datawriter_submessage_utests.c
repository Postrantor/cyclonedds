  ...
  DDS_Security_EndpointSecurityAttributes * attributes, DDS_Security_PropertySeq * properties)
{
  ...
  writer_crypto = crypto->crypto_key_factory->register_local_datawriter(
    crypto->crypto_key_factory, local_participant_handle, properties, attributes, &exception);
  ...
  DDS_Security_DatawriterCryptoHandle nodeB_remote_writer_crypto)
{
  ...
  result = crypto->crypto_key_exchange->create_local_datawriter_crypto_tokens(
    crypto->crypto_key_exchange, &tokens, nodeA_local_writer_crypto, nodeA_remote_reader_crypto,
    &exception);

  if (result) {
    result = crypto->crypto_key_exchange->set_remote_datawriter_crypto_tokens(
      crypto->crypto_key_exchange, nodeB_local_reader_crypto, nodeB_remote_writer_crypto, &tokens,
      &exception);
  }
  ...
  if (result) {
    result = crypto->crypto_key_exchange->create_local_datareader_crypto_tokens(
      crypto->crypto_key_exchange, &tokens, nodeB_local_reader_crypto, nodeB_remote_writer_crypto,
      &exception);
  }

  if (result) {
    result = crypto->crypto_key_exchange->set_remote_datareader_crypto_tokens(
      crypto->crypto_key_exchange, nodeA_local_writer_crypto, nodeA_remote_reader_crypto, &tokens,
      &exception);
  }
...
static void decode_datawriter_submessage_not_signed(
  DDS_Security_CryptoTransformKind_Enum transformation_kind)
{
  ...
  result = crypto->crypto_transform->encode_datawriter_submessage(
    crypto->crypto_transform, &encoded_buffer, &plain_buffer, local_writer_crypto, &reader_list,
    &index, &exception);
  ...
  result = crypto->crypto_transform->decode_datawriter_submessage(
    crypto->crypto_transform, &decoded_buffer, &encoded_buffer, local_reader_crypto,
    remote_writer_crypto, &exception);

  if (!result) {
    printf(
      "decode_datawriter_submessage: %s\n",
      exception.message ? exception.message : "Error message missing");
  }
...
CU_Test(
  ddssec_builtin_decode_datawriter_submessage, encoded_256,
  .init = suite_decode_datawriter_submessage_init, .fini = suite_decode_datawriter_submessage_fini)
{
  decode_datawriter_submessage_not_signed(CRYPTO_TRANSFORMATION_KIND_AES256_GCM);
}

CU_Test(
  ddssec_builtin_decode_datawriter_submessage, encoded_128,
  .init = suite_decode_datawriter_submessage_init, .fini = suite_decode_datawriter_submessage_fini)
{
...
CU_Test(
  ddssec_builtin_decode_datawriter_submessage, not_encoded_256,
  .init = suite_decode_datawriter_submessage_init, .fini = suite_decode_datawriter_submessage_fini)
{
...
CU_Test(
  ddssec_builtin_decode_datawriter_submessage, not_encoded_128,
  .init = suite_decode_datawriter_submessage_init, .fini = suite_decode_datawriter_submessage_fini)
{
  decode_datawriter_submessage_not_signed(CRYPTO_TRANSFORMATION_KIND_AES128_GMAC);
}

static void decode_datawriter_submessage_signed(
  DDS_Security_CryptoTransformKind_Enum transformation_kind)
{
  ...
  while ((uint32_t)index != LIST_SIZE) {
    result = crypto->crypto_transform->encode_datawriter_submessage(
      crypto->crypto_transform, &encoded_buffer, buffer, local_writer_crypto, &remote_reader_list,
      &index, &exception);
  ...
  for (i = 0; i < LIST_SIZE; i++) {
    result = crypto->crypto_transform->decode_datawriter_submessage(
      crypto->crypto_transform, &decoded_buffer, &encoded_buffer, local_reader_list._buffer[i],
      remote_writer_list._buffer[i], &exception);
...
CU_Test(
  ddssec_builtin_decode_datawriter_submessage, signed_256,
  .init = suite_decode_datawriter_submessage_init, .fini = suite_decode_datawriter_submessage_fini)
{
...
CU_Test(
  ddssec_builtin_decode_datawriter_submessage, signed_128,
  .init = suite_decode_datawriter_submessage_init, .fini = suite_decode_datawriter_submessage_fini)
{
...
CU_Test(
  ddssec_builtin_decode_datawriter_submessage, only_signed_256,
  .init = suite_decode_datawriter_submessage_init, .fini = suite_decode_datawriter_submessage_fini)
{
...
CU_Test(
  ddssec_builtin_decode_datawriter_submessage, only_signed_128,
  .init = suite_decode_datawriter_submessage_init, .fini = suite_decode_datawriter_submessage_fini)
{
...
CU_Test(
  ddssec_builtin_decode_datawriter_submessage, invalid_args,
  .init = suite_decode_datawriter_submessage_init, .fini = suite_decode_datawriter_submessage_fini)
{
  DDS_Security_boolean result;
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  ...
  result = crypto->crypto_transform->decode_datawriter_submessage(
    crypto->crypto_transform, &decoded_buffer, &encoded_buffer, 0, remote_writer_crypto,
    &exception);
  ...
  result = crypto->crypto_transform->decode_datawriter_submessage(
    crypto->crypto_transform, &decoded_buffer, &encoded_buffer, 1, remote_writer_crypto,
    &exception);
  ...
  result = crypto->crypto_transform->decode_datawriter_submessage(
    crypto->crypto_transform, &decoded_buffer, &encoded_buffer, local_reader_crypto, 0, &exception);
  ...
  result = crypto->crypto_transform->decode_datawriter_submessage(
    crypto->crypto_transform, &decoded_buffer, &encoded_buffer, local_reader_crypto, 1, &exception);
...
CU_Test(
  ddssec_builtin_decode_datawriter_submessage, invalid_data,
  .init = suite_decode_datawriter_submessage_init, .fini = suite_decode_datawriter_submessage_fini)
{
  DDS_Security_boolean result;
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  ...
  /* Incorrect prefix id */
  {
    ...
    result = crypto->crypto_transform->decode_datawriter_submessage(
      crypto->crypto_transform, &decoded_buffer, &corrupt_buffer, local_reader_crypto,
      remote_writer_crypto, &exception);
...
CU_Test(
  ddssec_builtin_decode_datawriter_submessage, volatile_sec,
  .init = suite_decode_datawriter_submessage_init, .fini = suite_decode_datawriter_submessage_fini)
{
  DDS_Security_boolean result;
  DDS_Security_SecurityException exception = {NULL, 0, 0};
