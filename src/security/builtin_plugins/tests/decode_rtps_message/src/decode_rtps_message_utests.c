...
static int register_local_participants(
  ...
  DDS_Security_PropertySeq * participant_properties)
{
  ...
  local_participantA_crypto = crypto->crypto_key_factory->register_local_participant(
    crypto->crypto_key_factory, local_participantA_identity, participant_permissions,
  ...
  local_participantB_crypto = crypto->crypto_key_factory->register_local_participant(
    crypto->crypto_key_factory, local_participantB_identity, participant_permissions,
    participant_properties, participant_security_attributes, &exception);
...
static void unregister_local_participants(void)
{
  ...
  if (local_participantA_crypto) {
    crypto->crypto_key_factory->unregister_participant(
      crypto->crypto_key_factory, local_participantA_crypto, &exception);
    reset_exception(&exception);
  }
  if (local_participantB_crypto) {
    crypto->crypto_key_factory->unregister_participant(
      crypto->crypto_key_factory, local_participantB_crypto, &exception);
    reset_exception(&exception);
  }
}

static int register_remote_participants(
  DDS_Security_ParticipantCryptoHandle local_id, DDS_Security_IdentityHandle remote_ids[4],
  DDS_Security_ParticipantCryptoHandle participant_cryptos[4])
{
  ...
  for (i = 0; i < 4; ++i) {
    participant_cryptos[i] = crypto->crypto_key_factory->register_matched_remote_participant(
      crypto->crypto_key_factory, local_id, remote_ids[i], remote_participant_permissions,
...
static void unregister_remote_participants(void)
{
  ...
  for (i = 0; i < 4; ++i) {
    if (remote_cryptos[i]) {
      crypto->crypto_key_factory->unregister_participant(
        crypto->crypto_key_factory, remote_cryptos[i], &exception);
      reset_exception(&exception);
    }
  }
}
...
static int register_remote_participant_for_participantB(
  DDS_Security_ParticipantCryptoHandle local_id, DDS_Security_IdentityHandle remote_identity,
...
static void unregister_remote_participant_of_participantB(
  DDS_Security_ParticipantCryptoHandle remote_participant_crypto)
{
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  if (remote_participant_crypto) {
    crypto->crypto_key_factory->unregister_participant(
      crypto->crypto_key_factory, remote_participant_crypto, &exception);
    reset_exception(&exception);
  }
}
  ...
  DDS_Security_ParticipantCryptoHandle remote_participantA_crypto_handle)
{
  ...
  result = crypto->crypto_key_exchange->create_local_participant_crypto_tokens(
    crypto->crypto_key_exchange, &tokens, local_participantA_crypto_handle,
    remote_participantB_crypto_handle, &exception);

  if (result) {
    result = crypto->crypto_key_exchange->set_remote_participant_crypto_tokens(
      crypto->crypto_key_exchange, local_participantB_crypto_handle,
      remote_participantA_crypto_handle, &tokens, &exception);
  }
...
static bool check_decoded_rtps_message(
  const DDS_Security_OctetSeq * decoded, const DDS_Security_OctetSeq * orig)
{
...
static void decode_rtps_message_not_authenticated(
  DDS_Security_CryptoTransformKind_Enum transformation_kind, uint32_t key_size)
{
  ...
  result = crypto->crypto_transform->encode_rtps_message(
    crypto->crypto_transform, &encoded_buffer, &plain_buffer, local_participantA_crypto,
    &reader_list, &index, &exception);
  ...
  result = crypto->crypto_transform->decode_rtps_message(
    crypto->crypto_transform, &decoded_buffer, &encoded_buffer, local_participantB_crypto,
    remote_particpantA_crypto, &exception);

  if (!result) {
    printf(
      "decode_rtps_message: %s\n", exception.message ? exception.message : "Error message missing");
  }
...
CU_Test(
  ddssec_builtin_decode_rtps_message, encoded_256, .init = suite_decode_rtps_message_init,
  .fini = suite_decode_rtps_message_fini)
{
  decode_rtps_message_not_authenticated(CRYPTO_TRANSFORMATION_KIND_AES256_GCM, 256);
}

CU_Test(
  ddssec_builtin_decode_rtps_message, encoded_128, .init = suite_decode_rtps_message_init,
  .fini = suite_decode_rtps_message_fini)
{
...
CU_Test(
  ddssec_builtin_decode_rtps_message, not_encrypted_256, .init = suite_decode_rtps_message_init,
  .fini = suite_decode_rtps_message_fini)
{
...
CU_Test(
  ddssec_builtin_decode_rtps_message, not_encrypted_128, .init = suite_decode_rtps_message_init,
  .fini = suite_decode_rtps_message_fini)
{
  decode_rtps_message_not_authenticated(CRYPTO_TRANSFORMATION_KIND_AES128_GMAC, 128);
}

static void decode_rtps_message_authenticated(
  DDS_Security_CryptoTransformKind_Enum transformation_kind, uint32_t key_size,
  DDS_Security_ProtectionKind protection_kind)
{
  DDS_Security_boolean result;
  ...
  while (index != 4) {
    result = crypto->crypto_transform->encode_rtps_message(
      crypto->crypto_transform, &encoded_buffer, buffer, local_participantA_crypto,
      &remote_reader_list, &index, &exception);
...
CU_Test(
  ddssec_builtin_decode_rtps_message, authenticated_256, .init = suite_decode_rtps_message_init,
  .fini = suite_decode_rtps_message_fini)
{
...
CU_Test(
  ddssec_builtin_decode_rtps_message, authenticated_128, .init = suite_decode_rtps_message_init,
  .fini = suite_decode_rtps_message_fini)
{
  decode_rtps_message_authenticated(
...
CU_Test(
  ddssec_builtin_decode_rtps_message, only_authenticated_256,
...
CU_Test(
  ddssec_builtin_decode_rtps_message, only_authenticated_128,
  .init = suite_decode_rtps_message_init, .fini = suite_decode_rtps_message_fini)
{
  decode_rtps_message_authenticated(
...
CU_Test(
  ddssec_builtin_decode_rtps_message, invalid_args, .init = suite_decode_rtps_message_init,
  .fini = suite_decode_rtps_message_fini)
{
  DDS_Security_boolean result;
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  ...
  prepare_participant_security_attributes_and_properties(
    &attributes, &properties, CRYPTO_TRANSFORMATION_KIND_AES256_GMAC, false);
  register_local_participants(&attributes, &properties);
  ...
  result = crypto->crypto_transform->decode_rtps_message(
    crypto->crypto_transform, &decoded_buffer, &encoded_buffer, 0, remote_particpantA_crypto,
    &exception);
  ...
  result = crypto->crypto_transform->decode_rtps_message(
    crypto->crypto_transform, &decoded_buffer, &encoded_buffer, 1, remote_particpantA_crypto,
    &exception);
  ...
  result = crypto->crypto_transform->decode_rtps_message(
    crypto->crypto_transform, &decoded_buffer, &encoded_buffer, local_participantB_crypto, 0,
    &exception);
  ...
  result = crypto->crypto_transform->decode_rtps_message(
    crypto->crypto_transform, &decoded_buffer, &encoded_buffer, local_participantB_crypto, 1,
    &exception);
...
CU_Test(
  ddssec_builtin_decode_rtps_message, invalid_data, .init = suite_decode_rtps_message_init,
  .fini = suite_decode_rtps_message_fini)
{
  DDS_Security_boolean result;
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  ...
  set_protection_kind(
    local_participantA_crypto, DDS_SECURITY_PROTECTION_KIND_ENCRYPT_WITH_ORIGIN_AUTHENTICATION);

  register_remote_participants(local_participantA_crypto, remote_identities, remote_cryptos);

  set_protection_kind(
    local_participantB_crypto, DDS_SECURITY_PROTECTION_KIND_ENCRYPT_WITH_ORIGIN_AUTHENTICATION);
  ...
  /* Incorrect prefix id */
  {
    ...
    result = crypto->crypto_transform->decode_rtps_message(
      crypto->crypto_transform, &decoded_buffer, &corrupt_buffer, local_participantB_crypto,
      remote_particpantA_crypto, &exception);
