...
static bool validate_permissions_token(DDS_Security_PermissionsCredentialToken * token)
{
  ...
  if (
    !token->class_id || strcmp(token->class_id, DDS_ACTOKEN_PERMISSIONS_CREDENTIAL_CLASS_ID) != 0) {
  ...
  if (property->value == NULL) {
    CU_FAIL("PermissionsCredentialToken property '" DDS_ACTOKEN_PROP_PERM_CERT
            "' does not have a value");
    return false;
  }
  if (strcmp(property->value, permissions) != 0) {
    CU_FAIL("PermissionsCredentialToken property '" DDS_ACTOKEN_PROP_PERM_CERT
            "' content does not match the permissions file");
    return false;
  }
...
CU_Test(
  ddssec_builtin_get_permissions_credential_token, happy_day,
  .init = suite_get_permissions_credential_token_init,
  .fini = suite_get_permissions_credential_token_fini)
{
  ...
  result = access_control->get_permissions_credential_token(
    access_control, &token, local_permissions_handle, &exception);
  if (!result) {
    printf(
      "get_permissions_credential_token: %s\n",
      exception.message ? exception.message : "Error message missing");
  }
...
CU_Test(
  ddssec_builtin_get_permissions_credential_token, invalid_args,
  .init = suite_get_permissions_credential_token_init,
  .fini = suite_get_permissions_credential_token_fini)
{
  DDS_Security_PermissionsCredentialToken token;
  ...
  result = access_control->get_permissions_credential_token(
    NULL, &token, local_permissions_handle, &exception);
  if (!result) {
    printf(
      "get_permissions_token: %s\n",
      exception.message ? exception.message : "Error message missing");
  }
  CU_ASSERT(!result);
  ...
  result = access_control->get_permissions_credential_token(
    access_control, NULL, local_permissions_handle, &exception);
  if (!result) {
    printf(
      "get_permissions_credential_token: %s\n",
      exception.message ? exception.message : "Error message missing");
  ...
  result = access_control->get_permissions_credential_token(access_control, &token, 0, &exception);
  if (!result) {
    printf(
      "get_permissions_credential_token: %s\n",
      exception.message ? exception.message : "Error message missing");
  ...
  result = access_control->get_permissions_credential_token(
    access_control, &token, local_permissions_handle, NULL);
  if (!result) {
    printf(
      "get_permissions_credential_token: %s\n",
      exception.message ? exception.message : "Error message missing");
  ...
  result = access_control->get_permissions_credential_token(
    access_control, &token, local_permissions_handle + 12345 /* invalid handle */, &exception);
  if (!result) {
    printf(
      "get_permissions_credential_token: %s\n",
      exception.message ? exception.message : "Error message missing");
