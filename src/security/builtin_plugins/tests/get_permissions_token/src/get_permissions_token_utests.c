...
static bool validate_permissions_token(DDS_Security_PermissionsToken * token)
{
...
CU_Test(
  ddssec_builtin_get_permissions_token, happy_day, .init = suite_get_permissions_token_init,
  .fini = suite_get_permissions_token_fini)
{
...
CU_Test(
  ddssec_builtin_get_permissions_token, invalid_args, .init = suite_get_permissions_token_init,
  .fini = suite_get_permissions_token_fini)
{
  DDS_Security_SecurityException exception;
  DDS_Security_PermissionsToken token;
  ...
  result =
    access_control->get_permissions_token(NULL, &token, local_permissions_handle, &exception);
  if (!result) {
    printf(
      "get_permissions_token: %s\n",
      exception.message ? exception.message : "Error message missing");
  ...
  result = access_control->get_permissions_token(access_control, &token, 0, &exception);
  if (!result) {
    printf(
      "get_permissions_token: %s\n",
      exception.message ? exception.message : "Error message missing");
  ...
  result =
    access_control->get_permissions_token(access_control, &token, local_permissions_handle, NULL);
  if (!result) {
    printf(
      "get_permissions_token: %s\n",
      exception.message ? exception.message : "Error message missing");
