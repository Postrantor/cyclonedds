...
static int register_remote_datareader(void)
{
  ...
  remote_reader_crypto = crypto->crypto_key_factory->register_matched_remote_datareader(
    crypto->crypto_key_factory, local_writer_crypto, remote_particpant_crypto, shared_secret_handle,
    true, &exception);
...
CU_Test(
  ddssec_builtin_set_remote_datareader_crypto_tokens, happy_day,
  .init = suite_set_remote_datareader_crypto_tokens_init,
  .fini = suite_set_remote_datareader_crypto_tokens_fini)
{
  ...
  if (!result)
    printf(
      "set_remote_datareader_crypto_tokens: %s\n",
      exception.message ? exception.message : "Error message missing");
...
CU_Test(
  ddssec_builtin_set_remote_datareader_crypto_tokens, single_token,
  .init = suite_set_remote_datareader_crypto_tokens_init,
  .fini = suite_set_remote_datareader_crypto_tokens_fini)
{
  DDS_Security_boolean result;
...
CU_Test(
  ddssec_builtin_set_remote_datareader_crypto_tokens, invalid_args,
  .init = suite_set_remote_datareader_crypto_tokens_init,
  .fini = suite_set_remote_datareader_crypto_tokens_fini)
{
  DDS_Security_boolean result;
  ...
  result = crypto->crypto_key_exchange->set_remote_datareader_crypto_tokens(
    crypto->crypto_key_exchange, local_writer_crypto, remote_reader_crypto, NULL, &exception);
  ...
  result = crypto->crypto_key_exchange->set_remote_datareader_crypto_tokens(
    crypto->crypto_key_exchange, 0, remote_reader_crypto, &tokens, &exception);
  ...
  result = crypto->crypto_key_exchange->set_remote_datareader_crypto_tokens(
    crypto->crypto_key_exchange, local_writer_crypto, 0, &tokens, &exception);
  ...
  result = crypto->crypto_key_exchange->set_remote_datareader_crypto_tokens(
    crypto->crypto_key_exchange, 1, remote_reader_crypto, &tokens, &exception);
  ...
  result = crypto->crypto_key_exchange->set_remote_datareader_crypto_tokens(
    crypto->crypto_key_exchange, local_writer_crypto, 1, &tokens, &exception);
  ...
  .fini = suite_set_remote_datareader_crypto_tokens_fini)
{
  ...
  {
    result = crypto->crypto_key_exchange->set_remote_datareader_crypto_tokens(
      crypto->crypto_key_exchange, local_writer_crypto, remote_reader_crypto, &empty_tokens,
      &exception);
...
CU_Test(
  ddssec_builtin_set_remote_datareader_crypto_tokens, invalid_key_material,
  .init = suite_set_remote_datareader_crypto_tokens_init,
  .fini = suite_set_remote_datareader_crypto_tokens_fini)
{
  DDS_Security_boolean result;
