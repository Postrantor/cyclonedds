...
static int validate_local_identity(const char * trusted_ca_dir, const char * crl_data)
{
  int res = 0;
...
static int set_dh_public_key(const char * keystr, unsigned char ** pubkey, size_t * size)
{
  int r = 0;
  BIO * bio = NULL;
  EVP_PKEY * pkey;
...
static int set_dh_keys(void)
{
  int r;

  r = set_dh_public_key(
    diffie_hellman_pubkey, &dh_pubkey_modp_2048_value, &dh_pubkey_modp_2048_length);
  if (r) {
    invalid_dh_pubkey_modp_2048_value = ddsrt_malloc(dh_pubkey_modp_2048_length);
    memcpy(
      invalid_dh_pubkey_modp_2048_value, dh_pubkey_modp_2048_value, dh_pubkey_modp_2048_length);
...
static int validate_remote_identities(const char * remote_id_certificate)
{
  ...
  challenge1 =
    find_binary_property(&g_local_auth_request_token, DDS_AUTHTOKEN_PROP_FUTURE_CHALLENGE);
  challenge2 =
...
static bool valid_c_id_property(const char * certificate, const DDS_Security_OctetSeq * value)
{
  if (value->_length == 0) {
...
static bool valid_string_value(const char * expected, const DDS_Security_OctetSeq * value)
{
...
static void set_binary_property_value(
  DDS_Security_BinaryProperty_t * bp, const char * name, const unsigned char * data, size_t length)
{
  assert(bp);
  assert(name);
  assert(data);
...
static void fill_handshake_message_token(
  ...
  const unsigned char * diffie_hellman, const size_t diffie_hellman_size,
  const unsigned char * challengeData, size_t challengeDataSize)
{
  ...
  set_binary_property_value(
    ...
    serialized_local_participant_data_size);
  ...
  /* Calculate the hash_c1 */
  {
    ...
    set_binary_property_value(
      hash_c1, DDS_AUTHTOKEN_PROP_HASH_C1, (const unsigned char *)&hash, sizeof(hash));
  }
  ...
  if (challengeData) {
    set_binary_property_value(
      challenge, DDS_AUTHTOKEN_PROP_CHALLENGE1, challengeData, challengeDataSize);
  } else {
    set_binary_property_value(
      challenge, DDS_AUTHTOKEN_PROP_CHALLENGE1 "x", challenge2->value._buffer,
...
static bool validate_handshake_token(
  DDS_Security_HandshakeMessageToken * token, const DDS_Security_OctetSeq * challenge_1,
  const DDS_Security_OctetSeq * challenge_2)
{
  ...
  if (!token->class_id || strcmp(token->class_id, AUTH_HANDSHAKE_REPLY_TOKEN_CLASS_ID) != 0) {
    ...
    CU_FAIL("HandshakeMessageToken incorrect property '" DDS_AUTHTOKEN_PROP_C_ID
            "' value is invalid");
    ...
    CU_FAIL("HandshakeMessageToken incorrect property '" DDS_AUTHTOKEN_PROP_C_DSIGN_ALGO
            "' not found");
    ...
    CU_FAIL("HandshakeMessageToken incorrect property '" DDS_AUTHTOKEN_PROP_C_KAGREE_ALGO
            "' not found");
...
CU_Test(
  ddssec_builtin_validate_begin_handshake_reply, happy_day, .init = init_testcase,
  .fini = fini_testcase)
{
  DDS_Security_ValidationResult_t result;
  ...
  fill_handshake_message_token_default(
    &handshake_token_in, remote_participant_data1, challenge2->value._buffer,
    challenge2->value._length);
...
CU_Test(
  ddssec_builtin_validate_begin_handshake_reply, future_challenge, .init = init_testcase,
  .fini = fini_testcase)

{
  ...
  fill_handshake_message_token_default(
    &handshake_token_in, remote_participant_data2, challenge2->value._buffer,
    challenge2->value._length);
...
CU_Test(
  ddssec_builtin_validate_begin_handshake_reply, invalid_arguments, .init = init_testcase,
  .fini = fini_testcase)
{
  DDS_Security_ValidationResult_t result;
  DDS_Security_HandshakeHandle handshake_handle;
  ...
  fill_handshake_message_token_default(
    &handshake_token_in, remote_participant_data1, challenge1->value._buffer,
    challenge1->value._length);

  result = auth->begin_handshake_reply(
    auth, NULL, &handshake_token_out, &handshake_token_in, remote_identity_handle1,
    local_identity_handle, &serialized_participant_data, &exception);
  ...
  result = auth->begin_handshake_reply(
    auth, &handshake_handle, NULL, &handshake_token_in, remote_identity_handle1,
    local_identity_handle, &serialized_participant_data, &exception);
  ...
  result = auth->begin_handshake_reply(
    auth, &handshake_handle, &handshake_token_out, NULL, remote_identity_handle1,
    local_identity_handle, &serialized_participant_data, &exception);
  ...
  result = auth->begin_handshake_reply(
    auth, &handshake_handle, &handshake_token_out, &handshake_token_in, 0, local_identity_handle,
  ...
  result = auth->begin_handshake_reply(
    auth, &handshake_handle, &handshake_token_out, &handshake_token_in, remote_identity_handle1, 0,
    &serialized_participant_data, &exception);
  ...
  result = auth->begin_handshake_reply(
    auth, &handshake_handle, &handshake_token_out, &handshake_token_in, remote_identity_handle1,
    local_identity_handle, NULL, &exception);
  ...
  result = auth->begin_handshake_reply(
    auth, &handshake_handle, &handshake_token_out, &handshake_token_in, remote_identity_handle1,
    local_identity_handle, &serdata, &exception);
...
CU_Test(
  ddssec_builtin_validate_begin_handshake_reply, invalid_certificate, .init = init_testcase,
  .fini = fini_testcase)
{
  DDS_Security_ValidationResult_t result;
  DDS_Security_HandshakeHandle handshake_handle;
  ...
  fill_handshake_message_token(
    &handshake_token_in, remote_participant_data1, unrelated_identity, AUTH_DSIGN_ALGO_RSA_NAME,
    AUTH_KAGREE_ALGO_RSA_NAME, dh_pubkey_modp_2048_value, dh_pubkey_modp_2048_length,
    challenge2->value._buffer, challenge2->value._length);
  ...
  fill_handshake_message_token(
    &handshake_token_in, remote_participant_data1, NULL, AUTH_DSIGN_ALGO_RSA_NAME,
    AUTH_KAGREE_ALGO_RSA_NAME, dh_pubkey_modp_2048_value, dh_pubkey_modp_2048_length,
    challenge2->value._buffer, challenge2->value._length);
...
CU_Test(
  ddssec_builtin_validate_begin_handshake_reply, invalid_participant_data, .init = init_testcase,
  .fini = fini_testcase)
{
  DDS_Security_ValidationResult_t result;
  DDS_Security_HandshakeHandle handshake_handle;
  ...
  fill_handshake_message_token(
    ...
    AUTH_DSIGN_ALGO_RSA_NAME, AUTH_KAGREE_ALGO_RSA_NAME, dh_pubkey_modp_2048_value,
    dh_pubkey_modp_2048_length, challenge2->value._buffer, challenge2->value._length);
...
CU_Test(
  ddssec_builtin_validate_begin_handshake_reply, invalid_dsign_algo, .init = init_testcase,
  .fini = fini_testcase)
{
  DDS_Security_ValidationResult_t result;
  DDS_Security_HandshakeHandle handshake_handle;
  ...
  fill_handshake_message_token(
    &handshake_token_in, remote_participant_data1, remote_identity_certificate, "RSASSA-PSS-SHA128",
    AUTH_KAGREE_ALGO_RSA_NAME, dh_pubkey_modp_2048_value, dh_pubkey_modp_2048_length,
    challenge2->value._buffer, challenge2->value._length);
  ...
  fill_handshake_message_token(
    &handshake_token_in, remote_participant_data1, remote_identity_certificate, NULL,
    AUTH_KAGREE_ALGO_RSA_NAME, dh_pubkey_modp_2048_value, dh_pubkey_modp_2048_length,
    challenge2->value._buffer, challenge2->value._length);
...
CU_Test(
  ddssec_builtin_validate_begin_handshake_reply, invalid_kagree_algo, .init = init_testcase,
  .fini = fini_testcase)
{
  DDS_Security_ValidationResult_t result;
  DDS_Security_HandshakeHandle handshake_handle;
  ...
  fill_handshake_message_token(
    &handshake_token_in, remote_participant_data1, remote_identity_certificate,
    AUTH_DSIGN_ALGO_RSA_NAME, "DH+MODP-2048-128", dh_pubkey_modp_2048_value,
    dh_pubkey_modp_2048_length, challenge2->value._buffer, challenge2->value._length);
  ...
  fill_handshake_message_token(
    &handshake_token_in, remote_participant_data1, remote_identity_certificate,
    AUTH_DSIGN_ALGO_RSA_NAME, NULL, dh_pubkey_modp_2048_value, dh_pubkey_modp_2048_length,
    challenge2->value._buffer, challenge2->value._length);
...
CU_Test(
  ddssec_builtin_validate_begin_handshake_reply, invalid_diffie_hellman, .init = init_testcase,
  .fini = fini_testcase)
{
  DDS_Security_ValidationResult_t result;
  DDS_Security_HandshakeHandle handshake_handle;
  ...
  fill_handshake_message_token(
    &handshake_token_in, remote_participant_data1, remote_identity_certificate,
    AUTH_DSIGN_ALGO_RSA_NAME, AUTH_KAGREE_ALGO_RSA_NAME, invalid_dh_pubkey_modp_2048_value,
    dh_pubkey_modp_2048_length, challenge2->value._buffer, challenge2->value._length);
  ...
  fill_handshake_message_token(
    &handshake_token_in, remote_participant_data1, remote_identity_certificate,
    AUTH_DSIGN_ALGO_RSA_NAME, AUTH_KAGREE_ALGO_RSA_NAME, NULL, 0, challenge2->value._buffer,
    challenge2->value._length);
...
CU_Test(
  ddssec_builtin_validate_begin_handshake_reply, invalid_challenge, .init = init_testcase,
  .fini = fini_testcase)
{
  DDS_Security_ValidationResult_t result;
  DDS_Security_HandshakeHandle handshake_handle;
  ...
  fill_handshake_message_token(
    &handshake_token_in, remote_participant_data1, remote_identity_certificate,
    AUTH_DSIGN_ALGO_RSA_NAME, AUTH_KAGREE_ALGO_RSA_NAME, dh_pubkey_modp_2048_value,
    dh_pubkey_modp_2048_length, challenge1->value._buffer, challenge1->value._length);
  ...
  fill_handshake_message_token(
    &handshake_token_in, remote_participant_data1, remote_identity_certificate,
    AUTH_DSIGN_ALGO_RSA_NAME, AUTH_KAGREE_ALGO_RSA_NAME, dh_pubkey_modp_2048_value,
    dh_pubkey_modp_2048_length, NULL, 0);
...
CU_Test(
  ddssec_builtin_validate_begin_handshake_reply, return_handle, .init = init_testcase,
  .fini = fini_testcase)
{
  DDS_Security_ValidationResult_t result;
  DDS_Security_HandshakeHandle handshake_handle;
...
CU_Test(
  validate_begin_handshake_reply, extended_certificate_check, .init = init_testcase,
  .fini = fini_testcase)
{
  DDS_Security_ValidationResult_t result;
  DDS_Security_HandshakeHandle handshake_handle;
