...
static void fill_participant_qos(
  DDS_Security_Qos * qos, const char * permission_filename, const char * governance_filename)
{
  char * permission_uri;
  char * governance_uri;
...
static bool create_local_identity(DDS_Security_DomainId domain_id, const char * governance_file)
{
  ...
  if (result != DDS_SECURITY_VALIDATION_OK) {
    printf(
      "[ERROR] validate_local_identity_failed: %s\n",
      exception.message ? exception.message : "Error message missing");
    return false;
  }

  local_permissions_handle = access_control->validate_local_permissions(
    access_control, auth, local_identity_handle, domain_id, &participant_qos, &exception);
...
static void clear_local_identity(void)
{
  ...
  if (local_permissions_handle != DDS_SECURITY_HANDLE_NIL) {
    ...
    if (!success) {
      printf(
        "return_permissions_handle failed: %s\n",
        exception.message ? exception.message : "Error message missing");
    }
    reset_exception(&exception);
  }
...
static void suite_get_xxx_sec_attributes_init(void)
{
      ...
      ATTRIBUTE_CHECKLIST[SEC_TOPIC_DCPSSUBSCRIPTIONSSECURE].is_read_protected =
        ATTRIBUTE_CHECKLIST[SEC_TOPIC_DCPSPARTICIPANTMESSAGESECURE].is_read_protected =
          ATTRIBUTE_CHECKLIST[SEC_TOPIC_DCPSPARTICIPANTSTATELESSMESSAGE].is_read_protected =
            ATTRIBUTE_CHECKLIST[SEC_TOPIC_DCPSPARTICIPANTVOLATILEMESSAGESECURE].is_read_protected =
              false;
      ...
      ATTRIBUTE_CHECKLIST[SEC_TOPIC_DCPSSUBSCRIPTIONSSECURE].is_write_protected =
        ATTRIBUTE_CHECKLIST[SEC_TOPIC_DCPSPARTICIPANTMESSAGESECURE].is_write_protected =
          ATTRIBUTE_CHECKLIST[SEC_TOPIC_DCPSPARTICIPANTSTATELESSMESSAGE].is_write_protected =
            ATTRIBUTE_CHECKLIST[SEC_TOPIC_DCPSPARTICIPANTVOLATILEMESSAGESECURE].is_write_protected =
              false;
      ...
      ATTRIBUTE_CHECKLIST[SEC_TOPIC_DCPSSUBSCRIPTIONSSECURE].is_key_protected =
        ATTRIBUTE_CHECKLIST[SEC_TOPIC_DCPSPARTICIPANTMESSAGESECURE].is_key_protected =
          ATTRIBUTE_CHECKLIST[SEC_TOPIC_DCPSPARTICIPANTSTATELESSMESSAGE].is_key_protected =
            ATTRIBUTE_CHECKLIST[SEC_TOPIC_DCPSPARTICIPANTVOLATILEMESSAGESECURE].is_key_protected =
              false;
  ...
  ATTRIBUTE_CHECKLIST[SEC_TOPIC_DCPSPARTICIPANTVOLATILEMESSAGESECURE].is_submessage_protected =
    true;
...
static void suite_get_xxx_sec_attributes_fini(void) { ddsrt_free(g_path_to_etc_dir); }
...
static void plugins_fini(void) { unload_plugins(plugins); }

static bool verify_endpoint_attributes(
  SEC_TOPIC_TYPE topic_type, DDS_Security_EndpointSecurityAttributes * attributes)
{
  bool result = true;
  if (
    attributes->is_read_protected != ATTRIBUTE_CHECKLIST[topic_type].is_read_protected ||
    attributes->is_write_protected != ATTRIBUTE_CHECKLIST[topic_type].is_write_protected ||
    attributes->is_submessage_protected !=
      ATTRIBUTE_CHECKLIST[topic_type].is_submessage_protected ||
  ...
  if (topic_type == SEC_TOPIC_DCPS_KINEMATICS || topic_type == SEC_TOPIC_DCPS_SHAPE) {
    if (
      attributes->is_discovery_protected !=
        ATTRIBUTE_CHECKLIST[topic_type].is_discovery_protected ||
      attributes->is_liveliness_protected !=
        ATTRIBUTE_CHECKLIST[topic_type].is_liveliness_protected ||
      attributes->plugin_endpoint_attributes !=
        ATTRIBUTE_CHECKLIST[topic_type].plugin_endpoint_attributes) {
      result = false;
    }
  }
  ...
  if (!result) {
    ...
    printf(
      "is_read_protected: EXPECTED: %u ACTUAL: %u\n"
...
static bool verify_topic_attributes(
  SEC_TOPIC_TYPE topic_type, DDS_Security_TopicSecurityAttributes * attributes)
{
  bool result = true;
  if (
    attributes->is_read_protected != ATTRIBUTE_CHECKLIST[topic_type].is_read_protected ||
...
CU_Test(
  ddssec_builtin_get_xxx_sec_attributes, participant_happy_day,
  .init = suite_get_xxx_sec_attributes_init, .fini = suite_get_xxx_sec_attributes_fini)
{
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  ...
  result = access_control->get_participant_sec_attributes(
    access_control, local_permissions_handle, &attributes, &exception);
  CU_ASSERT(result);
  ...
  CU_ASSERT(
    (attributes.plugin_participant_attributes &
     DDS_SECURITY_PLUGIN_PARTICIPANT_ATTRIBUTES_FLAG_IS_DISCOVERY_ENCRYPTED) == 0);
  CU_ASSERT(
    (attributes.plugin_participant_attributes &
  ...
  CU_ASSERT(
    (attributes.plugin_participant_attributes &
     DDS_SECURITY_PLUGIN_PARTICIPANT_ATTRIBUTES_FLAG_IS_LIVELINESS_AUTHENTICATED) == 0);
  CU_ASSERT(
    (attributes.plugin_participant_attributes &
     DDS_SECURITY_PARTICIPANT_ATTRIBUTES_FLAG_IS_VALID) != 0);

  result =
    access_control->return_participant_sec_attributes(access_control, &attributes, &exception);
  CU_ASSERT(result);
...
CU_Test(
  ddssec_builtin_get_xxx_sec_attributes, datawriter_happy_day,
  .init = suite_get_xxx_sec_attributes_init, .fini = suite_get_xxx_sec_attributes_fini)
{
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  ...
  for (i = SEC_TOPIC_DCPSPARTICIPANTSECURE; i <= SEC_TOPIC_DCPS_SHAPE; ++i) {
    result = access_control->get_datawriter_sec_attributes(
      access_control, local_permissions_handle, TOPIC_NAMES[i], partition, &data_tag, &attributes,
      &exception);
...
CU_Test(
  ddssec_builtin_get_xxx_sec_attributes, datawriter_non_existing_topic,
  .init = suite_get_xxx_sec_attributes_init, .fini = suite_get_xxx_sec_attributes_fini)
{
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  DDS_Security_PartitionQosPolicy * partition = NULL;
  ...
  /* Now call the function. */
  result = access_control->get_datawriter_sec_attributes(
    access_control, local_permissions_handle, TOPIC_NAMES[SEC_TOPIC_DCPS_SHAPE], partition,
    &data_tag, &attributes, &exception);
...
CU_Test(
  ddssec_builtin_get_xxx_sec_attributes, datareader_happy_day,
  .init = suite_get_xxx_sec_attributes_init, .fini = suite_get_xxx_sec_attributes_fini)
{
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  DDS_Security_PartitionQosPolicy * partition = NULL;
...
CU_Test(
  ddssec_builtin_get_xxx_sec_attributes, datareader_non_existing_topic,
  .init = suite_get_xxx_sec_attributes_init, .fini = suite_get_xxx_sec_attributes_fini)
{
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  DDS_Security_PartitionQosPolicy * partition = NULL;
...
CU_Test(
  ddssec_builtin_get_xxx_sec_attributes, participant_invalid_param,
  .init = suite_get_xxx_sec_attributes_init, .fini = suite_get_xxx_sec_attributes_fini)
{
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  DDS_Security_ParticipantSecurityAttributes attributes;
  ...
  result = access_control->get_participant_sec_attributes(
    NULL, local_permissions_handle, &attributes, &exception);
  CU_ASSERT(!result);
  ...
  result =
    access_control->get_participant_sec_attributes(access_control, 0, &attributes, &exception);
  CU_ASSERT(!result);
  CU_ASSERT(exception.code == DDS_SECURITY_ERR_INVALID_PARAMETER_CODE);
  memset(&attributes, 0, sizeof(attributes));
  reset_exception(&exception);
  ...
  result = access_control->get_participant_sec_attributes(
    access_control, local_permissions_handle, NULL, &exception);
  CU_ASSERT(!result);
  CU_ASSERT(exception.code == DDS_SECURITY_ERR_INVALID_PARAMETER_CODE);
  memset(&attributes, 0, sizeof(attributes));
  reset_exception(&exception);
  ...
  result = access_control->get_participant_sec_attributes(
    access_control, local_permissions_handle + 12345, &attributes, &exception);
  CU_ASSERT(!result);
  CU_ASSERT(exception.code == DDS_SECURITY_ERR_INVALID_PARAMETER_CODE);
  memset(&attributes, 0, sizeof(attributes));
  reset_exception(&exception);
...
CU_Test(
  ddssec_builtin_get_xxx_sec_attributes, datareader_invalid_param,
  .init = suite_get_xxx_sec_attributes_init, .fini = suite_get_xxx_sec_attributes_fini)
{
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  DDS_Security_PartitionQosPolicy * partition = NULL;
  ...
  result = access_control->get_datareader_sec_attributes(
    access_control, local_permissions_handle, NULL, partition, &data_tag, &attributes, &exception);
  ...
  result = access_control->get_datareader_sec_attributes(
    access_control, local_permissions_handle, "", partition, &data_tag, &attributes, &exception);
  ...
  result = access_control->get_datareader_sec_attributes(
    access_control, local_permissions_handle, "Shape", partition, &data_tag, NULL, &exception);
  ...
  result = access_control->get_datareader_sec_attributes(
    access_control, local_permissions_handle + 12345, "Shape", partition, &data_tag, &attributes,
    &exception);
...
CU_Test(
  ddssec_builtin_get_xxx_sec_attributes, datawriter_invalid_param,
  .init = suite_get_xxx_sec_attributes_init, .fini = suite_get_xxx_sec_attributes_fini)
{
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  DDS_Security_PartitionQosPolicy * partition = NULL;
...
CU_Test(
  ddssec_builtin_get_xxx_sec_attributes, topic_happy_day, .init = suite_get_xxx_sec_attributes_init,
  .fini = suite_get_xxx_sec_attributes_fini)
{
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  ...
  for (i = SEC_TOPIC_DCPS_KINEMATICS; i <= SEC_TOPIC_DCPS_SHAPE; ++i) {
    result = access_control->get_topic_sec_attributes(
      access_control, local_permissions_handle, TOPIC_NAMES[i], &attributes, &exception);
...
CU_Test(
  ddssec_builtin_get_xxx_sec_attributes, topic_non_existing_topic,
  .init = suite_get_xxx_sec_attributes_init, .fini = suite_get_xxx_sec_attributes_fini)
{
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  DDS_Security_TopicSecurityAttributes attributes;
  ...
  /* Now call the function. */
  result = access_control->get_topic_sec_attributes(
    access_control, local_permissions_handle, TOPIC_NAMES[SEC_TOPIC_DCPS_SHAPE], &attributes,
    &exception);
...
CU_Test(
  ddssec_builtin_get_xxx_sec_attributes, topic_invalid_param,
  .init = suite_get_xxx_sec_attributes_init, .fini = suite_get_xxx_sec_attributes_fini)
{
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  DDS_Security_TopicSecurityAttributes attributes;
  ...
  result = access_control->get_topic_sec_attributes(
    access_control, local_permissions_handle, NULL, &attributes, &exception);
  ...
  result = access_control->get_topic_sec_attributes(
    access_control, local_permissions_handle, "Shape", NULL, &exception);
  ...
  result = access_control->get_topic_sec_attributes(
    access_control, local_permissions_handle + 12345, "Shape", &attributes, &exception);
...
CU_Test(
  ddssec_builtin_get_xxx_sec_attributes, participant_2nd_rule,
  .init = suite_get_xxx_sec_attributes_init, .fini = suite_get_xxx_sec_attributes_fini)
{
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  DDS_Security_ParticipantSecurityAttributes attributes;
  ...
  CU_ASSERT(
    (attributes.plugin_participant_attributes &
     DDS_SECURITY_PLUGIN_PARTICIPANT_ATTRIBUTES_FLAG_IS_RTPS_ENCRYPTED) == 0);
  CU_ASSERT(
    (attributes.plugin_participant_attributes &
     DDS_SECURITY_PLUGIN_PARTICIPANT_ATTRIBUTES_FLAG_IS_DISCOVERY_ENCRYPTED) == 0);
  CU_ASSERT(
  ...
  CU_ASSERT(
    (attributes.plugin_participant_attributes &
     DDS_SECURITY_PLUGIN_PARTICIPANT_ATTRIBUTES_FLAG_IS_RTPS_AUTHENTICATED) == 0);
  CU_ASSERT(
    (attributes.plugin_participant_attributes &
     DDS_SECURITY_PLUGIN_PARTICIPANT_ATTRIBUTES_FLAG_IS_DISCOVERY_AUTHENTICATED) == 0);
  CU_ASSERT(
    (attributes.plugin_participant_attributes &
     DDS_SECURITY_PLUGIN_PARTICIPANT_ATTRIBUTES_FLAG_IS_LIVELINESS_AUTHENTICATED) == 0);
...
static void test_liveliness_discovery_participant_attr(
  DDS_Security_PermissionsHandle hdl, bool liveliness_protected,
  DDS_Security_unsigned_long liveliness_mask, bool discovery_protected,
  DDS_Security_unsigned_long discovery_mask)
{
  DDS_Security_unsigned_long mask =
    DDS_SECURITY_PARTICIPANT_ATTRIBUTES_FLAG_IS_VALID | liveliness_mask | discovery_mask;
  DDS_Security_SecurityException exception = {NULL, 0, 0};
  ...
  result = access_control->get_participant_sec_attributes(access_control, hdl, &attr, &exception);
  CU_ASSERT(result);
  ...
  result = access_control->return_participant_sec_attributes(access_control, &attr, &exception);
  CU_ASSERT(result);
}

static void test_liveliness_discovery_writer_attr(
  const char * topic_name, DDS_Security_PermissionsHandle hdl, bool liveliness_protected,
  bool discovery_protected, bool submsg_protected, DDS_Security_unsigned_long submsg_mask)
{
  ...
  result = access_control->get_datawriter_sec_attributes(
    access_control, hdl, topic_name, partition, &data_tag, &attr, &exception);
  CU_ASSERT_FATAL(result);
  ...
  result = access_control->return_datawriter_sec_attributes(access_control, &attr, &exception);
  CU_ASSERT(result);
}
  ...
  bool discovery_protected, bool submsg_protected, DDS_Security_unsigned_long submsg_mask)
{
  ...
  result = access_control->return_datareader_sec_attributes(access_control, &attr, &exception);
  CU_ASSERT(result);
}

static void test_liveliness_discovery_attr(
  const char * governance, bool liveliness_protected, DDS_Security_unsigned_long liveliness_mask,
  bool discovery_protected, DDS_Security_unsigned_long discovery_mask)
{
  ...
  if (
    liveliness_mask & DDS_SECURITY_PLUGIN_PARTICIPANT_ATTRIBUTES_FLAG_IS_LIVELINESS_AUTHENTICATED) {
    submsg_liveliness_mask |=
  ...
  test_liveliness_discovery_participant_attr(
    local_permissions_handle, liveliness_protected, liveliness_mask, discovery_protected,
    discovery_mask);
  ...
  test_liveliness_discovery_writer_attr(
    ...
    false /* submsg_protected     */, 0 /* submsg_mask          */);

  /* Builtin topic. */
  test_liveliness_discovery_writer_attr(
    "DCPSPublication", local_permissions_handle, false /* liveliness_protected */,
    false /* discovery_protected  */, false /* submsg_protected     */,
    0 /* submsg_mask          */);

  /* Security (normal) builtin topic. */
  test_liveliness_discovery_writer_attr(
    "DCPSPublicationsSecure", local_permissions_handle, false /* liveliness_protected */,
    false /* discovery_protected  */, discovery_protected /* submsg_protected     */,
    submsg_discovery_mask /* submsg_mask          */);

  /* Security (liveliness affected) builtin topic. */
  test_liveliness_discovery_writer_attr(
    "DCPSParticipantMessageSecure", local_permissions_handle, false /* liveliness_protected */,
    false /* discovery_protected  */, liveliness_protected /* submsg_protected     */,
  ...
  test_liveliness_discovery_reader_attr(
    "Kinematics", local_permissions_handle, liveliness_protected, discovery_protected,
    false /* submsg_protected     */, false /* submsg_mask          */);
...
CU_Test(
  ddssec_builtin_get_xxx_sec_attributes, liveliness_discovery_clear,
  .init = suite_get_xxx_sec_attributes_init, .fini = suite_get_xxx_sec_attributes_fini)
{
  /*
     * Expect these values based on these options, which is the 1st domain rule
...
CU_Test(
  ddssec_builtin_get_xxx_sec_attributes, liveliness_discovery_signed,
  .init = suite_get_xxx_sec_attributes_init, .fini = suite_get_xxx_sec_attributes_fini)
{
  /*
     * Expect these values based on these options, which is the 1st domain rule
...
CU_Test(
  ddssec_builtin_get_xxx_sec_attributes, liveliness_discovery_encrypted_and_authenticated,
  .init = suite_get_xxx_sec_attributes_init, .fini = suite_get_xxx_sec_attributes_fini)
{
  /*
     * Expect these values based on these options, which is the 1st domain rule
...
CU_Test(
  ddssec_builtin_get_xxx_sec_attributes, liveliness_discovery_signed_and_authenticated,
  .init = suite_get_xxx_sec_attributes_init, .fini = suite_get_xxx_sec_attributes_fini)
{
  /*
     * Expect these values based on these options, which is the 1st domain rule
...
CU_Test(
  ddssec_builtin_get_xxx_sec_attributes, liveliness_discovery_different,
  .init = suite_get_xxx_sec_attributes_init, .fini = suite_get_xxx_sec_attributes_fini)
{
  /*
     * Expect these values based on these options, which is the 1st domain rule
