...
static size_t alignup_ptr(const unsigned char * ptr, size_t a)
{
  size_t m = (a - 1);
  size_t x = (size_t)ptr;
  return ((x + m) & ~m) - x;
...
DDS_Security_Serializer DDS_Security_Serializer_new(size_t size, size_t increment)
{
...
void DDS_Security_Serializer_free(DDS_Security_Serializer ser)
{
  if (ser) {
...
void DDS_Security_Serializer_buffer(
  DDS_Security_Serializer ser, unsigned char ** buffer, size_t * size)
{
  assert(ser);
  assert(buffer);
  assert(size);
...
static void serbuffer_adjust_size(DDS_Security_Serializer ser, size_t needed)
{
...
static void serbuffer_align(DDS_Security_Serializer ser, size_t alignment)
{
  size_t offset, i;
...
static void DDS_Security_Serialize_mark_len(DDS_Security_Serializer ser)
{
...
static void DDS_Security_Serialize_update_len(DDS_Security_Serializer ser)
{
  unsigned short len;
...
static void DDS_Security_Serialize_uint16(DDS_Security_Serializer ser, unsigned short value)
{
...
static void DDS_Security_Serialize_uint32_t(DDS_Security_Serializer ser, uint32_t value)
{
  serbuffer_align(ser, sizeof(value));
  serbuffer_adjust_size(ser, sizeof(value));
...
static void DDS_Security_Serialize_string(DDS_Security_Serializer ser, const char * str)
{
...
static void DDS_Security_Serialize_Property(
  DDS_Security_Serializer ser, const DDS_Security_Property_t * property)
{
  DDS_Security_Serialize_string(ser, property->name);
  DDS_Security_Serialize_string(ser, property->value);
}

static void DDS_Security_Serialize_OctetSeq(
  DDS_Security_Serializer ser, const DDS_Security_OctetSeq * seq)
{
...
static void DDS_Security_Serialize_BinaryProperty(
  DDS_Security_Serializer ser, const DDS_Security_BinaryProperty_t * property)
{
  DDS_Security_Serialize_string(ser, property->name);
  DDS_Security_Serialize_OctetSeq(ser, &property->value);
}

void DDS_Security_Serialize_PropertySeq(
  DDS_Security_Serializer ser, const DDS_Security_PropertySeq * seq)
{
  uint32_t i;
...
void DDS_Security_Serialize_BinaryPropertyArray(
  DDS_Security_Serializer serializer, const DDS_Security_BinaryProperty_t ** properties,
...
void DDS_Security_Serialize_BinaryPropertySeq(
  DDS_Security_Serializer serializer, const DDS_Security_BinaryPropertySeq * seq)
{
  uint32_t i;
...
static void DDS_Security_Serialize_DataHolder(
  DDS_Security_Serializer ser, const DDS_Security_DataHolder * holder)
{
...
static void DDS_Security_Serialize_BuiltinTopicKey(
  DDS_Security_Serializer ser, DDS_Security_BuiltinTopicKey_t key)
{
  serbuffer_align(ser, sizeof(uint32_t));
...
static void DDS_Security_Serialize_UserDataQosPolicy(
  DDS_Security_Serializer ser, DDS_Security_OctetSeq * seq)
{
  if (seq->_length > 0) {
    serbuffer_align(ser, sizeof(uint32_t));
...
static void DDS_Security_Serialize_IdentityToken(
  DDS_Security_Serializer ser, DDS_Security_IdentityToken * token)
{
  serbuffer_align(ser, sizeof(uint32_t));
...
static void DDS_Security_Serialize_PermissionsToken(
  DDS_Security_Serializer ser, DDS_Security_PermissionsToken * token)
{
  serbuffer_align(ser, sizeof(uint32_t));
...
static void DDS_Security_Serialize_PropertyQosPolicy(
  DDS_Security_Serializer ser, DDS_Security_PropertyQosPolicy * policy)
{
  serbuffer_align(ser, sizeof(uint32_t));
...
static void DDS_Security_Serialize_ParticipantSecurityInfo(
  DDS_Security_Serializer ser, DDS_Security_ParticipantSecurityInfo * info)
{
  serbuffer_align(ser, sizeof(uint32_t));
...
void DDS_Security_Serialize_ParticipantBuiltinTopicData(
  DDS_Security_Serializer ser, DDS_Security_ParticipantBuiltinTopicData * pdata)
{
...
static void DDS_Security_Serialize_OctetArray(
  DDS_Security_Serializer ser, const DDS_Security_octet * data, uint32_t length)
{
...
void DDS_Security_Serialize_KeyMaterial_AES_GCM_GMAC(
  DDS_Security_Serializer ser, const DDS_Security_KeyMaterial_AES_GCM_GMAC * data)
{
  DDS_Security_Serialize_OctetArray(
    ser, data->transformation_kind, sizeof(data->transformation_kind));
  ...
  DDS_Security_Serialize_OctetArray(
    ser, data->receiver_specific_key_id, sizeof(data->receiver_specific_key_id));
  DDS_Security_Serialize_OctetSeq(ser, &data->master_receiver_specific_key);
}

DDS_Security_Deserializer DDS_Security_Deserializer_new(const unsigned char * data, size_t size)
{
...
void DDS_Security_Deserializer_free(DDS_Security_Deserializer dser) { ddsrt_free(dser); }

static void DDS_Security_Deserialize_align(DDS_Security_Deserializer dser, size_t size)
{
...
static int DDS_Security_Deserialize_uint16(DDS_Security_Deserializer dser, unsigned short * value)
{
...
static int DDS_Security_Deserialize_uint32_t(DDS_Security_Deserializer dser, uint32_t * value)
{
  size_t l = sizeof(*value);
...
static int DDS_Security_Deserialize_string(DDS_Security_Deserializer dser, char ** value)
{
  uint32_t len;
  size_t sz;
...
static int DDS_Security_Deserialize_OctetArray(
  DDS_Security_Deserializer dser, unsigned char * arr, uint32_t length)
{
...
static int DDS_Security_Deserialize_OctetSeq(
  DDS_Security_Deserializer dser, DDS_Security_OctetSeq * seq)
{
...
static int DDS_Security_Deserialize_Property(
  DDS_Security_Deserializer dser, DDS_Security_Property_t * property)
{
  return DDS_Security_Deserialize_string(dser, &property->name) &&
         DDS_Security_Deserialize_string(dser, &property->value);
}

static int DDS_Security_Deserialize_BinaryProperty(
  DDS_Security_Deserializer dser, DDS_Security_BinaryProperty_t * property)
{
  return DDS_Security_Deserialize_string(dser, &property->name) &&
         DDS_Security_Deserialize_OctetSeq(dser, &property->value);
}

static int DDS_Security_Deserialize_PropertySeq(
  DDS_Security_Deserializer dser, DDS_Security_PropertySeq * seq)
{
...
static int DDS_Security_Deserialize_BinaryPropertySeq(
  DDS_Security_Deserializer dser, DDS_Security_BinaryPropertySeq * seq)
{
...
static int DDS_Security_Deserialize_DataHolder(
  DDS_Security_Deserializer dser, DDS_Security_DataHolder * holder)
{
...
static int DDS_Security_Deserialize_PropertyQosPolicy(
  DDS_Security_Deserializer dser, DDS_Security_PropertyQosPolicy * policy, size_t len)
{
  size_t sl = dser->remain;

  if (!DDS_Security_Deserialize_PropertySeq(dser, &policy->value)) return 0;
...
static int DDS_Security_Deserialize_BuiltinTopicKey(
  DDS_Security_Deserializer dser, DDS_Security_BuiltinTopicKey_t key)
{
...
static int DDS_Security_Deserialize_ParticipantSecurityInfo(
  DDS_Security_Deserializer dser, DDS_Security_ParticipantSecurityInfo * info)
{
...
int DDS_Security_Deserialize_ParticipantBuiltinTopicData(
  DDS_Security_Deserializer dser, DDS_Security_ParticipantBuiltinTopicData * pdata,
  DDS_Security_SecurityException * ex)
{
  ...
  do {
    DDS_Security_Deserialize_align(dser, 4);
    r = DDS_Security_Deserialize_uint16(dser, &pid) && DDS_Security_Deserialize_uint16(dser, &len);
      ...
      if (r) {
        if (dser->cursor != next_cursor) {
          DDS_Security_Exception_set(
            ex, "Deserialization", DDS_SECURITY_ERR_UNDEFINED_CODE, DDS_SECURITY_VALIDATION_FAILED,
            "Deserialize PID 0x%x failed: internal_size %d != external_size %d", pid,
            (int)len + (int)(dser->cursor - next_cursor), (int)len);
          r = 0;
        }
      } else {
        DDS_Security_Exception_set(
...
void DDS_Security_BuiltinTopicKeyBE(
  DDS_Security_BuiltinTopicKey_t dst, const DDS_Security_BuiltinTopicKey_t src)
{
...
int DDS_Security_Deserialize_KeyMaterial_AES_GCM_GMAC(
  DDS_Security_Deserializer dser, DDS_Security_KeyMaterial_AES_GCM_GMAC * data)
{
  memset(data, 0, sizeof(*data));
  return DDS_Security_Deserialize_OctetArray(
           dser, data->transformation_kind, sizeof(data->transformation_kind)) &&
         DDS_Security_Deserialize_OctetSeq(dser, &data->master_salt) &&
         DDS_Security_Deserialize_OctetArray(
           dser, data->sender_key_id, sizeof(data->sender_key_id)) &&
         DDS_Security_Deserialize_OctetSeq(dser, &data->master_sender_key) &&
         DDS_Security_Deserialize_OctetArray(
           dser, data->receiver_specific_key_id, sizeof(data->receiver_specific_key_id)) &&
