...
static struct ddsrt_circlist_elem * find_return_obj_data(
  struct dds_security_access_control_impl * impl, void * obj)
{
...
static DDS_Security_PermissionsHandle validate_local_permissions(
  ...
  const DDS_Security_IdentityHandle identity, const DDS_Security_DomainId domain_id,
  const DDS_Security_Qos * participant_qos, DDS_Security_SecurityException * ex)
{
  struct dds_security_access_control_impl * impl =
    (struct dds_security_access_control_impl *)instance;
  switch (impl->mode) {
    ...
    case PLUGIN_MODE_WRAPPED: {
      DDS_Security_PermissionsHandle handle = impl->instance->validate_local_permissions(
        impl->instance, auth_plugin, identity, domain_id, participant_qos, ex);
      return handle;
    }
  ...
  DDS_Security_SecurityException * ex)
{
  ...
  switch (impl->mode) {
    case PLUGIN_MODE_NOT_ALLOWED:
      ...
      /* fall through */
    case PLUGIN_MODE_WRAPPED: {
      DDS_Security_PermissionsHandle handle = impl->instance->validate_remote_permissions(
        impl->instance, auth_plugin, local_identity_handle, remote_identity_handle,
  ...
  DDS_Security_SecurityException * ex)
{
  ...
  switch (impl->mode) {
    case PLUGIN_MODE_NOT_ALLOWED:
      ...
      /* fall through */
    case PLUGIN_MODE_WRAPPED:
      return impl->instance->check_create_participant(
        impl->instance, permissions_handle, domain_id, participant_qos, ex);
  ...
  switch (impl->mode) {
    case PLUGIN_MODE_NOT_ALLOWED:
      if (impl->not_allowed_mask & NOT_ALLOWED_LOCAL_WRITER) {
        if (
          topic_name &&
          strncmp(topic_name, AC_WRAPPER_TOPIC_PREFIX, strlen(AC_WRAPPER_TOPIC_PREFIX)) == 0) {
          ex->code = 1;
      ...
      /* fall through */
    case PLUGIN_MODE_WRAPPED:
      return impl->instance->check_create_datawriter(
        impl->instance, permissions_handle, domain_id, topic_name, writer_qos, partition, data_tag,
        ex);
  ...
  const DDS_Security_DataTags * data_tag, DDS_Security_SecurityException * ex)
{
  ...
  switch (impl->mode) {
    case PLUGIN_MODE_NOT_ALLOWED:
      ...
      /* fall through */
    case PLUGIN_MODE_WRAPPED:
      return impl->instance->check_create_datareader(
        impl->instance, permissions_handle, domain_id, topic_name, reader_qos, partition, data_tag,
        ex);
  ...
  DDS_Security_SecurityException * ex)
{
  ...
  switch (impl->mode) {
    case PLUGIN_MODE_NOT_ALLOWED:
      ...
      /* fall through */
    case PLUGIN_MODE_WRAPPED:
      return impl->instance->check_create_topic(
        impl->instance, permissions_handle, domain_id, topic_name, qos, ex);
  ...
  DDS_Security_SecurityException * ex)
{
  ...
  switch (impl->mode) {
    case PLUGIN_MODE_WRAPPED:
    case PLUGIN_MODE_NOT_ALLOWED:
      return impl->instance->check_local_datawriter_register_instance(
        impl->instance, permissions_handle, writer, key, ex);
  ...
  DDS_Security_SecurityException * ex)
{
  ...
  switch (impl->mode) {
    case PLUGIN_MODE_WRAPPED:
    case PLUGIN_MODE_NOT_ALLOWED:
      return impl->instance->check_local_datawriter_dispose_instance(
        impl->instance, permissions_handle, writer, key, ex);
  ...
  DDS_Security_SecurityException * ex)
{
  ...
  switch (impl->mode) {
    case PLUGIN_MODE_NOT_ALLOWED:
      ...
      /* fall through */
    case PLUGIN_MODE_WRAPPED:
      return impl->instance->check_remote_participant(
        impl->instance, permissions_handle, domain_id, participant_data, ex);
  ...
  DDS_Security_SecurityException * ex)
{
  ...
  switch (impl->mode) {
    case PLUGIN_MODE_NOT_ALLOWED:
      ...
      /* fall through */
    case PLUGIN_MODE_WRAPPED:
      return impl->instance->check_remote_datawriter(
        impl->instance, permissions_handle, domain_id, publication_data, ex);
  ...
  switch (impl->mode) {
    case PLUGIN_MODE_NOT_ALLOWED:
      if (impl->not_allowed_mask & NOT_ALLOWED_REMOTE_READER) {
        if (
          subscription_data->topic_name && strncmp(
                                             subscription_data->topic_name, AC_WRAPPER_TOPIC_PREFIX,
                                             strlen(AC_WRAPPER_TOPIC_PREFIX)) == 0) {
          ex->code = 1;
    ...
    case PLUGIN_MODE_WRAPPED: {
      bool ret;
      if ((ret = impl->instance->check_remote_datareader(
             impl->instance, permissions_handle, domain_id, subscription_data, relay_only, ex))) {
        /* Only relay_only for the user reader, not the builtin ones. */
        if (
          impl->mode == PLUGIN_MODE_NOT_ALLOWED &&
          impl->not_allowed_mask & NOT_ALLOWED_REMOTE_READER_RELAY_ONLY) {
          if (
  ...
  DDS_Security_SecurityException * ex)
{
  ...
  switch (impl->mode) {
    case PLUGIN_MODE_NOT_ALLOWED:
      ...
      /* fall through */
    case PLUGIN_MODE_WRAPPED:
      return impl->instance->check_remote_topic(
        impl->instance, permissions_handle, domain_id, topic_data, ex);
  ...
  switch (impl->mode) {
    ...
    case PLUGIN_MODE_NOT_ALLOWED:
      return impl->instance->check_local_datawriter_match(
        impl->instance, writer_permissions_handle, reader_permissions_handle, publication_data,
        subscription_data, ex);
  ...
  DDS_Security_SecurityException * ex)
{
  ...
  switch (impl->mode) {
    case PLUGIN_MODE_WRAPPED:
    case PLUGIN_MODE_NOT_ALLOWED:
      return impl->instance->check_local_datareader_match(
        impl->instance, reader_permissions_handle, writer_permissions_handle, subscription_data,
        publication_data, ex);
  ...
  DDS_Security_SecurityException * ex)
{
  ...
  switch (impl->mode) {
    case PLUGIN_MODE_WRAPPED:
    case PLUGIN_MODE_NOT_ALLOWED:
      return impl->instance->check_remote_datawriter_register_instance(
        impl->instance, permissions_handle, reader, publication_handle, key, instance_handle, ex);
  ...
  const DDS_Security_DynamicData key, DDS_Security_SecurityException * ex)
{
  ...
  switch (impl->mode) {
    case PLUGIN_MODE_WRAPPED:
    case PLUGIN_MODE_NOT_ALLOWED:
      return impl->instance->check_remote_datawriter_dispose_instance(
        impl->instance, permissions_handle, reader, publication_handle, key, ex);
  ...
  const DDS_Security_PermissionsHandle handle, DDS_Security_SecurityException * ex)
{
  ...
  switch (impl->mode) {
    case PLUGIN_MODE_WRAPPED:
      ...
      /* fall through */
    case PLUGIN_MODE_NOT_ALLOWED:
      return impl->instance->get_permissions_credential_token(
        impl->instance, permissions_credential_token, handle, ex);
  ...
  DDS_Security_SecurityException * ex)
{
  ...
  switch (impl->mode) {
    case PLUGIN_MODE_WRAPPED:
      ...
      /* fall through */
    case PLUGIN_MODE_NOT_ALLOWED:
      return impl->instance->return_permissions_credential_token(
        impl->instance, permissions_credential_token, ex);
  ...
  DDS_Security_ParticipantSecurityAttributes * attributes, DDS_Security_SecurityException * ex)
{
  ...
  switch (impl->mode) {
    case PLUGIN_MODE_WRAPPED:
      ...
      /* fall through */
    case PLUGIN_MODE_NOT_ALLOWED:
      return impl->instance->get_participant_sec_attributes(
        impl->instance, permissions_handle, attributes, ex);
  ...
  switch (impl->mode) {
    ...
    case PLUGIN_MODE_NOT_ALLOWED:
      return impl->instance->get_topic_sec_attributes(
        impl->instance, permissions_handle, topic_name, attributes, ex);
  ...
  DDS_Security_EndpointSecurityAttributes * attributes, DDS_Security_SecurityException * ex)
{
  ...
  switch (impl->mode) {
    case PLUGIN_MODE_WRAPPED:
      ...
      /* fall through */
    case PLUGIN_MODE_NOT_ALLOWED:
      return impl->instance->get_datawriter_sec_attributes(
        impl->instance, permissions_handle, topic_name, partition, data_tag, attributes, ex);
  ...
  DDS_Security_EndpointSecurityAttributes * attributes, DDS_Security_SecurityException * ex)
{
  ...
  switch (impl->mode) {
    case PLUGIN_MODE_WRAPPED:
      ...
      /* fall through */
    case PLUGIN_MODE_NOT_ALLOWED:
      return impl->instance->get_datareader_sec_attributes(
        impl->instance, permissions_handle, topic_name, partition, data_tag, attributes, ex);
...
static int finalize_test_access_control_common(
  struct dds_security_access_control_impl * impl, bool wrapped)
{
  int32_t ret;
...
int init_test_access_control_all_ok(
  const char * argument, void ** context, struct ddsi_domaingv * gv)
{
  DDSRT_UNUSED_ARG(context);
  struct dds_security_access_control_impl * impl =
    init_test_access_control_common(argument, false, gv);
...
{
  struct dds_security_access_control_impl * impl =
    (struct dds_security_access_control_impl *)context;
  assert(impl->mode == PLUGIN_MODE_ALL_OK);
  return finalize_test_access_control_common(impl, false);
}

int init_test_access_control_wrapped(
  const char * argument, void ** context, struct ddsi_domaingv * gv)
{
  struct dds_security_access_control_impl * impl =
    init_test_access_control_common(argument, true, gv);
...
int init_test_access_control_missing_func(
  const char * argument, void ** context, struct ddsi_domaingv * gv)
{
  DDSRT_UNUSED_ARG(context);
  struct dds_security_access_control_impl * impl =
...
#define INIT_NOT_ALLOWED(name_, mask_)                                 \
  int init_test_access_control_##name_(                                \
    const char * argument, void ** context, struct ddsi_domaingv * gv) \
  {                                                                    \
    DDSRT_UNUSED_ARG(context);                                         \
    struct dds_security_access_control_impl * impl =                   \
