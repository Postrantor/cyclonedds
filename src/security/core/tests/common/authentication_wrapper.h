...
SECURITY_EXPORT int init_test_authentication_wrapped(
...
SECURITY_EXPORT int init_test_authentication_all_ok(
  const char * argument, void ** context, struct ddsi_domaingv * gv);
...
SECURITY_EXPORT int init_test_authentication_missing_func(
  const char * argument, void ** context, struct ddsi_domaingv * gv);
SECURITY_EXPORT int finalize_test_authentication_missing_func(void * context);

/* Init function fails */
SECURITY_EXPORT int init_test_authentication_init_error(
  const char * argument, void ** context, struct ddsi_domaingv * gv);
SECURITY_EXPORT int finalize_test_authentication_init_error(void * context);

SECURITY_EXPORT enum take_message_result test_authentication_plugin_take_msg(
