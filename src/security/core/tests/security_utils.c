...
CU_Test(ddssec_security_utils, parse_xml_date)
{
  ...
  CU_ASSERT_EQUAL(
    DDS_Security_parse_xml_date("2020-01-01T01:01:01.0000000000001+01:00"), DDS_TIME_INVALID);
  ...
  CU_ASSERT_EQUAL(
    DDS_Security_parse_xml_date("2020-01-01T01:01:01+00:30"), DDS_SECS(1577840461 - 30 * 60));
  CU_ASSERT_EQUAL(
    DDS_Security_parse_xml_date("2020-01-01T01:01:01+01:00"), DDS_SECS(1577840461 - 60 * 60));
  CU_ASSERT_EQUAL(
    DDS_Security_parse_xml_date("2020-01-01T01:01:01+12:00"), DDS_SECS(1577840461 - 12 * 60 * 60));
  CU_ASSERT_EQUAL(
    DDS_Security_parse_xml_date("2020-01-01T01:01:01-01:00"), DDS_SECS(1577840461 + 60 * 60));
  ...
  CU_ASSERT_EQUAL(
    DDS_Security_parse_xml_date("2038-01-19T03:14:08Z"), DDS_SECS(INT64_C(INT32_MAX + 1)));
  ...
  CU_ASSERT_EQUAL(
    DDS_Security_parse_xml_date("2262-04-11T23:47:16.854775807+00:01"), INT64_MAX - DDS_SECS(60));
  CU_ASSERT_EQUAL(
    DDS_Security_parse_xml_date("2262-04-11T23:47:16.854775807-00:01"), DDS_TIME_INVALID);

  CU_ASSERT_EQUAL(
    DDS_Security_parse_xml_date("2020-01-01T01:01:01.000000001+01:00"),
    INT64_C(1577836861000000001));
  CU_ASSERT_EQUAL(
    DDS_Security_parse_xml_date("2020-01-01T01:01:01.0000000004+01:00"),
    INT64_C(1577836861000000000));
  CU_ASSERT_EQUAL(
    DDS_Security_parse_xml_date("2020-01-01T01:01:01.0000000005+01:00"),
    INT64_C(1577836861000000001));
  CU_ASSERT_EQUAL(
    DDS_Security_parse_xml_date("2020-01-01T01:01:01.987654321+01:00"),
    INT64_C(1577836861987654321));
}
