...
typedef char * (*expand_fn)(
  const char * src0, expand_lookup_fn lookup, void * data, uint32_t depth);
...
static void error(const char * s, const char * msg) { errorN(strlen(s), s, msg); }
...
static char * expand_var(
  const char * name, char op, const char * alt, expand_fn expand, expand_lookup_fn lookup,
  void * data, uint32_t depth)
{
...
static char * expand_varbrace(
  const char ** src, expand_fn expand, expand_lookup_fn lookup, void * data, uint32_t depth)
{
...
static char * ddsrt_expand_vars_sh1(
  const char * src0, expand_lookup_fn lookup, void * data, uint32_t depth)
{
...
static char * ddsrt_expand_vars1(
  const char * src0, expand_lookup_fn lookup, void * data, uint32_t depth)
{
