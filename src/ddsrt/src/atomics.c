...
#endif
DDS_EXPORT extern inline uint32_t ddsrt_atomic_add32_ov(volatile ddsrt_atomic_uint32_t *x,
                                                        uint32_t v);
DDS_EXPORT extern inline uint32_t ddsrt_atomic_add32_nv(volatile ddsrt_atomic_uint32_t *x,
                                                        uint32_t v);
#if DDSRT_HAVE_ATOMIC64
DDS_EXPORT extern inline uint64_t ddsrt_atomic_add64_nv(volatile ddsrt_atomic_uint64_t *x,
                                                        uint64_t v);
#endif
/* SUB */
...
#endif
DDS_EXPORT extern inline uint32_t ddsrt_atomic_sub32_ov(volatile ddsrt_atomic_uint32_t *x,
                                                        uint32_t v);
DDS_EXPORT extern inline uint32_t ddsrt_atomic_sub32_nv(volatile ddsrt_atomic_uint32_t *x,
                                                        uint32_t v);
#if DDSRT_HAVE_ATOMIC64
DDS_EXPORT extern inline uint64_t ddsrt_atomic_sub64_nv(volatile ddsrt_atomic_uint64_t *x,
                                                        uint64_t v);
#endif
/* AND */
...
#endif
DDS_EXPORT extern inline uint32_t ddsrt_atomic_and32_ov(volatile ddsrt_atomic_uint32_t *x,
                                                        uint32_t v);
#if DDSRT_HAVE_ATOMIC64
DDS_EXPORT extern inline uint64_t ddsrt_atomic_and64_ov(volatile ddsrt_atomic_uint64_t *x,
                                                        uint64_t v);
#endif
DDS_EXPORT extern inline uint32_t ddsrt_atomic_and32_nv(volatile ddsrt_atomic_uint32_t *x,
                                                        uint32_t v);
#if DDSRT_HAVE_ATOMIC64
DDS_EXPORT extern inline uint64_t ddsrt_atomic_and64_nv(volatile ddsrt_atomic_uint64_t *x,
                                                        uint64_t v);
#endif
/* OR */
...
#endif
DDS_EXPORT extern inline uint32_t ddsrt_atomic_or32_ov(volatile ddsrt_atomic_uint32_t *x,
                                                       uint32_t v);
#if DDSRT_HAVE_ATOMIC64
DDS_EXPORT extern inline uint64_t ddsrt_atomic_or64_ov(volatile ddsrt_atomic_uint64_t *x,
                                                       uint64_t v);
#endif
DDS_EXPORT extern inline uint32_t ddsrt_atomic_or32_nv(volatile ddsrt_atomic_uint32_t *x,
                                                       uint32_t v);
#if DDSRT_HAVE_ATOMIC64
DDS_EXPORT extern inline uint64_t ddsrt_atomic_or64_nv(volatile ddsrt_atomic_uint64_t *x,
                                                       uint64_t v);
#endif
/* CAS */
DDS_EXPORT extern inline int ddsrt_atomic_cas32(volatile ddsrt_atomic_uint32_t *x,
                                                uint32_t exp,
                                                uint32_t des);
#if DDSRT_HAVE_ATOMIC64
DDS_EXPORT extern inline int ddsrt_atomic_cas64(volatile ddsrt_atomic_uint64_t *x,
                                                uint64_t exp,
                                                uint64_t des);
#endif
DDS_EXPORT extern inline int ddsrt_atomic_casptr(volatile ddsrt_atomic_uintptr_t *x,
                                                 uintptr_t exp,
                                                 uintptr_t des);
DDS_EXPORT extern inline int ddsrt_atomic_casvoidp(volatile ddsrt_atomic_voidp_t *x,
                                                   void *exp,
                                                   void *des);
#if DDSRT_HAVE_ATOMIC_LIFO
DDS_EXPORT extern inline int ddsrt_atomic_casvoidp2(
...
void ddsrt_atomic_lifo_pushmany(ddsrt_atomic_lifo_t *head,
                                void *first,
                                void *last,
                                size_t linkoff) {
  uintptr_t a0, b0;
...
void ddsrt_atomics_init(void) {
  for (int i = 0; i < N_MUTEXES; i++) ddsrt_mutex_init(&mutexes[i]);
}

void ddsrt_atomics_fini(void) {
  for (int i = 0; i < N_MUTEXES; i++) ddsrt_mutex_destroy(&mutexes[i]);
}
#else
static ddsrt_mutex_t mutexes[N_MUTEXES] = {
...
void ddsrt_atomic_inc64(volatile ddsrt_atomic_uint64_t *x) { ddsrt_atomic_add64(x, 1); }
uint64_t ddsrt_atomic_inc64_nv(volatile ddsrt_atomic_uint64_t *x) {
  return ddsrt_atomic_add64_nv(x, 1);
}
void ddsrt_atomic_dec64(volatile ddsrt_atomic_uint64_t *x) { ddsrt_atomic_sub64(x, 1); }
