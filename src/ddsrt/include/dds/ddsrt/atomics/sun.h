...
inline void ddsrt_atomic_inc32(volatile ddsrt_atomic_uint32_t * x) { atomic_inc_32(&x->v); }
inline void ddsrt_atomic_inc64(volatile ddsrt_atomic_uint64_t * x) { atomic_inc_64(&x->v); }
inline uint32_t ddsrt_atomic_inc32_ov(volatile ddsrt_atomic_uint32_t * x)
{
  ...
  do {
    oldval = x->v;
    newval = oldval + 1;
  } while (atomic_cas_32(&x->v, oldval, newval) != oldval);
  return oldval;
}
...
inline void ddsrt_atomic_dec32(volatile ddsrt_atomic_uint32_t * x) { atomic_dec_32(&x->v); }
inline void ddsrt_atomic_dec64(volatile ddsrt_atomic_uint64_t * x) { atomic_dec_64(&x->v); }
...
inline uint64_t ddsrt_atomic_dec64_ov(volatile ddsrt_atomic_uint64_t * x)
{
  ...
  do {
    oldval = x->v;
    newval = oldval - 1;
  } while (atomic_cas_64(&x->v, oldval, newval) != oldval);
  return oldval;
}
...
inline void ddsrt_atomic_fence_ldld(void) { membar_consumer(); }
inline void ddsrt_atomic_fence_stst(void) { membar_producer(); }
inline void ddsrt_atomic_fence_acq(void) { membar_enter(); }
inline void ddsrt_atomic_fence_rel(void) { membar_exit(); }
