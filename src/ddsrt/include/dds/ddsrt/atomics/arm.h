...
inline uint32_t ddsrt_atomic_and32_ov(volatile ddsrt_atomic_uint32_t * x, uint32_t v)
{
  ...
  do {
    oldval = x->v;
    newval = oldval & v;
  } while (!ddsrt_atomic_cas32(x, oldval, newval));
  return oldval;
}
...
inline void ddsrt_atomic_fence(void) { __asm volatile("dmb" : : : "memory"); }
inline void ddsrt_atomic_fence_ldld(void) { ddsrt_atomic_fence(); }
inline void ddsrt_atomic_fence_stst(void) { ddsrt_atomic_fence(); }
inline void ddsrt_atomic_fence_acq(void) { ddsrt_atomic_fence(); }
inline void ddsrt_atomic_fence_rel(void) { ddsrt_atomic_fence(); }
