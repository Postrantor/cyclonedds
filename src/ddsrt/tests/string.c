...
CU_TheoryDataPoints(ddsrt_strncasecmp, empty) = {
  ...
  CU_DataPoints(const char *, "", "a", "", "a", "", "a"), CU_DataPoints(size_t, 1, 1, 0, 0, 2, 2),
...
CU_TheoryDataPoints(ddsrt_strncasecmp, length) = {
  ...
  CU_DataPoints(size_t, 3, 3, 4, 4, 5, 5), CU_DataPoints(eq_t, eq, eq, lt, gt, eq, eq)};
...
CU_TheoryDataPoints(ddsrt_str_replace, basic) = {
  CU_DataPoints(
    const char *, "", "a", "aaa", "aaa", "aaa", "aaa", "a", "aa", "acaca", "aacaacaa", "aaa"),
  ...
  CU_DataPoints(
    const char *, "", NULL, "bbb", "bbaa", "bbbba", "ba", "a", "bb", "bbcbbcbb", "bcbcaa", ""),
};

CU_Theory(
  (const char * str, const char * srch, const char * subst, size_t max, const char * exp),
  ddsrt_str_replace, basic)
{
...
CU_TheoryDataPoints(ddsrt_strndup, exact_length) = {
  CU_DataPoints(const char *, "", "a", "abcd"), CU_DataPoints(const char *, "", "a", "abcd"),
...
CU_TheoryDataPoints(ddsrt_strndup, too_long) = {
  CU_DataPoints(const char *, "abcd", "abcd", "abcd"), CU_DataPoints(const char *, "abc", "a", ""),
...
CU_TheoryDataPoints(ddsrt_strndup, too_short) = {
  ...
  CU_DataPoints(const char *, "", "", "a", "a", "abc"), CU_DataPoints(size_t, 1, 2, 2, 4, 4)};
