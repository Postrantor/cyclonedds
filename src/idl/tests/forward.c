...
CU_Test(idl_forward, struct_union_maybe_enum)
{
  static const struct
  {
    ...
    {IDL_RETCODE_SEMANTIC_ERROR, 0u,
     "union a; struct a; union a switch (short) { case 1: long b; };"},
  ...
  for (size_t i = 0; i < sizeof(tests) / sizeof(tests[0]); i++) {
    ...
    if (ret == IDL_RETCODE_OK) {
      ...
      assert(pstate);
      for (node = pstate->root; idl_is_forward(node); node = idl_next(node)) forward = node;
...
CU_Test(idl_forward, aliases)
{
  static const struct
  {
    ...
    {1, "union a; typedef a b; union a switch(short) { case 1: long b; };", IDL_RETCODE_OK,
     IDL_UNION},
    {2, "union a; union a; typedef a b; union a switch(short) { case 1: long b; };", IDL_RETCODE_OK,
     IDL_UNION}};
...
CU_Test(idl_forward, backwards_aliases)
{
  static const struct
  {
    ...
    {1, "union a switch(short) { case 1: long b; }; union a; typedef a b;", IDL_RETCODE_OK,
     IDL_UNION},
    {2, "union a switch(short) { case 1: long b; }; union a; union a; typedef a b;", IDL_RETCODE_OK,
     IDL_UNION}};
...
CU_Test(idl_forward, incomplete_type)
{
  static const struct
  {
    ...
    {"struct a; typedef a c; struct b { c f1; }; struct a { long a1; };",
    ...
    {"union a; struct b { a f1; }; union a switch(long) { case 1: long a1; };",
     IDL_RETCODE_SEMANTIC_ERROR},
    {"union a; struct b { @external a f1; }; union a switch(long) { case 1: long a1; };",
     IDL_RETCODE_OK},
    {"struct a; union b switch(long) { case 1: a f1; }; struct a { long a1; };",
     IDL_RETCODE_SEMANTIC_ERROR},
    {"struct a; union b switch(long) { case 1: @external a f1; }; struct a { long a1; };",
     IDL_RETCODE_OK},
  };
