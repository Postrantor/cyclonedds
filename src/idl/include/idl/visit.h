...
typedef idl_retcode_t (*idl_visitor_callback_t)(
  const struct idl_pstate * pstate, const bool revisit, const idl_path_t * path, const void * node,
  void * user_data);
...
IDL_EXPORT idl_retcode_t idl_visit(
  const struct idl_pstate * pstate, const void * node, const idl_visitor_t * visitor,
  void * user_data);
