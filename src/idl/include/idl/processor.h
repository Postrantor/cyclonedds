...
IDL_EXPORT idl_retcode_t idl_create_pstate(
  uint32_t flags, const idl_builtin_annotation_t * annotations, idl_pstate_t ** pstatep);

IDL_EXPORT void idl_delete_pstate(idl_pstate_t * pstate);

IDL_EXPORT idl_retcode_t idl_parse(idl_pstate_t * pstate);

IDL_EXPORT idl_retcode_t idl_parse_string(idl_pstate_t * pstate, const char * str);

IDL_EXPORT void idl_verror(
  const idl_pstate_t * pstate, const idl_location_t * loc, const char * fmt, va_list ap);

IDL_EXPORT void idl_error(
  const idl_pstate_t * pstate, const idl_location_t * loc, const char * fmt, ...)
  idl_attribute_format_printf(3, 4);

IDL_EXPORT void idl_warning(
