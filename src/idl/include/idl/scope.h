...
IDL_EXPORT const idl_declaration_t * idl_find(
  const struct idl_pstate * pstate, const idl_scope_t * scope, const idl_name_t * name,
  uint32_t flags);

IDL_EXPORT const idl_declaration_t * idl_find_scoped_name(
  const struct idl_pstate * pstate, const idl_scope_t * scope,
  const idl_scoped_name_t * scoped_name, uint32_t flags);

IDL_EXPORT const idl_declaration_t * idl_find_field_name(
  const struct idl_pstate * pstate, const idl_scope_t * scope, const idl_field_name_t * field_name,
  uint32_t flags);
