...
// ICEORYX_TODO: the iceoryx listener has a maximum number of subscribers that can be registered but this can only be
// queried at runtime
// 目前，iceoryx监听器在运行时只能查询到最大订阅者数量
// currently it is hardcoded to be 128 events in the iceoryx C binding
// 当前，在iceoryx C绑定中硬编码为128个事件
