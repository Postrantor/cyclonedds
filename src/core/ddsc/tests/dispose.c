...
static void disposing_init(void)
{
  ...
  g_topic = dds_create_topic(
    ...
    create_unique_topic_name("ddsc_disposing_test", name, sizeof name), qos, NULL);
...
static void disposing_fini(void)
{
  dds_delete(g_reader);
  dds_delete(g_writer);
...
CU_Theory(
  (dds_entity_t writer), ddsc_writedispose, invalid_writers, .init = disposing_init,
  .fini = disposing_fini)
{
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t * writer), ddsc_writedispose, non_writers, .init = disposing_init,
  .fini = disposing_fini)
{
  dds_return_t ret;
  DDSRT_WARNING_MSVC_OFF(6387); /* Disable SAL warning on intentional misuse of the API */
...
CU_Theory(
  (dds_entity_t writer), ddsc_writedispose_ts, invalid_writers, .init = disposing_init,
  .fini = disposing_fini)
{
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t * writer), ddsc_writedispose_ts, non_writers, .init = disposing_init,
  .fini = disposing_fini)
{
  dds_return_t ret;
  DDSRT_WARNING_MSVC_OFF(6387); /* Disable SAL warning on intentional misuse of the API */
...
/*************************************************************************************************/
CU_Test(
  ddsc_writedispose_ts, disposing_old_instance, .init = disposing_init, .fini = disposing_fini)
{
  Space_Type1 oldInstance = {0, 22, 22};
  dds_return_t ret;
...
/*************************************************************************************************/
CU_Test(
  ddsc_writedispose_ts, disposing_new_instance, .init = disposing_init, .fini = disposing_fini)
{
  Space_Type1 newInstance = {INITIAL_SAMPLES, 42, 42};
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t writer), ddsc_dispose, invalid_writers, .init = disposing_init,
  .fini = disposing_fini)
{
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t * writer), ddsc_dispose, non_writers, .init = disposing_init,
  .fini = disposing_fini)
{
  dds_return_t ret;
  DDSRT_WARNING_MSVC_OFF(6387); /* Disable SAL warning on intentional misuse of the API */
...
CU_Theory(
  (dds_entity_t writer), ddsc_dispose_ts, invalid_writers, .init = disposing_init,
  .fini = disposing_fini)
{
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t * writer), ddsc_dispose_ts, non_writers, .init = disposing_init,
  .fini = disposing_fini)
{
  dds_return_t ret;
  DDSRT_WARNING_MSVC_OFF(6387); /* Disable SAL warning on intentional misuse of the API */
...
CU_Theory(
  (dds_instance_handle_t handle), ddsc_dispose_ih, invalid_handles, .init = disposing_init,
  .fini = disposing_fini)
{
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t writer), ddsc_dispose_ih, invalid_writers, .init = disposing_init,
  .fini = disposing_fini)
{
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t * writer), ddsc_dispose_ih, non_writers, .init = disposing_init,
  .fini = disposing_fini)
{
  dds_return_t ret;
  ret = dds_dispose_ih(*writer, DDS_HANDLE_NIL);
...
CU_Theory(
  (dds_instance_handle_t handle), ddsc_dispose_ih_ts, invalid_handles, .init = disposing_init,
  .fini = disposing_fini)
{
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t writer), ddsc_dispose_ih_ts, invalid_writers, .init = disposing_init,
  .fini = disposing_fini)
{
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t * writer), ddsc_dispose_ih_ts, non_writers, .init = disposing_init,
  .fini = disposing_fini)
{
  dds_return_t ret;
  ret = dds_dispose_ih_ts(*writer, DDS_HANDLE_NIL, g_present);
