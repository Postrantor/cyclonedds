...
static void init_entity_status(void)
{
  char topicName[100];
  ...
  top = dds_create_topic(
    participant, &RoundTripModule_DataType_desc,
    create_unique_topic_name("ddsc_status_test", topicName, 100), NULL, NULL);
  CU_ASSERT(top > 0);

  qos = dds_create_qos();
  CU_ASSERT_PTR_NOT_NULL_FATAL(qos);
  dds_qset_resource_limits(
    qos, resource_limits.max_samples, resource_limits.max_instances,
...
static void fini_entity_status(void)
{
 ...
 ****************************************************************************/
CU_Test(
  ddsc_entity_status, publication_matched, .init = init_entity_status, .fini = fini_entity_status)
{
...
CU_Test(
  ddsc_entity_status, subscription_matched, .init = init_entity_status, .fini = fini_entity_status)
{
...
CU_Test(ddsc_entity, all_data_available, .init = init_entity_status, .fini = fini_entity_status)
{
  ...
  ret =
    dds_take_status(reader2, &sta, DDS_SUBSCRIPTION_MATCHED_STATUS | DDS_LIVELINESS_CHANGED_STATUS);
  CU_ASSERT_EQUAL_FATAL(ret, DDS_RETCODE_OK);
  CU_ASSERT_EQUAL_FATAL(sta, DDS_SUBSCRIPTION_MATCHED_STATUS | DDS_LIVELINESS_CHANGED_STATUS);
...
CU_Theory(
  (dds_entity_t e), ddsc_get_enabled_status, bad_param, .init = init_entity_status,
  .fini = fini_entity_status)
{
  uint32_t mask;
...
CU_Test(
  ddsc_get_enabled_status, deleted_reader, .init = init_entity_status, .fini = fini_entity_status)
{
  uint32_t mask;
  dds_delete(rea);
...
CU_Theory(
  (dds_entity_t * e), ddsc_get_enabled_status, status_ok, .init = init_entity_status,
  .fini = fini_entity_status)
{
  uint32_t mask;
  ret = dds_get_status_mask(*e, &mask);
...
CU_Theory(
  (dds_entity_t e), ddsc_set_enabled_status, bad_param, .init = init_entity_status,
  .fini = fini_entity_status)
{
...
CU_Test(
  ddsc_set_enabled_status, deleted_reader, .init = init_entity_status, .fini = fini_entity_status)
{
  dds_delete(rea);
...
CU_Theory(
  (dds_entity_t * entity), ddsc_set_enabled_status, status_ok, .init = init_entity_status,
  .fini = fini_entity_status)
{
...
CU_Theory(
  (dds_entity_t e), ddsc_read_status, bad_param, .init = init_entity_status,
  .fini = fini_entity_status)
{
  uint32_t status;
...
CU_Theory(
  (dds_entity_t * e), ddsc_read_status, status_ok, .init = init_entity_status,
  .fini = fini_entity_status)
{
  uint32_t status;
...
CU_Test(
  ddsc_read_status, invalid_status_on_reader, .init = init_entity_status,
  .fini = fini_entity_status)
{
  uint32_t status;
...
CU_Test(
  ddsc_read_status, invalid_status_on_writer, .init = init_entity_status,
  .fini = fini_entity_status)
{
  uint32_t status;
...
CU_Theory(
  (dds_entity_t e), ddsc_take_status, bad_param, .init = init_entity_status,
  .fini = fini_entity_status)
{
  uint32_t status;
...
CU_Theory(
  (dds_entity_t * e), ddsc_take_status, status_ok, .init = init_entity_status,
  .fini = fini_entity_status)
{
  uint32_t status;
  ret = dds_take_status(*e, &status, 0 /*mask*/);
...
CU_Theory(
  (dds_entity_t e), ddsc_get_status_changes, bad_param, .init = init_entity_status,
  .fini = fini_entity_status)
{
  uint32_t status;
...
CU_Test(
  ddsc_get_status_changes, deleted_reader, .init = init_entity_status, .fini = fini_entity_status)
{
  uint32_t status;
  dds_delete(rea);
...
CU_Theory(
  (dds_entity_t * e), ddsc_get_status_changes, status_ok, .init = init_entity_status,
  .fini = fini_entity_status)
{
  uint32_t status;
  ret = dds_get_status_changes(*e, &status);
...
CU_Theory(
  (dds_entity_t e), ddsc_triggered, bad_param, .init = init_entity_status,
  .fini = fini_entity_status)
{
  ret = dds_triggered(e);
  CU_ASSERT_EQUAL_FATAL(ret, DDS_RETCODE_BAD_PARAMETER);
...
CU_TheoryDataPoints(ddsc_triggered, status_ok) = {
  CU_DataPoints(
    dds_entity_t *, &rea, &wri, &participant, &top, &publisher, &subscriber, &waitSetrd),
};
CU_Theory(
  (dds_entity_t * e), ddsc_triggered, status_ok, .init = init_entity_status,
  .fini = fini_entity_status)
{
  ret = dds_triggered(*e);
  CU_ASSERT_FATAL(ret >= 0);
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_inconsistent_topic_status, inconsistent_topic_status, .init = init_entity_status,
  .fini = fini_entity_status)
{
...
CU_Theory(
  (dds_entity_t topic), ddsc_get_inconsistent_topic_status, bad_params, .init = init_entity_status,
  .fini = fini_entity_status)
{
  dds_inconsistent_topic_status_t topic_status;
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_inconsistent_topic_status, null, .init = init_entity_status, .fini = fini_entity_status)
{
...
CU_Theory(
  (dds_entity_t * topic), ddsc_get_inconsistent_topic_status, non_topics,
  .init = init_entity_status, .fini = fini_entity_status)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_inconsistent_topic_status, deleted_topic, .init = init_entity_status,
  .fini = fini_entity_status)
{
  dds_delete(top);
  ret = dds_get_inconsistent_topic_status(top, NULL);
...
CU_Theory(
  (dds_entity_t writer), ddsc_get_publication_matched_status, bad_params,
  .init = init_entity_status, .fini = fini_entity_status)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_publication_matched_status, null, .init = init_entity_status, .fini = fini_entity_status)
{
...
CU_Theory(
  (dds_entity_t * writer), ddsc_get_publication_matched_status, non_writers,
  .init = init_entity_status, .fini = fini_entity_status)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_publication_matched_status, deleted_writer, .init = init_entity_status,
  .fini = fini_entity_status)
{
  dds_delete(wri);
  ret = dds_get_publication_matched_status(wri, NULL);
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_liveliness_lost_status, liveliness_lost_status, .init = init_entity_status,
  .fini = fini_entity_status)
{
...
CU_Theory(
  (dds_entity_t writer), ddsc_get_liveliness_lost_status, bad_params, .init = init_entity_status,
  .fini = fini_entity_status)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_liveliness_lost_status, null, .init = init_entity_status, .fini = fini_entity_status)
{
  dds_set_status_mask(wri, 0);
...
CU_Theory(
  (dds_entity_t * writer), ddsc_get_liveliness_lost_status, non_writers, .init = init_entity_status,
  .fini = fini_entity_status)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_liveliness_lost_status, deleted_writer, .init = init_entity_status,
  .fini = fini_entity_status)
{
  dds_delete(wri);
  ret = dds_get_liveliness_lost_status(wri, NULL);
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_offered_deadline_missed_status, offered_deadline_missed_status,
  .init = init_entity_status, .fini = fini_entity_status)
{
...
CU_Theory(
  (dds_entity_t writer), ddsc_get_offered_deadline_missed_status, bad_params,
  .init = init_entity_status, .fini = fini_entity_status)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_offered_deadline_missed_status, null, .init = init_entity_status,
  .fini = fini_entity_status)
{
  dds_set_status_mask(wri, 0);
...
CU_Theory(
  (dds_entity_t * writer), ddsc_get_offered_deadline_missed_status, non_writers,
  .init = init_entity_status, .fini = fini_entity_status)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_offered_deadline_missed_status, deleted_writer, .init = init_entity_status,
  .fini = fini_entity_status)
{
  dds_delete(wri);
  ret = dds_get_offered_deadline_missed_status(wri, NULL);
...
CU_Theory(
  (dds_entity_t writer), ddsc_get_offered_incompatible_qos_status, bad_params,
  .init = init_entity_status, .fini = fini_entity_status)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_offered_incompatible_qos_status, null, .init = init_entity_status,
  .fini = fini_entity_status)
{
  dds_set_status_mask(wri, 0);
...
CU_Theory(
  (dds_entity_t * writer), ddsc_get_offered_incompatible_qos_status, non_writers,
  .init = init_entity_status, .fini = fini_entity_status)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_offered_incompatible_qos_status, deleted_writer, .init = init_entity_status,
  .fini = fini_entity_status)
{
  dds_delete(wri);
  ret = dds_get_offered_incompatible_qos_status(wri, NULL);
...
CU_Theory(
  (dds_entity_t reader), ddsc_get_subscription_matched_status, bad_params,
  .init = init_entity_status, .fini = fini_entity_status)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_subscription_matched_status, null, .init = init_entity_status,
  .fini = fini_entity_status)
{
...
CU_Theory(
  (dds_entity_t * reader), ddsc_get_subscription_matched_status, non_readers,
  .init = init_entity_status, .fini = fini_entity_status)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_subscription_matched_status, deleted_reader, .init = init_entity_status,
  .fini = fini_entity_status)
{
  dds_delete(rea);
  ret = dds_get_subscription_matched_status(rea, NULL);
...
CU_Theory(
  (dds_entity_t reader), ddsc_get_liveliness_changed_status, bad_params, .init = init_entity_status,
  .fini = fini_entity_status)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_liveliness_changed_status, null, .init = init_entity_status, .fini = fini_entity_status)
{
  dds_set_status_mask(rea, 0);
...
CU_Theory(
  (dds_entity_t * reader), ddsc_get_liveliness_changed_status, non_readers,
  .init = init_entity_status, .fini = fini_entity_status)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_liveliness_changed_status, deleted_reader, .init = init_entity_status,
  .fini = fini_entity_status)
{
  dds_delete(rea);
  ret = dds_get_liveliness_changed_status(rea, NULL);
...
CU_Theory(
  (dds_entity_t reader), ddsc_get_sample_rejected_status, bad_params, .init = init_entity_status,
  .fini = fini_entity_status)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_sample_rejected_status, null, .init = init_entity_status, .fini = fini_entity_status)
{
  dds_set_status_mask(rea, 0);
...
CU_Theory(
  (dds_entity_t * reader), ddsc_get_sample_rejected_status, non_readers, .init = init_entity_status,
  .fini = fini_entity_status)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_sample_rejected_status, deleted_reader, .init = init_entity_status,
  .fini = fini_entity_status)
{
  dds_delete(rea);
  ret = dds_get_sample_rejected_status(rea, NULL);
...
CU_Theory(
  (dds_entity_t reader), ddsc_get_sample_lost_status, bad_params, .init = init_entity_status,
  .fini = fini_entity_status)
{
...
CU_Theory(
  (dds_entity_t * reader), ddsc_get_sample_lost_status, non_readers, .init = init_entity_status,
  .fini = fini_entity_status)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_sample_lost_status, deleted_reader, .init = init_entity_status,
  .fini = fini_entity_status)
{
  dds_delete(rea);
  ret = dds_get_sample_lost_status(rea, NULL);
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_requested_deadline_missed_status, requested_deadline_missed_status,
  .init = init_entity_status, .fini = fini_entity_status)
{
...
CU_Theory(
  (dds_entity_t reader), ddsc_get_requested_deadline_missed_status, bad_params,
  .init = init_entity_status, .fini = fini_entity_status)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_requested_deadline_missed_status, null, .init = init_entity_status,
  .fini = fini_entity_status)
{
  dds_set_status_mask(rea, 0);
...
CU_Theory(
  (dds_entity_t * reader), ddsc_get_requested_deadline_missed_status, non_readers,
  .init = init_entity_status, .fini = fini_entity_status)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_requested_deadline_missed_status, deleted_reader, .init = init_entity_status,
  .fini = fini_entity_status)
{
  dds_delete(rea);
  ret = dds_get_requested_deadline_missed_status(rea, NULL);
...
CU_Theory(
  (dds_entity_t reader), ddsc_get_requested_incompatible_qos_status, bad_params,
  .init = init_entity_status, .fini = fini_entity_status)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_requested_incompatible_qos_status, null, .init = init_entity_status,
  .fini = fini_entity_status)
{
  dds_set_status_mask(rea, 0);
...
CU_Theory(
  (dds_entity_t * reader), ddsc_get_requested_incompatible_qos_status, non_readers,
  .init = init_entity_status, .fini = fini_entity_status)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_get_requested_incompatible_qos_status, deleted_reader, .init = init_entity_status,
  .fini = fini_entity_status)
{
  dds_delete(rea);
  ret = dds_get_requested_incompatible_qos_status(rea, NULL);
