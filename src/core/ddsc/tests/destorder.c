...
CU_Test(ddsc_destorder, by_source)
{
  ...
  dotest(
    ...
    "  take{(1,1,0)} r");
  dotest(
    "w(do=s) x(do=s) y(do=s) r(do=s,h=1)"
...
CU_Test(ddsc_destorder, by_reception)
{
  ...
  dotest(
    ...
    "  take{(1,2,0)} r");
  dotest(
    "w(do=r) x(do=r) y(do=r) r(do=r,h=1)"
    "  wr y (1,0,0)@1"
    "  wr w (1,1,0)@1"
    "  wr x (1,2,0)@1"
    "  take{(1,2,0)} r");
...
CU_Test(ddsc_destorder, by_source_history)
{
  ...
  dotest(
    "w(do=s) x(do=s) y(do=s) r(do=s,h=3)"
    "  wr y (1,0,0)@1"
    "  wr w (1,1,0)@1"
    "  wr x (1,2,0)@1"
    "  take{(1,0,0),(1,1,0)} r");
...
CU_Test(ddsc_destorder, by_reception_history)
{
  ...
  dotest(
    "w(do=r) x(do=r) y(do=r) r(do=r,h=3)"
    "  wr y (1,0,0)@1"
    "  wr w (1,1,0)@1.1"
    "  wr x (1,2,0)@1.2"
    "  take{(1,0,0),(1,1,0),(1,2,0)} r");
