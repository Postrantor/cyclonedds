...
static void do_test(dds_dynamic_type_t * dtype)
{
  ...
  ret = dds_create_topic_descriptor(
    DDS_FIND_SCOPE_LOCAL_DOMAIN, participant, type_info, 0, &descriptor);
  CU_ASSERT_EQUAL_FATAL(ret, DDS_RETCODE_OK);
...
CU_Test(ddsc_dynamic_type, basic, .init = dynamic_type_init, .fini = dynamic_type_fini)
{
  ...
  dds_dynamic_type_add_member(
    &dstruct, DDS_DYNAMIC_MEMBER_PRIM(DDS_DYNAMIC_UINT32, "member_uint32"));
  do_test(&dstruct);
}
...
CU_Test(ddsc_dynamic_type, entity_kinds, .init = dynamic_type_init, .fini = dynamic_type_fini)
{
  ...
  dds_entity_t topic = dds_create_topic(
    participant, &Space_Type1_desc,
    create_unique_topic_name("ddsc_dynamic_type_test", name, sizeof name), NULL, NULL);
...
#define TYPE_SPEC_PRIM_NC(p)                                       \
  {                                                                \
    .kind = DDS_DYNAMIC_TYPE_KIND_PRIMITIVE, .type.primitive = (p) \
  }
...
CU_Test(ddsc_dynamic_type, type_create, .init = dynamic_type_init, .fini = dynamic_type_fini)
{
  ...
  static const struct
  {
    ...
    {{.kind = DDS_DYNAMIC_ALIAS, .name = "t", .base_type = TYPE_SPEC_PRIM_NC(DDS_DYNAMIC_INT32)},
     DDS_RETCODE_OK},
    {{.kind = DDS_DYNAMIC_ARRAY,
      .name = "t",
      .element_type = TYPE_SPEC_PRIM_NC(DDS_DYNAMIC_INT32),
      .bounds = bounds,
      .num_bounds = 1},
     DDS_RETCODE_OK},
    ...
    {{.kind = DDS_DYNAMIC_UNION,
      .name = "t",
      .discriminator_type = TYPE_SPEC_PRIM_NC(DDS_DYNAMIC_INT32)},
     DDS_RETCODE_OK},
  ...
  for (uint32_t i = 0; i < sizeof(tests) / sizeof(tests[0]); i++) {
    ...
    if (tests[i].ret == DDS_RETCODE_OK) dds_dynamic_type_unref(&dtype);
  }
}
...
CU_Test(ddsc_dynamic_type, struct_member_id, .init = dynamic_type_init, .fini = dynamic_type_fini)
{
  ...
  dstruct = dds_dynamic_type_create(
    participant, (dds_dynamic_type_descriptor_t){.kind = DDS_DYNAMIC_STRUCTURE, .name = "t"});
  ...
  dds_dynamic_type_add_member(
    &dstruct, ((dds_dynamic_member_descriptor_t){
  ...
  CU_ASSERT_EQUAL_FATAL(
    type->xt._u.structure.members.seq[0].id, ddsi_dynamic_type_member_hashid("m0"));
  CU_ASSERT_EQUAL_FATAL(
    type->xt._u.structure.members.seq[1].id, ddsi_dynamic_type_member_hashid("m1"));
  CU_ASSERT_EQUAL_FATAL(type->xt._u.structure.members.seq[2].id, 123);
  CU_ASSERT_EQUAL_FATAL(
    type->xt._u.structure.members.seq[3].id, ddsi_dynamic_type_member_hashid("m3"));

  dds_dynamic_type_unref(&dstruct);
}

CU_Test(
  ddsc_dynamic_type, extensibility_invalid, .init = dynamic_type_init, .fini = dynamic_type_fini)
{
  dds_return_t ret;
  ...
  // Invalid type
  dds_dynamic_type_t dbool = dds_dynamic_type_create(
    participant, (dds_dynamic_type_descriptor_t){.kind = DDS_DYNAMIC_BOOLEAN});
...
CU_Test(
  ddsc_dynamic_type, extensibility_valid, .init = dynamic_type_init, .fini = dynamic_type_fini)
{
  static const struct
  {
    bool default_ext;
  ...
  for (uint32_t i = 0; i < sizeof(tests) / sizeof(tests[0]); i++) {
    dds_dynamic_type_t dstruct = dds_dynamic_type_create(
      participant, (dds_dynamic_type_descriptor_t){.kind = DDS_DYNAMIC_STRUCTURE, .name = "t"});
    if (!tests[i].default_ext) dds_dynamic_type_set_extensibility(&dstruct, tests[i].dyn_ext);
    dds_dynamic_type_add_member(&dstruct, DDS_DYNAMIC_MEMBER_PRIM(DDS_DYNAMIC_UINT16, "m1"));
...
CU_Test(ddsc_dynamic_type, bit_bound, .init = dynamic_type_init, .fini = dynamic_type_fini)
{
  ...
  dds_dynamic_type_t dbitmask = dds_dynamic_type_create(
    participant, (dds_dynamic_type_descriptor_t){.kind = DDS_DYNAMIC_BITMASK, .name = "b"});
  dds_dynamic_type_t denum = dds_dynamic_type_create(
    participant, (dds_dynamic_type_descriptor_t){.kind = DDS_DYNAMIC_ENUMERATION, .name = "e"});
  ...
  // Type may not have members
  dbitmask = dds_dynamic_type_create(
    participant, (dds_dynamic_type_descriptor_t){.kind = DDS_DYNAMIC_BITMASK, .name = "b"});
...
CU_Test(
  ddsc_dynamic_type, bitmask_field_invalid, .init = dynamic_type_init, .fini = dynamic_type_fini)
{
  // Bitmask type NULL
...
CU_Test(ddsc_dynamic_type, enum_type, .init = dynamic_type_init, .fini = dynamic_type_fini)
{
  ...
  dds_dynamic_type_add_enum_literal(
    &denum, "e_31", DDS_DYNAMIC_ENUM_LITERAL_VALUE((1u << 31) - 1), false);
...
CU_Test(
  ddsc_dynamic_type, enum_literal_invalid, .init = dynamic_type_init, .fini = dynamic_type_fini)
{
  // Enum type NULL
  dds_return_t ret =
    dds_dynamic_type_add_enum_literal(NULL, "b1", DDS_DYNAMIC_ENUM_LITERAL_VALUE(1), false);
  CU_ASSERT_EQUAL_FATAL(ret, DDS_RETCODE_BAD_PARAMETER);
...
CU_Test(ddsc_dynamic_type, struct_member_prop, .init = dynamic_type_init, .fini = dynamic_type_fini)
{
  ...
  dds_return_t ret =
    dds_dynamic_member_set_key(&dstruct, ddsi_dynamic_type_member_hashid("m2"), true);
  CU_ASSERT_EQUAL_FATAL(ret, DDS_RETCODE_OK);
  ...
  ret = dds_dynamic_member_set_must_understand(
    &dstruct, ddsi_dynamic_type_member_hashid("m2_name"), true);
  CU_ASSERT_EQUAL_FATAL(ret, DDS_RETCODE_OK);
  ...
  CU_ASSERT_EQUAL_FATAL(
    type->xt._u.structure.members.seq[0].id, ddsi_dynamic_type_member_hashid("m1"));
  ...
  CU_ASSERT_EQUAL_FATAL(
    type->xt._u.structure.members.seq[1].id, ddsi_dynamic_type_member_hashid("m2_name"));
...
CU_Test(
  ddsc_dynamic_type, struct_member_prop_invalid, .init = dynamic_type_init,
  .fini = dynamic_type_fini)
{
  dds_dynamic_type_t dstruct;
  dds_return_t ret;
  ...
  dds_dynamic_type_t dsubstruct = dds_dynamic_type_create(
    participant, (dds_dynamic_type_descriptor_t){.kind = DDS_DYNAMIC_STRUCTURE, .name = "s"});
...
{
  dds_dynamic_type_t dunion = dds_dynamic_type_create(
    participant, (dds_dynamic_type_descriptor_t){
                   .kind = DDS_DYNAMIC_UNION,
                   .name = "u",
  ...
  dds_dynamic_type_add_member(
    &dunion, DDS_DYNAMIC_UNION_MEMBER_PRIM(DDS_DYNAMIC_INT32, "m1", 2, ((int32_t[]){1, 2})));
  dds_dynamic_type_add_member(
    &dunion, DDS_DYNAMIC_UNION_MEMBER_PRIM(DDS_DYNAMIC_INT32, "m2", 1, ((int32_t[]){5})));
  dds_dynamic_type_add_member(
    &dunion, DDS_DYNAMIC_UNION_MEMBER_DEFAULT_PRIM(DDS_DYNAMIC_BOOLEAN, "md"));

  dds_return_t ret =
    dds_dynamic_member_set_hashid(&dunion, ddsi_dynamic_type_member_hashid("m2"), "m2_name");
  CU_ASSERT_EQUAL_FATAL(ret, DDS_RETCODE_OK);
  // Because of the set_hashid, from this point the member has a different id
  ...
  CU_ASSERT_EQUAL_FATAL(
    type->xt._u.union_type.members.seq[0].id, ddsi_dynamic_type_member_hashid("m1"));
  ...
  CU_ASSERT_EQUAL_FATAL(
    type->xt._u.union_type.members.seq[1].id, ddsi_dynamic_type_member_hashid("m2_name"));
  ...
  CU_ASSERT_EQUAL_FATAL(
    type->xt._u.union_type.members.seq[2].id, ddsi_dynamic_type_member_hashid("md"));
...
CU_Test(
  ddsc_dynamic_type, union_member_prop_invalid, .init = dynamic_type_init,
  .fini = dynamic_type_fini)
{
  ...
  dds_dynamic_type_set_autoid(&dunion, DDS_DYNAMIC_TYPE_AUTOID_HASH);
  dds_dynamic_type_add_member(
    &dunion, DDS_DYNAMIC_UNION_MEMBER_PRIM(DDS_DYNAMIC_INT32, "m1", 1, ((int32_t[]){1})));
  dds_dynamic_type_add_member(
    &dunion, DDS_DYNAMIC_UNION_MEMBER_PRIM(DDS_DYNAMIC_INT32, "m2", 1, ((int32_t[]){2})));
  ...
  ret = dds_dynamic_type_add_member(
    &dunion, DDS_DYNAMIC_UNION_MEMBER_PRIM(DDS_DYNAMIC_INT32, "m2", 1, ((int32_t[]){1})));
  CU_ASSERT_EQUAL_FATAL(ret, DDS_RETCODE_BAD_PARAMETER);
  dds_dynamic_type_unref(&dunion);
  ...
  dunion = dds_dynamic_type_create(participant, desc);
  dds_dynamic_type_add_member(
    &dunion, DDS_DYNAMIC_UNION_MEMBER_DEFAULT_PRIM(DDS_DYNAMIC_INT32, "m1"));
  ret = dds_dynamic_type_add_member(
    &dunion, DDS_DYNAMIC_UNION_MEMBER_DEFAULT_PRIM(DDS_DYNAMIC_INT32, "m2"));
  CU_ASSERT_EQUAL_FATAL(ret, DDS_RETCODE_BAD_PARAMETER);
  dds_dynamic_type_unref(&dunion);
  ...
  dunion = dds_dynamic_type_create(participant, desc);
  dds_dynamic_type_add_member(
    &dunion, DDS_DYNAMIC_UNION_MEMBER(dstruct, "m1", 1, ((int32_t[]){1})));
  ret = dds_dynamic_type_add_member(
    &dunion, DDS_DYNAMIC_UNION_MEMBER_PRIM(DDS_DYNAMIC_INT16, "m2", 1, ((int32_t[]){1})));
  CU_ASSERT_EQUAL_FATAL(ret, DDS_RETCODE_BAD_PARAMETER);
  dds_dynamic_type_unref(&dunion);
}
...
CU_Test(ddsc_dynamic_type, no_members, .init = dynamic_type_init, .fini = dynamic_type_fini)
{
  ...
  dds_dynamic_type_t dbasestruct = dds_dynamic_type_create(
    participant, (dds_dynamic_type_descriptor_t){.kind = DDS_DYNAMIC_STRUCTURE, .name = "b"});
  dstruct = dds_dynamic_type_create(
    participant,
    (dds_dynamic_type_descriptor_t){
      .kind = DDS_DYNAMIC_STRUCTURE, .name = "t", .base_type = DDS_DYNAMIC_TYPE_SPEC(dbasestruct)});
