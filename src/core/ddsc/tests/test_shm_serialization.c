...
CU_Test(ddsc_shm_serialization, get_serialized_size)
{
  ...
  topic = dds_create_topic(participant, &DynamicData_Msg_desc, "DynamicData_Msg", NULL, NULL);
