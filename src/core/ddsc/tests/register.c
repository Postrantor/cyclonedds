...
static void registering_init(void)
{
  ...
  g_topic = dds_create_topic(
    ...
    create_unique_topic_name("ddsc_registering_test", name, sizeof name), qos, NULL);
...
static void registering_fini(void)
{
  dds_delete(g_reader);
  dds_delete(g_writer);
...
CU_TheoryDataPoints(ddsc_register_instance, invalid_params) = {
  CU_DataPoints(dds_instance_handle_t *, &hndle, NULL), CU_DataPoints(void *, NULL, &data)};
CU_Theory(
  (dds_instance_handle_t * hndl2, void * datap), ddsc_register_instance, invalid_params,
  .init = registering_init, .fini = registering_fini)
{
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t writer), ddsc_register_instance, invalid_writers, .init = registering_init,
  .fini = registering_fini)
{
  dds_return_t ret;
  dds_instance_handle_t handle;
...
CU_Theory(
  (dds_entity_t * writer), ddsc_register_instance, non_writers, .init = registering_init,
  .fini = registering_fini)
{
  dds_return_t ret;
  dds_instance_handle_t handle;
...
CU_Test(
  ddsc_register_instance, registering_new_instance, .init = registering_init,
  .fini = registering_fini)
{
...
CU_Test(
  ddsc_register_instance, data_already_available, .init = registering_init,
  .fini = registering_fini)
{
  dds_instance_handle_t instHndl, instHndl2;
  dds_return_t ret;
