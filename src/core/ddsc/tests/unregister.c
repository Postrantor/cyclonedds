...
static void unregistering_init(void)
{
  ...
  g_topic = dds_create_topic(
    ...
    create_unique_topic_name("ddsc_unregistering_test", name, 100), qos, NULL);
...
static void unregistering_fini(void)
{
  dds_delete(g_reader);
  dds_delete(g_writer);
...
CU_Theory(
  (dds_entity_t writer), ddsc_unregister_instance, invalid_writers, .init = unregistering_init,
  .fini = unregistering_fini)
{
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t * writer), ddsc_unregister_instance, non_writers, .init = unregistering_init,
  .fini = unregistering_fini)
{
  dds_return_t ret;
  ret = dds_unregister_instance(*writer, g_data);
...
/*************************************************************************************************/
CU_Test(
  ddsc_unregister_instance, unregistering_old_instance, .init = unregistering_init,
  .fini = unregistering_fini)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_unregister_instance_ts, deleted, .init = unregistering_init, .fini = unregistering_fini)
{
  dds_return_t ret;
  dds_delete(g_writer);
...
CU_Theory(
  (dds_entity_t writer), ddsc_unregister_instance_ts, invalid_writers, .init = unregistering_init,
  .fini = unregistering_fini)
{
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t * writer), ddsc_unregister_instance_ts, non_writers, .init = unregistering_init,
  .fini = unregistering_fini)
{
  dds_return_t ret;
  ret = dds_unregister_instance_ts(*writer, g_data, g_present);
...
/*************************************************************************************************/
CU_Test(
  ddsc_unregister_instance_ts, unregistering_old_instance, .init = unregistering_init,
  .fini = unregistering_fini)
{
  Space_Type1 oldInstance = {0, 22, 22};
  dds_return_t ret;
...
/*************************************************************************************************/
CU_Test(
  ddsc_unregister_instance_ts, unregistering_past_sample, .init = unregistering_init,
  .fini = unregistering_fini)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_unregister_instance_ih, deleted, .init = unregistering_init, .fini = unregistering_fini)
{
  dds_return_t ret;
  dds_delete(g_writer);
...
CU_Theory(
  (dds_instance_handle_t handle), ddsc_unregister_instance_ih, invalid_handles,
  .init = unregistering_init, .fini = unregistering_fini)
{
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t writer), ddsc_unregister_instance_ih, invalid_writers, .init = unregistering_init,
  .fini = unregistering_fini)
{
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t * writer), ddsc_unregister_instance_ih, non_writers, .init = unregistering_init,
  .fini = unregistering_fini)
{
  dds_return_t ret;
  ret = dds_unregister_instance_ih(*writer, DDS_HANDLE_NIL);
...
/*************************************************************************************************/
CU_Test(
  ddsc_unregister_instance_ih, unregistering_old_instance, .init = unregistering_init,
  .fini = unregistering_fini)
{
  Space_Type1 oldInstance = {0, 22, 22};
...
/*************************************************************************************************/
CU_Test(
  ddsc_unregister_instance_ih_ts, deleted, .init = unregistering_init, .fini = unregistering_fini)
{
  dds_return_t ret;
  dds_delete(g_writer);
...
CU_Theory(
  (dds_instance_handle_t handle), ddsc_unregister_instance_ih_ts, invalid_handles,
  .init = unregistering_init, .fini = unregistering_fini)
{
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t writer), ddsc_unregister_instance_ih_ts, invalid_writers,
  .init = unregistering_init, .fini = unregistering_fini)
{
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t * writer), ddsc_unregister_instance_ih_ts, non_writers, .init = unregistering_init,
  .fini = unregistering_fini)
{
  dds_return_t ret;
  ret = dds_unregister_instance_ih_ts(*writer, DDS_HANDLE_NIL, g_present);
...
/*************************************************************************************************/
CU_Test(
  ddsc_unregister_instance_ih_ts, unregistering_old_instance, .init = unregistering_init,
  .fini = unregistering_fini)
{
  Space_Type1 oldInstance = {0, 22, 22};
  dds_instance_handle_t hdl = dds_lookup_instance(g_writer, &oldInstance);
...
/*************************************************************************************************/
CU_Test(
  ddsc_unregister_instance_ih_ts, unregistering_past_sample, .init = unregistering_init,
  .fini = unregistering_fini)
{
  Space_Type1 oldInstance = {0, 0, 0};
  dds_instance_handle_t hdl = dds_lookup_instance(g_writer, &oldInstance);
...
CU_Test(ddsc_unregister_instance_ih_ts, unregistering_instance)
{
  ...
  g_topic = dds_create_topic(
    g_participant, &Space_Type1_desc,
    create_unique_topic_name("ddsc_unregistering_instance_test", name, 100), NULL, NULL);
  CU_ASSERT_FATAL(g_topic > 0);
...
/*************************************************************************************************/
CU_Test(
  ddsc_unregister_instance, dispose_unregistered_sample, .init = unregistering_init,
  .fini = unregistering_fini)
{
  dds_entity_t writer;
...
/*************************************************************************************************/
CU_Test(
  ddsc_unregister_instance_ts, dispose_unregistered_sample, .init = unregistering_init,
  .fini = unregistering_fini)
{
  dds_entity_t writer;
  writer = dds_create_writer(g_participant, g_topic, NULL, NULL);
