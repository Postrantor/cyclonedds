...
static bool accept_all(const void * sample)
{
  (void)sample;
  return true;
}
...
static void hierarchy_init(void)
{
  ...
  g_topic = dds_create_topic(
    g_participant, &RoundTripModule_DataType_desc,
    create_unique_topic_name("ddsc_hierarchy_test", name, sizeof name), NULL, NULL);
...
static void hierarchy_fini(void)
{
...
CU_Test(ddsc_entity_delete, recursive_with_deleted_topic)
{
  ...
  g_topic = dds_create_topic(
    g_participant, &RoundTripModule_DataType_desc,
    create_unique_topic_name("ddsc_hierarchy_test", name, 100), NULL, NULL);
  CU_ASSERT_FATAL(g_topic > 0);
...
CU_TheoryDataPoints(ddsc_entity_get_participant, valid_entities) = {
  CU_DataPoints(
    dds_entity_t *, &g_readcond, &g_querycond, &g_reader, &g_subscriber, &g_writer, &g_publisher,
    &g_topic, &g_participant),
};
CU_Theory(
  (dds_entity_t * entity), ddsc_entity_get_participant, valid_entities, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
...
CU_Theory(
  (dds_entity_t * entity), ddsc_entity_get_participant, deleted_entities, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_entity_t participant;
  dds_delete(*entity);
...
CU_Theory(
  (dds_entity_t entity), ddsc_entity_get_participant, invalid_entities, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_entity_t participant;
...
CU_Theory(
  (dds_entity_t * entity), ddsc_entity_get_parent, conditions, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_entity_t parent;
...
CU_Theory(
  (dds_entity_t * entity), ddsc_entity_get_parent, pubsubtop, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_entity_t parent;
  parent = dds_get_parent(*entity);
...
CU_Theory(
  (dds_entity_t * entity), ddsc_entity_get_parent, deleted_entities, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_entity_t parent;
  dds_delete(*entity);
...
CU_Theory(
  (dds_entity_t entity), ddsc_entity_get_parent, invalid_entities, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_entity_t parent;
...
CU_Test(ddsc_entity_get_children, too_small, .init = hierarchy_init, .fini = hierarchy_fini)
{
  ...
  CU_ASSERT_EQUAL_FATAL(ret, 3);
  CU_ASSERT_FATAL(
    (children[0] == g_publisher) || (children[0] == g_subscriber) || (children[0] == g_topic));
  CU_ASSERT_FATAL(
    (children[1] == g_publisher) || (children[1] == g_subscriber) || (children[1] == g_topic));
...
CU_Test(ddsc_entity_get_children, participant, .init = hierarchy_init, .fini = hierarchy_fini)
{
  ...
  CU_ASSERT_FATAL(
    (children[1] == g_publisher) || (children[1] == g_subscriber) || (children[1] == g_topic));
  CU_ASSERT_FATAL(
    (children[2] == g_publisher) || (children[2] == g_subscriber) || (children[2] == g_topic));
  CU_ASSERT_NOT_EQUAL_FATAL(children[0], children[1]);
...
CU_Theory(
  (dds_entity_t * entity), ddsc_entity_get_children, conditions, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_return_t ret;
  dds_entity_t child;
...
CU_Theory(
  (dds_entity_t * entity), ddsc_entity_get_children, deleted_entities, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_return_t ret;
  dds_entity_t children[4];
...
CU_Theory(
  (dds_entity_t entity), ddsc_entity_get_children, invalid_entities, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_entity_t children[4];
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t * entity), ddsc_entity_get_topic, data_entities, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_entity_t topic;
...
CU_Theory(
  (dds_entity_t * entity), ddsc_entity_get_topic, deleted_entities, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_entity_t topic;
  dds_delete(*entity);
...
CU_Theory(
  (dds_entity_t entity), ddsc_entity_get_topic, invalid_entities, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_entity_t topic;
...
CU_Theory(
  (dds_entity_t * entity), ddsc_entity_get_topic, non_data_entities, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_entity_t topic;
  topic = dds_get_topic(*entity);
...
CU_Theory(
  (dds_entity_t entity), ddsc_entity_get_publisher, invalid_writers, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_entity_t publisher;
...
CU_Theory(
  (dds_entity_t * cond), ddsc_entity_get_publisher, non_writers, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_entity_t publisher;
...
CU_Theory(
  (dds_entity_t * entity), ddsc_entity_get_subscriber, readers, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
...
CU_Theory(
  (dds_entity_t * entity), ddsc_entity_get_subscriber, deleted_readers, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_entity_t subscriber;
  dds_delete(*entity);
...
CU_Theory(
  (dds_entity_t entity), ddsc_entity_get_subscriber, invalid_readers, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_entity_t subscriber;
...
CU_Theory(
  (dds_entity_t * cond), ddsc_entity_get_subscriber, non_readers, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_entity_t subscriber;
...
CU_Theory(
  (dds_entity_t * cond), ddsc_entity_get_datareader, conditions, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_entity_t reader;
...
CU_Theory(
  (dds_entity_t * cond), ddsc_entity_get_datareader, deleted_conds, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_entity_t reader;
  dds_delete(*cond);
...
CU_Theory(
  (dds_entity_t cond), ddsc_entity_get_datareader, invalid_conds, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_entity_t reader;
...
CU_TheoryDataPoints(ddsc_entity_get_datareader, non_conds) = {
  CU_DataPoints(
    dds_entity_t *, &g_reader, &g_subscriber, &g_writer, &g_publisher, &g_topic, &g_participant),
};
CU_Theory(
  (dds_entity_t * cond), ddsc_entity_get_datareader, non_conds, .init = hierarchy_init,
  .fini = hierarchy_fini)
{
  dds_entity_t reader;
  reader = dds_get_datareader(*cond);
...
CU_Test(ddsc_entity_implicit_publisher, deleted)
{
  ...
  topic = dds_create_topic(
    ...
    create_unique_topic_name("ddsc_entity_implicit_publisher_test", name, 100), NULL, NULL);
...
CU_Test(ddsc_entity_implicit_subscriber, deleted)
{
  ...
  topic = dds_create_topic(
    participant, &RoundTripModule_DataType_desc,
    create_unique_topic_name("ddsc_entity_implicit_subscriber_test", name, 100), NULL, NULL);
  CU_ASSERT_FATAL(topic > 0);
...
CU_Test(ddsc_entity_get_parent, implicit_publisher)
{
  ...
  topic = dds_create_topic(
    participant, &RoundTripModule_DataType_desc,
    create_unique_topic_name("ddsc_entity_implicit_publisher_promotion_test", name, 100), NULL,
    NULL);
  CU_ASSERT_FATAL(topic > 0);
...
CU_Test(ddsc_entity_get_parent, implicit_subscriber)
{
  ...
  topic = dds_create_topic(
    participant, &RoundTripModule_DataType_desc,
    create_unique_topic_name("ddsc_entity_implicit_subscriber_promotion_test", name, 100), NULL,
    NULL);
  CU_ASSERT_FATAL(topic > 0);
...
CU_Test(ddsc_entity_implicit, delete_publisher)
{
  ...
  topic = dds_create_topic(
    participant, &RoundTripModule_DataType_desc,
    create_unique_topic_name("ddsc_entity_implicit_delete_publisher", name, 100), NULL, NULL);
  CU_ASSERT_FATAL(topic > 0);
...
CU_Test(ddsc_entity_implicit, delete_subscriber)
{
  ...
  topic = dds_create_topic(
    participant, &RoundTripModule_DataType_desc,
    create_unique_topic_name("ddsc_entity_implicit_delete_subscriber", name, 100), NULL, NULL);
  CU_ASSERT_FATAL(topic > 0);
