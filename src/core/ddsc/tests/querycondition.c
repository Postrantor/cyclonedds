...
#define SAMPLE_IST(idx)                            \
  (((idx % 3) == 0)   ? DDS_IST_ALIVE              \
...
static bool filter_mod2(const void * sample)
{
  const Space_Type1 * s = sample;
  return (s->long_1 % 2 == 0);
}

static void querycondition_init_hdepth(int hdepth)
{
  ...
  g_topic = dds_create_topic(
    g_participant, &Space_Type1_desc,
    create_unique_topic_name("ddsc_querycondition_test", name, sizeof name), NULL, NULL);
...
static void querycondition_init(void) { querycondition_init_hdepth(1); }

static void querycondition_init_deephist(void) { querycondition_init_hdepth(333); }

static void querycondition_fini(void)
{
  dds_delete(g_reader);
  dds_delete(g_writer);
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_create, second, .init = querycondition_init, .fini = querycondition_fini)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_create, deleted_reader, .init = querycondition_init,
  .fini = querycondition_fini)
{
  uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
  dds_entity_t cond;
  dds_delete(g_reader);
...
CU_Theory(
  (dds_entity_t rdr), ddsc_querycondition_create, invalid_readers, .init = querycondition_init,
  .fini = querycondition_fini)
{
  uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
  dds_entity_t cond;
...
CU_Theory(
  (dds_entity_t * rdr), ddsc_querycondition_create, non_readers, .init = querycondition_init,
  .fini = querycondition_fini)
{
  uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
  dds_entity_t cond;
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_get_mask, deleted, .init = querycondition_init, .fini = querycondition_fini)
{
  uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_get_mask, null, .init = querycondition_init, .fini = querycondition_fini)
{
  uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
  dds_entity_t condition;
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t cond), ddsc_querycondition_get_mask, invalid_conditions,
  .init = querycondition_init, .fini = querycondition_fini)
{
  dds_return_t ret;
  uint32_t mask;
...
CU_Theory(
  (dds_entity_t * cond), ddsc_querycondition_get_mask, non_conditions, .init = querycondition_init,
  .fini = querycondition_fini)
{
  dds_return_t ret;
  uint32_t mask;
...
CU_TheoryDataPoints(ddsc_querycondition_get_mask, various_masks) = {
  ...
  CU_DataPoints(
    uint32_t, DDS_ANY_INSTANCE_STATE, DDS_ALIVE_INSTANCE_STATE,
    DDS_NOT_ALIVE_DISPOSED_INSTANCE_STATE, DDS_NOT_ALIVE_NO_WRITERS_INSTANCE_STATE),
};
CU_Theory(
  (uint32_t ss, uint32_t vs, uint32_t is), ddsc_querycondition_get_mask, various_masks,
  .init = querycondition_init, .fini = querycondition_fini)
{
...
CU_Test(ddsc_querycondition_read, any, .init = querycondition_init, .fini = querycondition_fini)
{
  ...
  /* Create condition. */
  condition = dds_create_querycondition(
    g_reader, DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE, filter_mod2);
  CU_ASSERT_FATAL(condition > 0);
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_read, not_read_sample_state, .init = querycondition_init,
  .fini = querycondition_fini)
{
  dds_entity_t condition;
  dds_return_t ret;
  ...
  /* Create condition. */
  condition = dds_create_querycondition(
    g_reader, DDS_NOT_READ_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE, filter_mod2);
  CU_ASSERT_FATAL(condition > 0);
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_read, read_sample_state, .init = querycondition_init,
  .fini = querycondition_fini)
{
  dds_entity_t condition;
  dds_return_t ret;
  ...
  /* Create condition. */
  condition = dds_create_querycondition(
    g_reader, DDS_READ_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE, filter_mod2);
  CU_ASSERT_FATAL(condition > 0);
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_read, new_view_state, .init = querycondition_init,
  .fini = querycondition_fini)
{
  dds_entity_t condition;
  dds_return_t ret;
  ...
  /* Create condition. */
  condition = dds_create_querycondition(
    g_reader, DDS_ANY_SAMPLE_STATE | DDS_NEW_VIEW_STATE | DDS_ANY_INSTANCE_STATE, filter_mod2);
  CU_ASSERT_FATAL(condition > 0);
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_read, not_new_view_state, .init = querycondition_init,
  .fini = querycondition_fini)
{
  dds_entity_t condition;
  dds_return_t ret;
  ...
  /* Create condition. */
  condition = dds_create_querycondition(
    g_reader, DDS_ANY_SAMPLE_STATE | DDS_NOT_NEW_VIEW_STATE | DDS_ANY_INSTANCE_STATE, filter_mod2);
  CU_ASSERT_FATAL(condition > 0);
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_read, alive_instance_state, .init = querycondition_init,
  .fini = querycondition_fini)
{
  dds_entity_t condition;
  dds_return_t ret;
  ...
  /* Create condition. */
  condition = dds_create_querycondition(
    g_reader, DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ALIVE_INSTANCE_STATE, filter_mod2);
  CU_ASSERT_FATAL(condition > 0);
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_read, disposed_instance_state, .init = querycondition_init,
  .fini = querycondition_fini)
{
  dds_entity_t condition;
  dds_return_t ret;
  ...
  /* Create condition. */
  condition = dds_create_querycondition(
    g_reader, DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_NOT_ALIVE_DISPOSED_INSTANCE_STATE,
    filter_mod2);
  CU_ASSERT_FATAL(condition > 0);
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_read, no_writers_instance_state, .init = querycondition_init,
  .fini = querycondition_fini)
{
  dds_entity_t condition;
  dds_return_t ret;
  ...
  /* Create condition. */
  condition = dds_create_querycondition(
    g_reader, DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_NOT_ALIVE_NO_WRITERS_INSTANCE_STATE,
    filter_mod2);
  CU_ASSERT_FATAL(condition > 0);
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_read, combination_of_states, .init = querycondition_init,
  .fini = querycondition_fini)
{
  dds_entity_t condition;
  dds_return_t ret;
  ...
  /* Create condition. */
  condition = dds_create_querycondition(
    g_reader, DDS_NOT_READ_SAMPLE_STATE | DDS_NEW_VIEW_STATE | DDS_ALIVE_INSTANCE_STATE,
    filter_mod2);
  CU_ASSERT_FATAL(condition > 0);
...
CU_Test(ddsc_querycondition_read, none, .init = querycondition_init, .fini = querycondition_fini)
{
  ...
  /* Create condition. */
  condition = dds_create_querycondition(
    g_reader, DDS_NOT_READ_SAMPLE_STATE | DDS_NOT_NEW_VIEW_STATE | DDS_ALIVE_INSTANCE_STATE,
    filter_mod2);
  CU_ASSERT_FATAL(condition > 0);
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_read, with_mask, .init = querycondition_init, .fini = querycondition_fini)
{
  dds_entity_t condition;
  dds_return_t ret;
  ...
  ret = dds_read_mask(
    condition, g_samples, g_info, MAX_SAMPLES, MAX_SAMPLES,
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_read, already_deleted, .init = querycondition_init,
  .fini = querycondition_fini)
{
  dds_entity_t condition;
  dds_return_t ret;
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_take, not_read_sample_state, .init = querycondition_init,
  .fini = querycondition_fini)
{
  dds_entity_t condition;
  dds_return_t ret;
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_take, read_sample_state, .init = querycondition_init,
  .fini = querycondition_fini)
{
  dds_entity_t condition;
  dds_return_t ret;
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_take, new_view_state, .init = querycondition_init,
  .fini = querycondition_fini)
{
  dds_entity_t condition;
  dds_return_t ret;
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_take, not_new_view_state, .init = querycondition_init,
  .fini = querycondition_fini)
{
  dds_entity_t condition;
  dds_return_t ret;
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_take, alive_instance_state, .init = querycondition_init,
  .fini = querycondition_fini)
{
  dds_entity_t condition;
  dds_return_t ret;
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_take, disposed_instance_state, .init = querycondition_init,
  .fini = querycondition_fini)
{
  dds_entity_t condition;
  dds_return_t ret;
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_take, no_writers_instance_state, .init = querycondition_init,
  .fini = querycondition_fini)
{
  dds_entity_t condition;
  dds_return_t ret;
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_take, combination_of_states, .init = querycondition_init,
  .fini = querycondition_fini)
{
  dds_entity_t condition;
  dds_return_t ret;
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_take, with_mask, .init = querycondition_init, .fini = querycondition_fini)
{
  dds_entity_t condition;
  dds_return_t ret;
...
/*************************************************************************************************/
CU_Test(
  ddsc_querycondition_take, already_deleted, .init = querycondition_init,
  .fini = querycondition_fini)
{
  dds_entity_t condition;
  dds_return_t ret;
...
/*************************************************************************************************/
static bool filter_k333_s1(const void * sample)
{
  const Space_Type1 * s = sample;
...
CU_Test(
  ddsc_querycondition_take, some_from_instance, .init = querycondition_init_deephist,
  .fini = querycondition_fini)
{
  ...
  condition = dds_create_querycondition(
    g_reader, DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE, filter_k333_s1);
  CU_ASSERT_FATAL(condition > 0);
  ...
  ret = dds_take_instance(
    g_reader, g_samples, g_info, MAX_SAMPLES, MAX_SAMPLES, g_info[0].instance_handle);
  CU_ASSERT_EQUAL(ret, run);
  idx = 0;
  while (sched[idx] != 0) {
    idx++;
