...
static void take_instance_init(void)
{
  ...
  g_topic = dds_create_topic(
    ...
    create_unique_topic_name("ddsc_take_instance_test", name, sizeof name), NULL, NULL);
...
static void take_instance_fini(void)
{
  dds_delete(g_rcond);
  dds_delete(g_qcond);
  dds_delete(g_reader);
...
CU_Theory(
  ...
  ddsc_take_instance, invalid_params, .init = take_instance_init, .fini = take_instance_fini)
{
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t * ent, void ** buf, dds_sample_info_t * si, uint32_t maxs), ddsc_take_instance_wl,
  invalid_params, .init = take_instance_init, .fini = take_instance_fini)
{
  dds_return_t ret;
  /* The only valid permutation is when non of the buffer values are
     * invalid and neither is the handle. So, don't test that. */
...
CU_Theory(
  (dds_entity_t * ent, void ** buf, dds_sample_info_t * si, size_t bufsz, uint32_t maxs),
  ddsc_take_instance_mask, invalid_params, .init = take_instance_init, .fini = take_instance_fini)
{
...
CU_Theory(
  ...
  ddsc_take_instance_mask_wl, invalid_params, .init = take_instance_init,
  .fini = take_instance_fini)
{
  uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
  dds_return_t ret;
  /* The only valid permutation is when non of the buffer values are
...
CU_Theory(
  ...
  .init = take_instance_init, .fini = take_instance_fini)
{
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t * rdr, dds_instance_handle_t hdl), ddsc_take_instance_wl, invalid_handles,
  .init = take_instance_init, .fini = take_instance_fini)
{
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t * rdr, dds_instance_handle_t hdl), ddsc_take_instance_mask, invalid_handles,
  .init = take_instance_init, .fini = take_instance_fini)
{
  uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t * rdr, dds_instance_handle_t hdl), ddsc_take_instance_mask_wl, invalid_handles,
  .init = take_instance_init, .fini = take_instance_fini)
{
  uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t * rdr), ddsc_take_instance, non_readers, .init = take_instance_init,
  .fini = take_instance_fini)
{
  dds_return_t ret;
  ret = dds_take_instance(*rdr, g_samples, g_info, MAX_SAMPLES, MAX_SAMPLES, g_hdl_valid);
  ...
  .fini = take_instance_fini)
{
  ...
  dds_return_t ret;
  ret =
    dds_take_instance_mask(*rdr, g_samples, g_info, MAX_SAMPLES, MAX_SAMPLES, g_hdl_valid, mask);
  CU_ASSERT_EQUAL_FATAL(ret, DDS_RETCODE_ILLEGAL_OPERATION);
}
/*************************************************************************************************/
...
CU_Theory(
  (dds_entity_t * rdr), ddsc_take_instance, already_deleted, .init = take_instance_init,
  .fini = take_instance_fini)
{
  dds_return_t ret;
  ret = dds_delete(*rdr);
...
CU_Theory(
  (dds_entity_t * rdr), ddsc_take_instance_mask, already_deleted, .init = take_instance_init,
  .fini = take_instance_fini)
{
  uint32_t mask = DDS_ANY_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
  dds_return_t ret;
...
/*************************************************************************************************/
CU_Test(
  ddsc_take_instance_wl, readcondition, .init = take_instance_init, .fini = take_instance_fini)
{
  dds_return_t expected_cnt = 1;
  dds_return_t ret;
...
/*************************************************************************************************/
CU_Test(
  ddsc_take_instance_mask, readcondition, .init = take_instance_init, .fini = take_instance_fini)
{
  ...
  ret =
    dds_take_instance_mask(g_rcond, g_samples, g_info, MAX_SAMPLES, MAX_SAMPLES, g_hdl_valid, mask);
  CU_ASSERT_EQUAL_FATAL(ret, expected_cnt);
  for (int i = 0; i < ret; i++) {
    Space_Type1 * sample = (Space_Type1 *)g_samples[i];
...
/*************************************************************************************************/
CU_Test(
  ddsc_take_instance_mask_wl, readcondition, .init = take_instance_init, .fini = take_instance_fini)
{
...
/*************************************************************************************************/
CU_Test(
  ddsc_take_instance_wl, querycondition, .init = take_instance_init, .fini = take_instance_fini)
{
  dds_return_t expected_cnt = 1;
  dds_return_t ret;
...
/*************************************************************************************************/
CU_Test(
  ddsc_take_instance_mask, querycondition, .init = take_instance_init, .fini = take_instance_fini)
{
  uint32_t mask = DDS_READ_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
  dds_return_t expected_cnt = 1;
  dds_return_t ret;
  ...
  ret =
    dds_take_instance_mask(g_qcond, g_samples, g_info, MAX_SAMPLES, MAX_SAMPLES, g_hdl_valid, mask);
  CU_ASSERT_EQUAL_FATAL(ret, expected_cnt);
  for (int i = 0; i < ret; i++) {
    Space_Type1 * sample = (Space_Type1 *)g_samples[i];
...
/*************************************************************************************************/
CU_Test(
  ddsc_take_instance_mask_wl, querycondition, .init = take_instance_init,
  .fini = take_instance_fini)
{
  uint32_t mask = DDS_NOT_READ_SAMPLE_STATE | DDS_ANY_VIEW_STATE | DDS_ANY_INSTANCE_STATE;
  dds_return_t expected_cnt = 1;
