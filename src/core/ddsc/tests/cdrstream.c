...
#define DDS_CONFIG                                                                           \
  "${CYCLONEDDS_URI}${CYCLONEDDS_URI:+,}<Discovery><ExternalDomainId>0</ExternalDomainId></" \
  "Discovery>"
...
#define RND_STR32                  \
  (ddsrt_random() % 2              \
     ? (char[]){'t', RND_CHAR4, 0} \
     : (char[]){'t', 'e', 's', 't', RND_CHAR8, RND_CHAR8, RND_CHAR8, RND_CHAR4, 0})
...
static const uint32_t TestIdl_MsgNested_ops[] = {
  // Msg2
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof(TestIdl_MsgNested, msg_field1),
  (3u << 16u) + 18u,  // SubMsg1
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof(TestIdl_MsgNested, msg_field2),
  (3u << 16u) + 7u,  // SubMsg2
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof(TestIdl_MsgNested, msg_field3),
  (3u << 16u) + 12u,  // SubMsg1
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof(TestIdl_SubMsg2, submsg_field3),
  (3u << 16u) + 4u,  // SubMsg2
  DDS_OP_RTS,

  // SubMsg1
  DDS_OP_ADR | DDS_OP_TYPE_4BY, offsetof(TestIdl_SubMsg1, submsg_field1), DDS_OP_RTS};

const dds_topic_descriptor_t TestIdl_MsgNested_desc = {
  sizeof(TestIdl_MsgNested), 4u, 0u, 0u, "TestIdl::MsgNested", NULL, 17, TestIdl_MsgNested_ops, ""};
...
static void * sample_init_nested(void)
{
  ...
  *subf2 = RND_UINT32;
  TestIdl_MsgNested msg = {
    ...
    .msg_field2 =
      {.submsg_field1 = RND_UINT32,
       .submsg_field2 = subf2,
       .submsg_field3 = {.submsg_field1 = RND_UINT32}},
...
static bool sample_equal_nested(void * s1, void * s2)
{
  ...
  return msg1->msg_field1.submsg_field1 == msg2->msg_field1.submsg_field1 &&
         ...
         *msg1->msg_field2.submsg_field2 == *msg2->msg_field2.submsg_field2 &&
         msg1->msg_field2.submsg_field3.submsg_field1 ==
           msg2->msg_field2.submsg_field3.submsg_field1 &&
...
static const uint32_t TestIdl_Msg_ops[] = {
  ...
  offsetof(TestIdl_MsgStr, msg_field1.str1),
  DDS_OP_ADR | DDS_OP_TYPE_BST,
  offsetof(TestIdl_MsgStr, msg_field1.str2),
  6,
  DDS_OP_ADR | DDS_OP_TYPE_ARR | DDS_OP_SUBTYPE_STR,
  offsetof(TestIdl_MsgStr, msg_field1.strseq3),
  2,
  DDS_OP_ADR | DDS_OP_TYPE_ARR | DDS_OP_SUBTYPE_BST,
  offsetof(TestIdl_MsgStr, msg_field1.strseq4),
  3,
  0,
  6,
  DDS_OP_RTS};

const dds_topic_descriptor_t TestIdl_MsgStr_desc = {
  sizeof(TestIdl_MsgStr), sizeof(char *), 0u, 0u, "TestIdl::MsgStr", NULL, 14, TestIdl_Msg_ops, ""};
...
static bool sample_equal_str(void * s1, void * s2)
{
  ...
  for (int i = 0; i < 2 && eq; i++)
    if (strcmp(msg1->msg_field1.strseq3[i], msg2->msg_field1.strseq3[i])) eq = false;
  for (int i = 0; i < 3 && eq; i++)
    if (strcmp(msg1->msg_field1.strseq4[i], msg2->msg_field1.strseq4[i])) eq = false;
  return (
    eq && !strcmp(msg1->msg_field1.str1, msg2->msg_field1.str1) &&
 ...
 * Unions
 **********************************************/
typedef enum TestIdl_Kind1 { TestIdl_KIND1_0, TestIdl_KIND1_1, TestIdl_KIND1_2 } TestIdl_Kind1;
...
typedef enum TestIdl_Kind3 { TestIdl_KIND3_0, TestIdl_KIND3_1, TestIdl_KIND3_2 } TestIdl_Kind3;
...
static const uint32_t TestIdl_MsgUnion_ops[] = {
  DDS_OP_ADR | DDS_OP_TYPE_ENU,
  offsetof(TestIdl_MsgUnion, msg_field1),
  2u,
  DDS_OP_ADR | DDS_OP_TYPE_ENU,
  offsetof(TestIdl_MsgUnion, msg_field2),
  10u,

  DDS_OP_ADR | DDS_OP_TYPE_UNI | DDS_OP_SUBTYPE_ENU,
  offsetof(TestIdl_MsgUnion, msg_field3._d),
  3u,
  (26u << 16) + 5u,
  2u,
  DDS_OP_JEQ | DDS_OP_TYPE_4BY | DDS_OP_FLAG_SGN | 0,
  TestIdl_KIND3_0,
  offsetof(TestIdl_MsgUnion, msg_field3._u.field1),
  DDS_OP_JEQ4 | DDS_OP_TYPE_ENU,
  TestIdl_KIND3_1,
  offsetof(TestIdl_MsgUnion, msg_field3._u.field2),
  10u,
  DDS_OP_JEQ | DDS_OP_TYPE_UNI | 3,
  TestIdl_KIND3_2,
  offsetof(TestIdl_MsgUnion, msg_field3._u.field3),

  DDS_OP_ADR | DDS_OP_TYPE_UNI | DDS_OP_SUBTYPE_4BY | DDS_OP_FLAG_SGN,
  offsetof(TestIdl_Union0, _d),
  2u,
  (10u << 16) + 4u,
  DDS_OP_JEQ | DDS_OP_TYPE_4BY | DDS_OP_FLAG_SGN | 0,
  0,
  offsetof(TestIdl_Union0, _u.field0_1),
  DDS_OP_JEQ | DDS_OP_TYPE_4BY | 0,
  1,
  offsetof(TestIdl_Union0, _u.field0_2),
  DDS_OP_RTS,
  DDS_OP_RTS};

const dds_topic_descriptor_t TestIdl_MsgUnion_desc = {
  sizeof(TestIdl_MsgUnion), 4u, DDS_TOPIC_CONTAINS_UNION, 0u, "TestIdl::MsgUnion", NULL, 3,
  TestIdl_MsgUnion_ops,     ""};

static void * sample_init_union(void)
{
  TestIdl_MsgUnion msg = {
    .msg_field1 = TestIdl_KIND1_1,
    .msg_field2 = TestIdl_KIND2_10,
    .msg_field3._d = TestIdl_KIND3_1,
    .msg_field3._u.field2 = TestIdl_KIND2_6};
...
static bool sample_equal_union(void * s1, void * s2)
{
  ...
  return msg1->msg_field1 == msg2->msg_field1 && msg1->msg_field2 == msg2->msg_field2 &&
         msg1->msg_field3._d == msg2->msg_field3._d &&
         msg1->msg_field3._u.field2 == msg2->msg_field3._u.field2;
}

static void sample_free_union(void * s) { ddsrt_free(s); }
...
static const uint32_t TestIdl_MsgRecursive_ops[] = {
  ...
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof(TestIdl_MsgRecursive, msg_field2),
  (3u << 16u) + 6u,  // SubMsg
  ...
  offsetof(TestIdl_SubMsgRecursive, submsg_field2), sizeof(TestIdl_SubMsgRecursive),
  (6u << 16u) + 4u,                      // sequence<SubMsgRecursive>
...
const dds_topic_descriptor_t TestIdl_MsgRecursive_desc = {
  sizeof(TestIdl_MsgRecursive), 4u, 0u, 0u, "TestIdl::MsgRecursive", NULL, 18,
  TestIdl_MsgRecursive_ops,     ""};
...
static void * sample_init_recursive(void)
{
  ...
  TestIdl_SubMsgRecursive_submsg_field2_seq seq = {
    ._length = sseqsz, ._maximum = sseqsz, ._buffer = sseq};
  TestIdl_SubMsgRecursive s1 = {
    .submsg_field1 = RND_UINT32, .submsg_field2 = seq, .submsg_field3 = RND_INT32};
...
static bool sample_equal_recursive_field2(
  TestIdl_SubMsgRecursive * s1, TestIdl_SubMsgRecursive * s2)
{
  if (
    s1->submsg_field1 != s2->submsg_field1 ||
  ...
  for (uint32_t n = 0; n < s1->submsg_field2._length; n++)
    if (!sample_equal_recursive_field2(
          &s1->submsg_field2._buffer[n], &s2->submsg_field2._buffer[n]))
      return false;
...
static bool sample_equal_recursive(void * s1, void * s2)
{
  ...
  return (
    msg1->msg_field1 == msg2->msg_field1 &&
...
static const uint32_t TestIdl_MsgExt_ops[] = {
  ...
  DDS_OP_ADR | DDS_OP_FLAG_EXT | DDS_OP_TYPE_EXT, offsetof(TestIdl_MsgExt, f3),
  (4u << 16u) + 14u /* TestIdl_MsgExt_b */, sizeof(TestIdl_MsgExt_b),
  DDS_OP_ADR | DDS_OP_FLAG_EXT | DDS_OP_TYPE_ARR | DDS_OP_SUBTYPE_2BY | DDS_OP_FLAG_SGN,
  offsetof(TestIdl_MsgExt, f4), 3u,
  DDS_OP_ADR | DDS_OP_FLAG_EXT | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_2BY | DDS_OP_FLAG_SGN,
  offsetof(TestIdl_MsgExt, f5), DDS_OP_ADR | DDS_OP_FLAG_EXT | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_STU,
  offsetof(TestIdl_MsgExt, f6), sizeof(TestIdl_MsgExt_b), (4u << 16u) + 5u /* TestIdl_MsgExt_b */,
  DDS_OP_RTS,
...
const dds_topic_descriptor_t TestIdl_MsgExt_desc = {sizeof(TestIdl_MsgExt),
                                                    sizeof(char *),
                                                    0u,
                                                    0u,
                                                    "TestIdl_MsgExt",
...
static void * sample_init_ext(void)
{
  ...
  *msg->f3->b1 = RND_INT32;
  ...
  for (uint32_t n = 0; n < seqsz5; n++) msg->f5->_buffer[n] = RND_INT16;
...
static bool sample_equal_ext(void * s1, void * s2)
{
  ...
  if (msg1->f5->_length != msg2->f5->_length) return false;
  for (uint32_t n = 0; n < msg1->f5->_length; n++)
    if (msg1->f5->_buffer[n] != msg2->f5->_buffer[n]) return false;

  if (msg1->f6->_length != msg2->f6->_length) return false;
  for (uint32_t n = 0; n < msg1->f6->_length; n++)
    if (*msg1->f6->_buffer[n].b1 != *msg2->f6->_buffer[n].b1) return false;

  return !strcmp(msg1->f1, msg2->f1) && !strcmp(*msg1->f2, *msg2->f2) &&
         *msg1->f3->b1 == *msg2->f3->b1 && (*msg1->f4)[0] == (*msg2->f4)[0] &&
         (*msg1->f4)[1] == (*msg2->f4)[1] && (*msg1->f4)[2] == (*msg2->f4)[2];
}
...
static const uint32_t TestIdl_MsgOpt_ops[] = {
  /* TestIdl_MsgOpt */
  DDS_OP_ADR | DDS_OP_FLAG_EXT | DDS_OP_TYPE_4BY | DDS_OP_FLAG_OPT | DDS_OP_FLAG_SGN,
  offsetof(TestIdl_MsgOpt, f1), DDS_OP_ADR | DDS_OP_TYPE_STR | DDS_OP_FLAG_OPT,
  offsetof(TestIdl_MsgOpt, f2), DDS_OP_ADR | DDS_OP_FLAG_EXT | DDS_OP_TYPE_EXT | DDS_OP_FLAG_OPT,
  offsetof(TestIdl_MsgOpt, f3), (4u << 16u) + 15u /* TestIdl_MsgOpt_b */, sizeof(TestIdl_MsgOpt_b),
  DDS_OP_ADR | DDS_OP_FLAG_EXT | DDS_OP_TYPE_BST | DDS_OP_FLAG_OPT, offsetof(TestIdl_MsgOpt, f4),
  33u,
  DDS_OP_ADR | DDS_OP_FLAG_EXT | DDS_OP_TYPE_ARR | DDS_OP_FLAG_OPT | DDS_OP_SUBTYPE_4BY |
    DDS_OP_FLAG_SGN,
  offsetof(TestIdl_MsgOpt, f5), 3u,
  DDS_OP_ADR | DDS_OP_FLAG_EXT | DDS_OP_TYPE_SEQ | DDS_OP_FLAG_OPT | DDS_OP_SUBTYPE_STU,
  offsetof(TestIdl_MsgOpt, f6), sizeof(TestIdl_MsgOpt_b), (4u << 16u) + 5u /* TestIdl_MsgOpt_b */,
  DDS_OP_RTS,
...
const dds_topic_descriptor_t TestIdl_MsgOpt_desc = {sizeof(TestIdl_MsgOpt),
                                                    sizeof(char *),
                                                    0u,
                                                    0u,
                                                    "TestIdl_MsgOpt",
...
static void * sample_init_opt(void)
{
  ...
  if (RND_INT32 % 2) msg->f2 = ddsrt_strdup(RND_STR32);
  if (RND_INT32 % 2) {
...
static bool sample_equal_opt(void * s1, void * s2)
{
  ...
  if (
    ((msg1->f1 == NULL && msg2->f1 != NULL) || (msg1->f1 != NULL && msg2->f1 == NULL)) ||
    ((msg1->f2 == NULL && msg2->f2 != NULL) || (msg1->f2 != NULL && msg2->f2 == NULL)) ||
    ((msg1->f3 == NULL && msg2->f3 != NULL) || (msg1->f3 != NULL && msg2->f3 == NULL)) ||
    (msg1->f3 != NULL && ((msg1->f3->b1 == NULL && msg2->f3->b1 != NULL) ||
                          (msg1->f3->b1 != NULL && msg2->f3->b1 == NULL))) ||
  ...
  if (msg1->f6 != NULL) {
    ...
    for (uint32_t n = 0; n < msg1->f6->_length; n++) {
      if (
        (msg1->f6->_buffer[n].b1 == NULL && msg2->f6->_buffer[n].b1 != NULL) ||
        (msg1->f6->_buffer[n].b1 != NULL && msg2->f6->_buffer[n].b1 == NULL))
        return false;
...
static const uint32_t TestIdl_AppendableMsg_ops[] = {
  ...
  offsetof(TestIdl_AppendableMsg, msg_field1),
  (3u << 16u) + 18u,  // AppendableSubMsg1
  DDS_OP_ADR | DDS_OP_TYPE_EXT,
  offsetof(TestIdl_AppendableMsg, msg_field2),
  (3u << 16u) + 21u,  // AppendableSubMsg2
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_STU,
  offsetof(TestIdl_AppendableMsg, msg_field3),
  sizeof(TestIdl_AppendableSubMsg2),
  (4u << 16u) + 18u,  // sequence<AppendableSubMsg2>
  DDS_OP_ADR | DDS_OP_TYPE_EXT,
  offsetof(TestIdl_AppendableMsg, msg_field4),
  (3u << 16u) + 20u,  // AppendableUnion0
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_UNI,
  offsetof(TestIdl_AppendableMsg, msg_field5),
  sizeof(TestIdl_AppendableUnion0),
  (4u << 16u) + 17u,  // sequenec<AppendableUnion0>
  DDS_OP_RTS,

  /* AppendableSubMsg1 */
  DDS_OP_DLC,
  DDS_OP_ADR | DDS_OP_TYPE_4BY,
  offsetof(TestIdl_AppendableSubMsg1, submsg1_field1),
  DDS_OP_ADR | DDS_OP_TYPE_STR,
  offsetof(TestIdl_AppendableSubMsg1, submsg1_field2),
  DDS_OP_RTS,

  /* AppendableSubMsg2 */
  DDS_OP_DLC,
  DDS_OP_ADR | DDS_OP_TYPE_4BY,
  offsetof(TestIdl_AppendableSubMsg2, submsg2_field1),
  DDS_OP_ADR | DDS_OP_TYPE_4BY,
  offsetof(TestIdl_AppendableSubMsg2, submsg2_field2),
  DDS_OP_RTS,

  /* AppendableUnion0 */
  DDS_OP_DLC,
  DDS_OP_ADR | DDS_OP_TYPE_UNI | DDS_OP_SUBTYPE_1BY,
  offsetof(TestIdl_AppendableUnion0, _d),
  2u,
  (10u << 16) + 4u,
  DDS_OP_JEQ | DDS_OP_TYPE_4BY | 0,
  0,
  offsetof(TestIdl_AppendableUnion0, _u.field1),
  DDS_OP_JEQ | DDS_OP_TYPE_4BY | DDS_OP_FLAG_SGN | 0,
  1,
  offsetof(TestIdl_AppendableUnion0, _u.field2),
  DDS_OP_RTS,
};

const dds_topic_descriptor_t TestIdl_MsgAppendable_desc = {
  sizeof(TestIdl_AppendableMsg), 4u, 0u, 0u, "TestIdl::AppendableMsg", NULL, 4,
  TestIdl_AppendableMsg_ops,     ""};

static void * sample_init_appendable(void)
{
  TestIdl_AppendableSubMsg2 sseq[] = {
    {.submsg2_field1 = 111, .submsg2_field2 = 222}, {.submsg2_field1 = 333, .submsg2_field2 = 444}};
  TestIdl_AppendableUnion0 useq[] = {
    {._d = 0, ._u.field1 = 555}, {._d = 1, ._u.field2 = -555}, {._d = 0, ._u.field1 = 666}};
  TestIdl_AppendableMsg msg = {
    ...
    .msg_field3 =
      {._length = 2,
       ._maximum = 2,
       ._buffer = ddsrt_memdup(sseq, 2 * sizeof(TestIdl_AppendableSubMsg2))},
    .msg_field4 = {._d = 1, ._u.field2 = -10},
    .msg_field5 = {
      ._length = 3,
      ._maximum = 3,
      ._buffer = ddsrt_memdup(useq, 3 * sizeof(TestIdl_AppendableUnion0))}};
  return ddsrt_memdup(&msg, sizeof(TestIdl_AppendableMsg));
}

static bool sample_equal_appendable_TestIdl_AppendableSubMsg2_seq(
  TestIdl_AppendableMsg_msg_field3_seq * s1, TestIdl_AppendableMsg_msg_field3_seq * s2)
{
  if (s1->_length != s2->_length) return false;
  for (uint32_t n = 0; n < s1->_length; n++) {
    if (
      s1->_buffer[n].submsg2_field1 != s2->_buffer[n].submsg2_field1 ||
...
static bool sample_equal_appendable_TestIdl_AppendableUnion0_seq(
  TestIdl_AppendableMsg_msg_field5_seq * s1, TestIdl_AppendableMsg_msg_field5_seq * s2)
{
  if (s1->_length != s2->_length) return false;
  for (uint32_t n = 0; n < s1->_length; n++) {
    if (
      s1->_buffer[n]._d != s2->_buffer[n]._d ||
...
static const uint32_t TestIdl_MsgKeysNested_ops[] = {
  // Msg
  DDS_OP_ADR | DDS_OP_TYPE_EXT | DDS_OP_FLAG_KEY, offsetof(TestIdl_MsgKeysNested, msg_field1),
  (3u << 16u) + 8u,  // SubMsgKeysNested
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_STU, offsetof(TestIdl_MsgKeysNested, msg_field2),
  sizeof(TestIdl_SubMsgKeysNested), (4u << 16u) + 5u,  // sequence<SubMsgKeysNested>
  DDS_OP_RTS,

  // SubMsg
  DDS_OP_DLC, DDS_OP_ADR | DDS_OP_TYPE_4BY, offsetof(TestIdl_SubMsgKeysNested, submsg_field1),
  ...
  DDS_OP_ADR | DDS_OP_TYPE_EXT | DDS_OP_FLAG_KEY, offsetof(TestIdl_SubMsgKeysNested, submsg_field4),
  (3u << 16) + 4u,  // SubMsgKeysNested2
  DDS_OP_RTS,

  // SubMsg2
  DDS_OP_PLC, DDS_OP_PLM | 5u, 1, DDS_OP_PLM | 6u, 2, DDS_OP_RTS, DDS_OP_ADR | DDS_OP_TYPE_4BY,
  offsetof(TestIdl_SubMsgKeysNested2, submsg2_field1), DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_4BY | DDS_OP_FLAG_KEY,
  offsetof(TestIdl_SubMsgKeysNested2, submsg2_field2), DDS_OP_RTS,
...
const dds_topic_descriptor_t TestIdl_MsgKeysNested_desc = {
  sizeof(TestIdl_MsgKeysNested),
  sizeof(char *),
  DDS_TOPIC_FIXED_KEY | DDS_TOPIC_FIXED_KEY_XCDR2,
  3u,
  "TestIdl::MsgKeysNested",
  TestIdl_MsgKeysNested_keys,
  8,
  TestIdl_MsgKeysNested_ops,
  ""};
...
{
  TestIdl_SubMsgKeysNested sseq[] = {
    {.submsg_field1 = 2100,
     .submsg_field2 = 2200,
     .submsg_field3 = 2300,
     .submsg_field4.submsg2_field1 = 2310,
     .submsg_field4.submsg2_field2 = 2320},
    {.submsg_field1 = 2101,
     .submsg_field2 = 2201,
     .submsg_field3 = 2301,
     .submsg_field4.submsg2_field1 = 2411,
     .submsg_field4.submsg2_field2 = 2412}};
  TestIdl_MsgKeysNested msg = {
    .msg_field1 =
      {.submsg_field1 = 1100,
       .submsg_field2 = 1200,
       .submsg_field3 = 1300,
       .submsg_field4.submsg2_field1 = 1410,
       .submsg_field4.submsg2_field2 = 1420},
    .msg_field2 = {
      ._length = 2,
      ._maximum = 2,
      ._buffer = ddsrt_memdup(sseq, 2 * sizeof(TestIdl_SubMsgKeysNested))}};
...
static bool keys_equal_keysnested(void * s1, void * s2)
{
  ...
  return msg1->msg_field1.submsg_field2 == msg2->msg_field1.submsg_field2 &&
         msg1->msg_field1.submsg_field3 == msg2->msg_field1.submsg_field3 &&
         msg1->msg_field1.submsg_field4.submsg2_field2 ==
           msg2->msg_field1.submsg_field4.submsg2_field2;
}

static bool sample_equal_keysnested_TestIdl_SubMsgKeysNested(
  TestIdl_SubMsgKeysNested * s1, TestIdl_SubMsgKeysNested * s2)
{
  return (
    s1->submsg_field1 == s2->submsg_field1 && s1->submsg_field2 == s2->submsg_field2 &&
    s1->submsg_field3 == s2->submsg_field3 &&
...
static bool sample_equal_keysnested(void * s1, void * s2)
{
  TestIdl_MsgKeysNested *msg1 = (TestIdl_MsgKeysNested *)s1, *msg2 = (TestIdl_MsgKeysNested *)s2;
  if (
    !sample_equal_keysnested_TestIdl_SubMsgKeysNested(&msg1->msg_field1, &msg2->msg_field1) ||
    msg1->msg_field2._length != msg2->msg_field2._length)
    return false;
  for (uint32_t n = 0; n < msg1->msg_field2._length; n++) {
    if (!sample_equal_keysnested_TestIdl_SubMsgKeysNested(
          &msg1->msg_field2._buffer[n], &msg2->msg_field2._buffer[n]))
      return false;
  }
  return true;
}
...
static const uint32_t TestIdl_MsgArr_ops[] = {
  ...
  DDS_OP_ADR | DDS_OP_TYPE_ARR | DDS_OP_SUBTYPE_STU, offsetof(TestIdl_MsgArr, msg_field2), 2u,
  (5u << 16) + 11u, sizeof(TestIdl_SubMsgArr), DDS_OP_ADR | DDS_OP_TYPE_ARR | DDS_OP_SUBTYPE_UNI,
  offsetof(TestIdl_MsgArr, msg_field3), 2u, (5u << 16) + 11u, sizeof(TestIdl_UnionArr), DDS_OP_RTS,

  /* TestIdl_SubMsgArr */
  DDS_OP_ADR | DDS_OP_TYPE_4BY, offsetof(TestIdl_SubMsgArr, field1), DDS_OP_ADR | DDS_OP_TYPE_4BY,
  offsetof(TestIdl_SubMsgArr, field2), DDS_OP_RTS,

  /* TestIdl_UnionArr */
  DDS_OP_ADR | DDS_OP_TYPE_UNI | DDS_OP_SUBTYPE_4BY | DDS_OP_FLAG_SGN,
  offsetof(TestIdl_UnionArr, _d), 2u, (10u << 16) + 4u,
  DDS_OP_JEQ | DDS_OP_TYPE_4BY | DDS_OP_FLAG_SGN | 0, 0,
  offsetof(TestIdl_UnionArr, _u.union_field1), DDS_OP_JEQ | DDS_OP_TYPE_4BY | 0, 1,
  offsetof(TestIdl_UnionArr, _u.union_field2), DDS_OP_RTS};

const dds_topic_descriptor_t TestIdl_MsgArr_desc = {
  sizeof(TestIdl_MsgArr),
  sizeof(char *),
...
static bool sample_equal_arr(void * s1, void * s2)
{
  ...
  return (
    msg1->msg_field1[0] == msg2->msg_field1[0] && msg1->msg_field1[1] == msg2->msg_field1[1] &&
...
static const uint32_t TestIdl_MsgAppendStruct1_ops[] = {
  DDS_OP_DLC,
  DDS_OP_ADR | DDS_OP_TYPE_4BY,
  offsetof(TestIdl_MsgAppendStruct1, msg_field1),
  DDS_OP_ADR | DDS_OP_TYPE_EXT,
  offsetof(TestIdl_MsgAppendStruct1, msg_field2),
  (3u << 16u) + 6u,
  DDS_OP_ADR | DDS_OP_TYPE_4BY,
  offsetof(TestIdl_MsgAppendStruct1, msg_field3),
  DDS_OP_RTS,

  DDS_OP_DLC,
  DDS_OP_ADR | DDS_OP_TYPE_4BY,
  offsetof(TestIdl_SubMsgAppendStruct1, submsg_field1),
  DDS_OP_ADR | DDS_OP_TYPE_4BY,
  offsetof(TestIdl_SubMsgAppendStruct1, submsg_field2),
  DDS_OP_RTS};
...
static const uint32_t TestIdl_MsgAppendStruct2_ops[] = {
  DDS_OP_DLC,
  DDS_OP_ADR | DDS_OP_TYPE_4BY,
  offsetof(TestIdl_MsgAppendStruct2, msg_field1),
  DDS_OP_ADR | DDS_OP_TYPE_EXT,
  offsetof(TestIdl_MsgAppendStruct2, msg_field2),
  (3u << 16u) + 9u,
  DDS_OP_ADR | DDS_OP_TYPE_4BY,
  offsetof(TestIdl_MsgAppendStruct2, msg_field3),
  DDS_OP_ADR | DDS_OP_TYPE_ARR | DDS_OP_SUBTYPE_4BY,
  offsetof(TestIdl_MsgAppendStruct2, msg_field4),
  10000u,
  DDS_OP_RTS,

  DDS_OP_DLC,
  DDS_OP_ADR | DDS_OP_TYPE_4BY,
  offsetof(TestIdl_SubMsgAppendStruct2, submsg_field1),
  DDS_OP_ADR | DDS_OP_TYPE_4BY,
  offsetof(TestIdl_SubMsgAppendStruct2, submsg_field2),
  DDS_OP_ADR | DDS_OP_TYPE_ARR | DDS_OP_SUBTYPE_4BY,
  offsetof(TestIdl_SubMsgAppendStruct2, submsg_field3),
  10000u,
  DDS_OP_RTS};

const dds_topic_descriptor_t TestIdl_MsgAppendStruct1_desc = {
  sizeof(TestIdl_MsgAppendStruct1), 4u, 0u, 0u, "TestIdl::MsgAppendStruct1", NULL, 0,
  TestIdl_MsgAppendStruct1_ops,     ""};
const dds_topic_descriptor_t TestIdl_MsgAppendStruct2_desc = {
  sizeof(TestIdl_MsgAppendStruct2), 4u, 0u, 0u, "TestIdl::MsgAppendStruct2", NULL, 0,
  TestIdl_MsgAppendStruct2_ops,     ""};

static void * sample_init_appendstruct1(void)
{
  TestIdl_MsgAppendStruct1 msg = {
    .msg_field1 = 1, .msg_field2 = {.submsg_field1 = 11, .submsg_field2 = 22}, .msg_field3 = 3};
  return ddsrt_memdup(&msg, sizeof(TestIdl_MsgAppendStruct1));
}

static void * sample_init_appendstruct2(void)
{
  TestIdl_MsgAppendStruct2 msg = {
    .msg_field1 = 101,
    .msg_field2 = {.submsg_field1 = 1011, .submsg_field2 = 1022},
    .msg_field3 = 103};
...
static bool sample_equal_appendstruct1(void * s_wr, void * s_rd)
{
  ...
  return eq && msg_wr->msg_field1 == msg_rd->msg_field1 &&
...
static const uint32_t TestIdl_MsgAppendDefaults1_ops[] = {
  DDS_OP_DLC,
  DDS_OP_ADR | DDS_OP_TYPE_4BY,
  offsetof(TestIdl_MsgAppendDefaults1, msg_field1),
  DDS_OP_RTS,
};
...
static const uint32_t TestIdl_MsgAppendDefaults2_ops[] = {
  DDS_OP_DLC,
  DDS_OP_ADR | DDS_OP_TYPE_4BY,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field1),
  DDS_OP_ADR | DDS_OP_TYPE_1BY,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field_i8),
  DDS_OP_ADR | DDS_OP_TYPE_1BY,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field_u8),
  DDS_OP_ADR | DDS_OP_TYPE_2BY,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field_i16),
  DDS_OP_ADR | DDS_OP_TYPE_2BY,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field_u16),
  DDS_OP_ADR | DDS_OP_TYPE_4BY,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field_i32),
  DDS_OP_ADR | DDS_OP_TYPE_4BY,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field_u32),
  DDS_OP_ADR | DDS_OP_TYPE_8BY,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field_i64),
  DDS_OP_ADR | DDS_OP_TYPE_8BY,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field_u64),
  DDS_OP_ADR | DDS_OP_TYPE_ENU,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field_enum),
  2u,
  DDS_OP_ADR | DDS_OP_TYPE_STR,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field_str),
  DDS_OP_ADR | DDS_OP_TYPE_BST,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field_bstr),
  100u,
  DDS_OP_ADR | DDS_OP_TYPE_ARR | DDS_OP_SUBTYPE_1BY,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field_au8),
  100u,
  DDS_OP_ADR | DDS_OP_TYPE_ARR | DDS_OP_SUBTYPE_8BY,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field_au64),
  100u,
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_1BY,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field_su8),
  DDS_OP_ADR | DDS_OP_TYPE_EXT,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field_subm),
  (3u << 16u) + 27u,
  DDS_OP_ADR | DDS_OP_TYPE_ARR | DDS_OP_SUBTYPE_STU,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field_asubm),
  100,
  (5u << 16u) + 24u,
  sizeof(TestIdl_SubMsgAppendDefaults2),
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_STU,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field_ssubm),
  sizeof(TestIdl_SubMsgAppendDefaults2),
  (4u << 16u) + 19u,
  DDS_OP_ADR | DDS_OP_TYPE_UNI | DDS_OP_SUBTYPE_ENU,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field_uni._d),
  3u,
  (14u << 16) + 5u,
  2u,
  DDS_OP_JEQ | DDS_OP_TYPE_4BY | DDS_OP_FLAG_SGN | 0,
  TestIdl_APPEND_DEFAULTS_KIND1,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field_uni._u.field1),
  DDS_OP_JEQ | DDS_OP_TYPE_4BY | 0,
  TestIdl_APPEND_DEFAULTS_KIND2,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field_uni._u.field2),
  DDS_OP_JEQ | DDS_OP_TYPE_1BY | 0,
  TestIdl_APPEND_DEFAULTS_KIND3,
  offsetof(TestIdl_MsgAppendDefaults2, msg_field_uni._u.field3),
  DDS_OP_RTS,

  DDS_OP_ADR | DDS_OP_TYPE_4BY,
  offsetof(TestIdl_SubMsgAppendDefaults2, submsg_field1),
  DDS_OP_RTS,
};

const dds_topic_descriptor_t TestIdl_MsgAppendDefaults1_desc = {
  sizeof(TestIdl_MsgAppendDefaults1), 4u, 0u, 0u, "TestIdl::MsgAppendDefaults1", NULL, 0,
  TestIdl_MsgAppendDefaults1_ops,     ""};
const dds_topic_descriptor_t TestIdl_MsgAppendDefaults2_desc = {
  sizeof(TestIdl_MsgAppendDefaults2),
  4u,
  DDS_TOPIC_CONTAINS_UNION,
  0u,
  "TestIdl::MsgAppendDefaults2",
  NULL,
  0,
  TestIdl_MsgAppendDefaults2_ops,
  ""};
...
static bool sample_equal_appenddefaults1(void * s_wr, void * s_rd)
{
  ...
  return msg_wr->msg_field1 == msg_rd->msg_field1 && msg_rd->msg_field_i8 == 0 &&
         msg_rd->msg_field_u8 == 0 && msg_rd->msg_field_i16 == 0 && msg_rd->msg_field_u16 == 0 &&
         msg_rd->msg_field_i32 == 0 && msg_rd->msg_field_u32 == 0 && msg_rd->msg_field_i64 == 0 &&
         msg_rd->msg_field_u64 == 0 && msg_rd->msg_field_au8[0] == 0 &&
         msg_rd->msg_field_au8[99] == 0 && msg_rd->msg_field_au64[0] == 0 &&
         msg_rd->msg_field_au64[99] == 0 &&
         msg_rd->msg_field_enum == TestIdl_APPEND_DEFAULTS_KIND1 && msg_rd->msg_field_str != NULL &&
         msg_rd->msg_field_str[0] == '\0' && msg_rd->msg_field_bstr[0] == '\0' &&
         msg_rd->msg_field_uni._d == 0 && msg_rd->msg_field_uni._u.field1 == 0 &&
         msg_rd->msg_field_su8._length == 0 && msg_rd->msg_field_subm.submsg_field1 == 0 &&
         msg_rd->msg_field_asubm[0].submsg_field1 == 0 &&
         msg_rd->msg_field_asubm[99].submsg_field1 == 0 && msg_rd->msg_field_ssubm._length == 0;
}
...
static void sample_free_appenddefaults(
  TestIdl_MsgAppendDefaults1 * s1, TestIdl_MsgAppendDefaults2 * s2)
{
  ddsrt_free(s1);
...
static const uint32_t TestIdl_MsgMutable1_ops[] = {
  ...
  11,
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_4BY | DDS_OP_FLAG_MU,
  offsetof(TestIdl_MsgMutable1, msg_field1),
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_2BY,
  offsetof(TestIdl_MsgMutable1, msg_field2),
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_EXT,
  offsetof(TestIdl_MsgMutable1, msg_field3),
  (3u << 16u) + 28u,
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_ARR | DDS_OP_SUBTYPE_STU,
  offsetof(TestIdl_MsgMutable1, msg_field4),
  2u,
  (5u << 16u) + 24u,
  sizeof(TestIdl_SubMsgMutable1),
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_4BY | DDS_OP_FLAG_SGN,
  offsetof(TestIdl_MsgMutable1, msg_field5),
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_8BY | DDS_OP_FLAG_FP,
  offsetof(TestIdl_MsgMutable1, msg_field7),
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_EXT,
  offsetof(TestIdl_MsgMutable1, msg_field8),
  (3u << 16u) + 12u,
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_STU,
  offsetof(TestIdl_MsgMutable1, msg_field10),
  sizeof(TestIdl_SubMsgMutable1),
  (4u << 16u) + 8u,
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_1BY,
  offsetof(TestIdl_MsgMutable1, msg_field11),
  DDS_OP_RTS,
  ...
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_4BY,
  offsetof(TestIdl_SubMsgMutable1, submsg_field1),
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_ARR | DDS_OP_SUBTYPE_4BY,
  offsetof(TestIdl_SubMsgMutable1, submsg_field2),
  3u,
  DDS_OP_RTS,
};
...
static const uint32_t TestIdl_MsgMutable2_ops[] = {
  DDS_OP_PLC,
  DDS_OP_PLM | DDS_OP_FLAG_MU << 16 | 21u,
  1,
  DDS_OP_PLM | 22u,
  2,
  DDS_OP_PLM | 23u,
  ...
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_4BY,
  offsetof(TestIdl_MsgMutable2, msg_field1),
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_2BY,
  offsetof(TestIdl_MsgMutable2, msg_field2),
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_EXT,
  offsetof(TestIdl_MsgMutable2, msg_field3),
  (3u << 16u) + 33u,
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_ARR | DDS_OP_SUBTYPE_STU,
  offsetof(TestIdl_MsgMutable2, msg_field4),
  2u,
  (5u << 16u) + 29u,
  sizeof(TestIdl_SubMsgMutable2),
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_4BY | DDS_OP_FLAG_SGN,
  offsetof(TestIdl_MsgMutable2, msg_field6),
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_8BY | DDS_OP_FLAG_FP,
  offsetof(TestIdl_MsgMutable2, msg_field7),
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_EXT,
  offsetof(TestIdl_MsgMutable2, msg_field9),
  (3u << 16u) + 17u,
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_STU,
  offsetof(TestIdl_MsgMutable2, msg_field10),
  sizeof(TestIdl_SubMsgMutable2),
  (4u << 16u) + 13u,
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_1BY,
  offsetof(TestIdl_MsgMutable2, msg_field11),
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_STU,
  offsetof(TestIdl_MsgMutable2, msg_field12),
  sizeof(TestIdl_SubMsgMutable2),
  (4u << 16u) + 5u,
  DDS_OP_RTS,
  ...
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_4BY,
  offsetof(TestIdl_SubMsgMutable2, submsg_field1),
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_ARR | DDS_OP_SUBTYPE_4BY,
  offsetof(TestIdl_SubMsgMutable2, submsg_field2),
  3u,
  DDS_OP_RTS,
};

const dds_topic_descriptor_t TestIdl_MsgMutable1_desc = {
  sizeof(TestIdl_MsgMutable1), 4u, 0u, 0u, "TestIdl::MsgMutable1", NULL, 0,
  TestIdl_MsgMutable1_ops,     ""};
const dds_topic_descriptor_t TestIdl_MsgMutable2_desc = {
  sizeof(TestIdl_MsgMutable2), 4u, 0u, 0u, "TestIdl::MsgMutable2", NULL, 0,
  TestIdl_MsgMutable2_ops,     ""};

static void * sample_init_mutable1(void)
{
  TestIdl_SubMsgMutable1 sseq[] = {
    {.submsg_field1 = 1001, .submsg_field2 = {1002, 1003, 1004}},
    {.submsg_field1 = 1003, .submsg_field2 = {1005, 1006, 1007}}};
  TestIdl_SubMsgMutable1_seq seq = {
    ._length = 2, ._maximum = 2, ._buffer = ddsrt_memdup(sseq, 2 * sizeof(TestIdl_SubMsgMutable1))};
  TestIdl_MsgMutable1 msg = {
    .msg_field1 = 1,
    .msg_field2 = 2,
    .msg_field3 = {.submsg_field1 = 3, .submsg_field2 = {4, 5, 6}},
    .msg_field4 =
      {{.submsg_field1 = 10, .submsg_field2 = {11, 12, 13}},
       {.submsg_field1 = 14, .submsg_field2 = {15, 16, 17}}},
    .msg_field5 = -5,
    .msg_field7 = 4.1,
...
{
  TestIdl_SubMsgMutable2 sseq[] = {
    {.submsg_field1 = 2001, .submsg_field2 = {2002, 2003, 2004}},
    {.submsg_field1 = 2003, .submsg_field2 = {2005, 2006, 2007}}};
  TestIdl_SubMsgMutable2_seq seq = {
    ._length = 2, ._maximum = 2, ._buffer = ddsrt_memdup(sseq, 2 * sizeof(TestIdl_SubMsgMutable2))};
  TestIdl_SubMsgMutable2 sseq2[] = {
    {.submsg_field1 = 2001, .submsg_field2 = {2002, 2003, 2004}},
    {.submsg_field1 = 2005, .submsg_field2 = {2006, 2007, 2008}},
    {.submsg_field1 = 2009, .submsg_field2 = {2010, 2011, 2012}}};
  TestIdl_SubMsgMutable2_seq seq2 = {
    ._length = 3,
    ._maximum = 3,
    ._buffer = ddsrt_memdup(sseq2, 3 * sizeof(TestIdl_SubMsgMutable2))};
  TestIdl_MsgMutable2 msg = {
    .msg_field1 = 101,
    .msg_field2 = 102,
    .msg_field3 = {.submsg_field1 = 103, .submsg_field2 = {104, 105, 106}},
    .msg_field4 =
      {{.submsg_field1 = 1010, .submsg_field2 = {1011, 1012, 1013}},
       {.submsg_field1 = 1014, .submsg_field2 = {1015, 1016, 1017}}},
    .msg_field6 = -106,
    .msg_field7 = 104.1,
...
static bool sample_equal_mutable1_intseq(uint32_t * seq1, uint32_t * seq2, uint32_t len)
{
  for (uint32_t n = 0; n < len; n++)
    if (seq1[n] != seq2[n]) return false;
  return true;
}

static bool sample_equal_mutable_TestIdl_SubMsgMutable_seq(
  TestIdl_SubMsgMutable1_seq * s1, TestIdl_SubMsgMutable2_seq * s2)
{
  if (s1->_length != s2->_length) return false;
  for (uint32_t n = 0; n < s1->_length; n++) {
    if (
      s1->_buffer[n].submsg_field1 != s2->_buffer[n].submsg_field1 ||
...
static bool sample_equal_mutable1(void * s_wr, void * s_rd)
{
  ...
  return msg_wr->msg_field1 == msg_rd->msg_field1 && msg_wr->msg_field2 == msg_rd->msg_field2 &&
         msg_wr->msg_field3.submsg_field1 == msg_rd->msg_field3.submsg_field1 &&
         sample_equal_mutable1_intseq(
           msg_wr->msg_field3.submsg_field2, msg_rd->msg_field3.submsg_field2, 3) &&
         msg_wr->msg_field4[0].submsg_field1 == msg_rd->msg_field4[0].submsg_field1 &&
         sample_equal_mutable1_intseq(
           msg_wr->msg_field4[0].submsg_field2, msg_rd->msg_field4[0].submsg_field2, 3) &&
         msg_wr->msg_field4[1].submsg_field1 == msg_rd->msg_field4[1].submsg_field1 &&
         sample_equal_mutable1_intseq(
           msg_wr->msg_field4[1].submsg_field2, msg_rd->msg_field4[1].submsg_field2, 3) &&
         msg_rd->msg_field6 == 0 && msg_wr->msg_field7 == msg_rd->msg_field7 &&
         msg_rd->msg_field9.submsg_field1 == 0 && msg_rd->msg_field9.submsg_field2[0] == 0 &&
         msg_rd->msg_field9.submsg_field2[1] == 0 && msg_rd->msg_field9.submsg_field2[2] == 0 &&
         msg_wr->msg_field10._length == msg_rd->msg_field10._length &&
         sample_equal_mutable_TestIdl_SubMsgMutable_seq(
           &msg_wr->msg_field10, &msg_rd->msg_field10) &&
         msg_wr->msg_field11 == msg_rd->msg_field11 && msg_rd->msg_field12._length == 0;
}
...
static bool sample_equal_mutable2(void * s_wr, void * s_rd)
{
  ...
  return msg_wr->msg_field1 == msg_rd->msg_field1 && msg_wr->msg_field2 == msg_rd->msg_field2 &&
         ...
         sample_equal_mutable1_intseq(
           msg_wr->msg_field4[1].submsg_field2, msg_rd->msg_field4[1].submsg_field2, 3) &&
         msg_rd->msg_field5 == 0 && msg_wr->msg_field7 == msg_rd->msg_field7 &&
         msg_rd->msg_field8.submsg_field1 == 0 && msg_rd->msg_field8.submsg_field2[0] == 0 &&
         msg_rd->msg_field8.submsg_field2[1] == 0 && msg_rd->msg_field8.submsg_field2[2] == 0 &&
         msg_wr->msg_field10._length == msg_rd->msg_field10._length &&
         sample_equal_mutable_TestIdl_SubMsgMutable_seq(
           &msg_rd->msg_field10, &msg_wr->msg_field10) &&
...
static void sample_free_mutable1(void * s_wr, void * s_rd) { sample_free_mutable(s_wr, s_rd); }

static void sample_free_mutable2(void * s_wr, void * s_rd) { sample_free_mutable(s_rd, s_wr); }
...
static void entity_init(
  const dds_topic_descriptor_t * desc, dds_data_representation_id_t data_representation,
  bool exp_rd_wr_fail)
{
  char topicname[100];
  ...
  if (!exp_rd_wr_fail) sync_reader_writer(dp2, rd, dp1, wr);
  dds_delete_qos(qos);
}
...
CU_TheoryDataPoints(ddsc_cdrstream, ser_des) = {
  CU_DataPoints(
    ...
    "arrays"),
  CU_DataPoints(
    const dds_topic_descriptor_t *, &D(Nested), &D(Str), &D(Union), &D(Recursive), &D(Appendable),
    &D(KeysNested), &D(Arr)),
  CU_DataPoints(sample_empty, 0, 0, 0, 0, 0, E(keysnested), 0),
  CU_DataPoints(
    sample_init, I(nested), I(str), I(union), I(recursive), I(appendable), I(keysnested), I(arr)),
  CU_DataPoints(keys_equal, 0, 0, 0, 0, 0, K(keysnested), 0),
  CU_DataPoints(
    sample_equal, C(nested), C(str), C(union), C(recursive), C(appendable), C(keysnested), C(arr)),
  CU_DataPoints(
    sample_free, F(nested), F(str), F(union), F(recursive), F(appendable), F(keysnested), F(arr)),
};

CU_Theory(
  (const char * descr, const dds_topic_descriptor_t * desc, sample_empty sample_empty_fn,
   sample_init sample_init_fn, keys_equal keys_equal_fn, sample_equal sample_equal_fn,
...
CU_TheoryDataPoints(ddsc_cdrstream, ser_des_multiple) = {
  ...
  CU_DataPoints(
    const dds_topic_descriptor_t *, &D(Nested), &D(Str), &D(Union), &D(Recursive), &D(Appendable),
    &D(KeysNested), &D(Arr), &D(Ext), &D(Opt)),
  CU_DataPoints(
    sample_init, I(nested), I(str), I(union), I(recursive), I(appendable), I(keysnested), I(arr),
    I(ext), I(opt)),
  CU_DataPoints(
...
CU_Theory(
  (const char * descr, const dds_topic_descriptor_t * desc, sample_init sample_init_fn,
   sample_equal sample_equal_fn, sample_free sample_free_fn),
...
CU_TheoryDataPoints(ddsc_cdrstream, appendable_mutable) = {
  CU_DataPoints(
    const char *, "appendable struct",
    /*                                              |                 */ "appendable defaults",
    /*                                              |                  |                     */
    "mutable"),
  CU_DataPoints(
    const dds_topic_descriptor_t *, &D(AppendStruct1), &D(AppendDefaults1), &D(Mutable1)),
  CU_DataPoints(
    const dds_topic_descriptor_t *, &D(AppendStruct2), &D(AppendDefaults2), &D(Mutable2)),
...
CU_Theory(
  (const char * descr, const dds_topic_descriptor_t * desc1, const dds_topic_descriptor_t * desc2,
   sample_init sample_init_fn1, sample_init sample_init_fn2, sample_equal sample_equal_fn1,
   sample_equal sample_equal_fn2, sample_free2 sample_free_fn1, sample_free2 sample_free_fn2),
  ddsc_cdrstream, appendable_mutable, .init = cdrstream_init, .fini = cdrstream_fini)
{
  for (int t = 0; t <= 1; t++) {
    ...
    desc_wr = (struct dds_cdrstream_desc){
      ...
      .keys.keys = NULL,
      .ops.nops =
        dds_stream_countops(topic_desc_wr->m_ops, topic_desc_wr->m_nkeys, topic_desc_wr->m_keys),
    ...
    desc_rd = (struct dds_cdrstream_desc){
      ...
      .keys.keys = NULL,
      .ops.nops =
        dds_stream_countops(topic_desc_rd->m_ops, topic_desc_rd->m_nkeys, topic_desc_rd->m_keys),
...
CU_TheoryDataPoints(ddsc_cdrstream, min_xcdr_version) = {
  CU_DataPoints(
    const dds_topic_descriptor_t *, D(t), D(t_nested), D(t_inherit), D(t_opt), D(t_ext),
    D(t_append), D(t_mut), D(t_nested_mut), D(t_nested_opt)),
  CU_DataPoints(uint16_t, XCDR1, XCDR1, XCDR1, XCDR2, XCDR1, XCDR2, XCDR2, XCDR2, XCDR2),
};

CU_Theory(
  (const dds_topic_descriptor_t * desc, uint16_t min_xcdrv), ddsc_cdrstream, min_xcdr_version,
  .init = cdrstream_init, .fini = cdrstream_fini)
{
...
CU_Test(ddsc_cdrstream, check_optimize)
{
  static const struct
  {
    ...
    {D(t5a), 0, 0,
     "array of non-primitive type is currently not optimized (FIXME: could be optimized for "
     "XCDR1?)"},
    {D(t6), 16, 16, "CDR and memory have equal alignment"},
    {D(t7), 0, 0,
     "field f2 is 1-byte aligned in CDR (because of 1-byte type in nested type), but 2-byte in "
     "memory"},
    ...
    {D(t27), 16, 0,
     "inheritance, base members before derived type members, xcdr2 has 4 byte alignment for long "
     "long"},
  };

  for (uint32_t i = 0; i < sizeof(tests) / sizeof(tests[0]); i++) {
    printf("running test for desc %s: %s ", tests[i].desc->m_typename, tests[i].description);
    struct dds_cdrstream_desc ddsi_desc = {
      .ops.nops = tests[i].desc->m_nops,
      .ops.ops = (uint32_t *)tests[i].desc->m_ops,
      .size = tests[i].desc->m_size};
...
static void init_sub1(uint8_t * data)
{
  ...
  t1->f2.s2 = NULL;
  t1->f2.s3 = (dds_sequence_string){
    ._length = 1,
    ._maximum = 1,
    ._release = true,
    ._buffer = ddsrt_malloc(1 * sizeof(*t1->f2.s3._buffer))};
...
static void init_sub3(uint8_t * data)
{
  ...
  t3->f4.s1 = NULL;
  t3->f4.s2 = (dds_sequence_long){
    ._length = 2,
    ._maximum = 2,
    ._release = true,
    ._buffer = ddsrt_malloc(2 * sizeof(*t3->f4.s2._buffer))};
}
...
static void init_sub4(uint8_t * data)
{
  ...
  (*t4->f2.s2.s2) = (dds_sequence_long){
    ._length = 3,
    ._maximum = 3,
    ._release = true,
    ._buffer = ddsrt_malloc(3 * sizeof(t4->f2.s2.s2->_buffer))};
  t4->f4.s2 = ddsrt_malloc(sizeof(*t4->f2.s2.s2));
  (*t4->f4.s2) = (dds_sequence_long){
    ._length = 1,
    ._maximum = 4,
    ._release = true,
    ._buffer = ddsrt_malloc(4 * sizeof(t4->f4.s2->_buffer))};
}
...
CU_Test(ddsc_cdrstream, skip_default)
{
  ...
  for (uint32_t i = 0; i < sizeof(tests) / sizeof(tests[0]); i++) {
    printf(
      "running test for desc %s/%s: %s\n", tests[i].desc_pub->m_typename,
      tests[i].desc_sub->m_typename, tests[i].description);
    ...
    memset(
      sample_pub, 0xef,
      desc_pub.size);  // assumes no pointers (strings, sequences, @external, @optional) in pub type
    bool ret =
      dds_stream_write_sampleLE(&os, &dds_cdrstream_default_allocator, sample_pub, &desc_pub);
    CU_ASSERT_FATAL(ret);
    ...
    dds_istream_t is = {
      .m_buffer = os.x.m_buffer,
      .m_index = 0,
      .m_size = os.x.m_size,
      .m_xcdr_version = os.x.m_xcdr_version};
