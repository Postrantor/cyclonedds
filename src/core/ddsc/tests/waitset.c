...
typedef enum thread_state_t { STARTING, WAITING, STOPPED } thread_state_t;
...
static void ddsc_waitset_init(void)
{
  ...
  topic = dds_create_topic(
    ...
    create_unique_topic_name("ddsc_waitset_test", name, sizeof name), NULL, NULL);
...
static void ddsc_waitset_fini(void) { ddsc_waitset_basic_fini(); }
...
static void ddsc_waitset_attached_fini(void) { ddsc_waitset_fini(); }

CU_Test(
  ddsc_waitset_create, second, .init = ddsc_waitset_basic_init, .fini = ddsc_waitset_basic_fini)
{
  dds_entity_t ws;
  dds_return_t ret;
...
CU_Test(
  ddsc_waitset_create, deleted_participant, .init = ddsc_waitset_basic_init,
  .fini = ddsc_waitset_basic_fini)
{
  dds_entity_t ws;
...
CU_Theory(
  (dds_entity_t par), ddsc_waitset_create, invalid_params, .init = ddsc_waitset_basic_init,
  .fini = ddsc_waitset_basic_fini)
{
...
CU_TheoryDataPoints(ddsc_waitset_create, non_participants) = {
  CU_DataPoints(
    dds_entity_t *, &topic, &writer, &reader, &waitset, &publisher, &subscriber, &readcond),
};
CU_Theory(
  (dds_entity_t * par), ddsc_waitset_create, non_participants, .init = ddsc_waitset_init,
  .fini = ddsc_waitset_fini)
{
  dds_entity_t ws = dds_create_waitset(*par);
...
CU_TheoryDataPoints(ddsc_waitset_attach, invalid_params) = {
  CU_DataPoints(dds_entity_t, -2, -1, 0, INT_MAX, INT_MIN),
  CU_DataPoints(
    dds_attach_t, (dds_attach_t)NULL, (dds_attach_t)&reader, (dds_attach_t)3, (dds_attach_t)0,
    (dds_attach_t)0, (dds_attach_t)0, (dds_attach_t)0),
};
CU_Theory(
  (dds_entity_t e, dds_attach_t a), ddsc_waitset_attach, invalid_params,
  .init = ddsc_waitset_basic_init, .fini = ddsc_waitset_basic_fini)
{
...
CU_Theory(
  (dds_entity_t ws, dds_attach_t a), ddsc_waitset_attach, invalid_waitsets,
  .init = ddsc_waitset_basic_init, .fini = ddsc_waitset_basic_fini)
{
...
CU_TheoryDataPoints(ddsc_waitset_attach, non_waitsets) = {
  CU_DataPoints(
    dds_entity_t *, &participant, &topic, &writer, &reader, &publisher, &subscriber, &readcond),
  CU_DataPoints(
    dds_entity_t *, &participant, &topic, &writer, &reader, &waitset, &publisher, &subscriber,
    &readcond),
  CU_DataPoints(
    dds_attach_t, (dds_attach_t)NULL, (dds_attach_t)&reader, (dds_attach_t)3, (dds_attach_t)0,
    (dds_attach_t)0, (dds_attach_t)0, (dds_attach_t)0),
...
CU_Theory(
  (dds_entity_t * ws, dds_entity_t * e, dds_attach_t a), ddsc_waitset_attach, non_waitsets,
  .init = ddsc_waitset_init, .fini = ddsc_waitset_fini)
{
...
CU_Test(
  ddsc_waitset_attach, deleted_waitset, .init = ddsc_waitset_basic_init,
  .fini = ddsc_waitset_basic_fini)
{
  dds_delete(waitset);
...
CU_TheoryDataPoints(ddsc_waitset_attach_detach, valid_entities) = {
  ...
  CU_DataPoints(
    ...
    &readcond),
  CU_DataPoints(
    dds_attach_t, (dds_attach_t)NULL, (dds_attach_t)&reader, (dds_attach_t)3, (dds_attach_t)3,
    (dds_attach_t)3, (dds_attach_t)3, (dds_attach_t)3, (dds_attach_t)3),
};
CU_Theory(
  (dds_entity_t * ws, dds_entity_t * e, dds_attach_t a), ddsc_waitset_attach_detach, valid_entities,
  .init = ddsc_waitset_init, .fini = ddsc_waitset_fini)
{
  dds_return_t exp;
  dds_return_t ret;
...
CU_Test(
  ddsc_waitset_attach_detach, second, .init = ddsc_waitset_basic_init,
  .fini = ddsc_waitset_basic_fini)
{
  dds_return_t ret;
...
CU_Theory(
  (dds_entity_t e), ddsc_waitset_detach, invalid_params, .init = ddsc_waitset_basic_init,
  .fini = ddsc_waitset_basic_fini)
{
...
CU_Theory(
  (dds_entity_t ws), ddsc_waitset_detach, invalid_waitsets, .init = ddsc_waitset_basic_init,
  .fini = ddsc_waitset_basic_fini)
{
...
CU_Theory(
  (dds_entity_t * ws, dds_entity_t * e), ddsc_waitset_detach, valid_entities,
  .init = ddsc_waitset_init, .fini = ddsc_waitset_fini)
{
  dds_return_t exp;
  dds_return_t ret;
...
{
  const dds_entity_t es[] = {readcond,  writer,     reader,  topic,
                             publisher, subscriber, waitset, participant};
  dds_return_t ret;
...
CU_Test(
  ddsc_waitset_attach_detach, combinations, .init = ddsc_waitset_init, .fini = ddsc_waitset_fini)
{
  const dds_entity_t entities[] = {readcond,  writer,     reader,  topic,
                                   publisher, subscriber, waitset, participant};
  ...
  for (uint32_t round = 1; round < (2u << count) - 2; round++) {
    ...
    uint32_t flipidx = 0;
    while (!(flipped & (1u << flipidx))) flipidx++;
...
CU_Test(
  ddsc_waitset_delete_attached, self, .init = ddsc_waitset_basic_init,
  .fini = ddsc_waitset_basic_fini)
{
  dds_return_t ret;
  ret = dds_waitset_attach(waitset, waitset, 0);
...
CU_Test(
  ddsc_waitset_delete_attached, participant, .init = ddsc_waitset_basic_init,
  .fini = ddsc_waitset_basic_fini)
{
  dds_return_t ret;
...
CU_Test(
  ddsc_waitset_set_trigger, deleted_waitset, .init = ddsc_waitset_basic_init,
  .fini = ddsc_waitset_basic_fini)
{
  dds_delete(waitset);
...
CU_Theory(
  (dds_entity_t ws), ddsc_waitset_set_trigger, invalid_params, .init = ddsc_waitset_basic_init,
  .fini = ddsc_waitset_basic_fini)
{
...
CU_Theory(
  (dds_entity_t * ws), ddsc_waitset_set_trigger, non_waitsets, .init = ddsc_waitset_init,
  .fini = ddsc_waitset_fini)
{
  dds_return_t ret = dds_waitset_set_trigger(*ws, true);
  CU_ASSERT_FATAL(ret == DDS_RETCODE_ILLEGAL_OPERATION);
...
CU_Test(
  ddsc_waitset_wait, deleted_waitset, .init = ddsc_waitset_attached_init,
  .fini = ddsc_waitset_attached_fini)
{
  dds_delete(waitset);
...
CU_Theory(
  (dds_entity_t ws), ddsc_waitset_wait, invalid_waitsets, .init = ddsc_waitset_basic_init,
  .fini = ddsc_waitset_basic_fini)
{
  dds_attach_t triggered;
...
CU_Theory(
  (dds_entity_t * ws), ddsc_waitset_wait, non_waitsets, .init = ddsc_waitset_init,
  .fini = ddsc_waitset_fini)
{
  dds_attach_t triggered;
  dds_return_t ret = dds_waitset_wait(*ws, &triggered, 1, DDS_SECS(1));
...
CU_Theory(
  (dds_attach_t * a, size_t size, int msec), ddsc_waitset_wait, invalid_params,
  .init = ddsc_waitset_basic_init, .fini = ddsc_waitset_basic_fini)
{
  dds_return_t ret;
...
CU_Test(
  ddsc_waitset_wait_until, deleted_waitset, .init = ddsc_waitset_attached_init,
  .fini = ddsc_waitset_attached_fini)
{
  (void)dds_delete(waitset);
  dds_attach_t triggered;
...
CU_Theory(
  (dds_entity_t ws), ddsc_waitset_wait_until, invalid_waitsets, .init = ddsc_waitset_basic_init,
  .fini = ddsc_waitset_basic_fini)
{
  dds_attach_t triggered;
...
CU_Theory(
  (dds_entity_t * ws), ddsc_waitset_wait_until, non_waitsets, .init = ddsc_waitset_init,
  .fini = ddsc_waitset_fini)
{
  dds_attach_t triggered;
  dds_return_t ret = dds_waitset_wait_until(*ws, &triggered, 1, dds_time());
...
CU_TheoryDataPoints(ddsc_waitset_wait_until, invalid_params) = {
  CU_DataPoints(dds_attach_t *, (dds_attach_t[]){0}, NULL), CU_DataPoints(size_t, 0, 1, 100)};
CU_Theory(
  (dds_attach_t * a, size_t size), ddsc_waitset_wait_until, invalid_params,
  .init = ddsc_waitset_basic_init, .fini = ddsc_waitset_basic_fini)
{
  dds_return_t ret;
...
CU_Test(
  ddsc_waitset_wait_until, past, .init = ddsc_waitset_attached_init,
  .fini = ddsc_waitset_attached_fini)
{
  dds_attach_t triggered;
...
CU_Theory(
  (size_t size), ddsc_waitset_get_entities, array_sizes, .init = ddsc_waitset_attached_init,
  .fini = ddsc_waitset_attached_fini)
{
  const dds_entity_t expected[] = {participant, topic,     writer,    reader,
                                   waitset,     publisher, subscriber};
  uint32_t found = 0;
  dds_return_t ret;
  dds_entity_t es[MAX_ENTITIES_CNT];
...
CU_Test(
  ddsc_waitset_get_entities, no_array, .init = ddsc_waitset_attached_init,
  .fini = ddsc_waitset_attached_fini)
{
  dds_return_t ret;
...
CU_Test(
  ddsc_waitset_get_entities, deleted_waitset, .init = ddsc_waitset_attached_init,
  .fini = ddsc_waitset_attached_fini)
{
...
CU_Theory(
  (dds_entity_t ws), ddsc_waitset_get_entities, invalid_params, .init = ddsc_waitset_attached_init,
  .fini = ddsc_waitset_attached_fini)
{
  dds_entity_t entities[MAX_ENTITIES_CNT];
...
CU_Theory(
  (dds_entity_t * ws), ddsc_waitset_get_entities, non_waitsets, .init = ddsc_waitset_attached_init,
  .fini = ddsc_waitset_attached_fini)
{
  dds_entity_t entities[MAX_ENTITIES_CNT];
  dds_return_t ret = dds_waitset_get_entities(*ws, entities, MAX_ENTITIES_CNT);
...
CU_Test(
  ddsc_waitset_triggering, on_self, .init = ddsc_waitset_attached_init,
  .fini = ddsc_waitset_attached_fini)
{
  dds_return_t ret;
...
CU_Test(
  ddsc_waitset_triggering, on_reader, .init = ddsc_waitset_attached_init,
  .fini = ddsc_waitset_attached_fini)
{
...
CU_Test(
  ddsc_waitset_triggering, on_readcondition, .init = ddsc_waitset_attached_init,
  .fini = ddsc_waitset_attached_fini)
{
  dds_return_t ret;
...
static dds_return_t thread_reached_state(
  ddsrt_atomic_uint32_t * actual, thread_state_t expected, int32_t msec)
{
...
static dds_return_t waiting_thread_expect_exit(struct thread_arg_t * arg)
{
  ...
  if (ret == 0) (void)ddsrt_thread_join(arg->tid, NULL);
  return ret;
}
...
CU_TheoryDataPoints(ddsc_waitset_triggering, after_listener) = {CU_DataPoints(bool, true, false)};
CU_Theory(
  (bool use_nop_listener), ddsc_waitset_triggering, after_listener,
  .init = ddsc_waitset_attached_init, .fini = ddsc_waitset_attached_fini)
{
  ddsrt_atomic_uint32_t flags;
  ...
  for (unsigned i = 0; i < rounds; i++) {
    ...
    dds_lset_data_available_arg(
      listener, use_nop_listener ? listener_nop : listener_take_expecting_data, &flags, false);
    ...
    struct listener_waitset_thread_arg arg = {
      .flags = &flags, .ws = waitset, .abstimeout = dds_time() + reltimeout};
    ddsrt_threadattr_init(&thread_attr);
    ret = ddsrt_thread_create(
      &thread_id, "waiting_thread", &thread_attr, listener_waitset_thread, &arg);
    CU_ASSERT_FATAL(ret == 0);
    ...
    flags_counts[cur]++;
    if (cur != exp) printf("current flags: 0x%" PRIx32 ", expected: 0x%" PRIx32 "\n", cur, exp);
  }
