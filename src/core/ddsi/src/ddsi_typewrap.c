...
static void ddsi_xt_get_typeid_impl(
  const struct xt_type * xt, struct DDS_XTypes_TypeIdentifier * ti, ddsi_typeid_kind_t kind);
...
void ddsi_typeid_copy_impl(
  struct DDS_XTypes_TypeIdentifier * dst, const struct DDS_XTypes_TypeIdentifier * src)
{
  assert(src);
  assert(dst);
  dst->_d = src->_d;
  if (src->_d <= DDS_XTypes_TK_STRING16) return;
  switch (src->_d) {
    ...
    case DDS_XTypes_TI_PLAIN_SEQUENCE_SMALL:
      ...
      dst->_u.seq_sdefn.element_identifier =
        ddsi_typeid_dup_impl(src->_u.seq_sdefn.element_identifier);
      break;
    case DDS_XTypes_TI_PLAIN_SEQUENCE_LARGE:
      ...
      dst->_u.seq_ldefn.element_identifier =
        ddsi_typeid_dup_impl(src->_u.seq_ldefn.element_identifier);
      break;
    case DDS_XTypes_TI_PLAIN_ARRAY_SMALL:
      dst->_u.array_sdefn.header = src->_u.array_sdefn.header;
      dst->_u.array_sdefn.array_bound_seq._length = dst->_u.array_sdefn.array_bound_seq._maximum =
        src->_u.array_sdefn.array_bound_seq._length;
      if (src->_u.array_sdefn.array_bound_seq._length > 0) {
        dst->_u.array_sdefn.array_bound_seq._buffer = ddsrt_memdup(
          src->_u.array_sdefn.array_bound_seq._buffer,
          src->_u.array_sdefn.array_bound_seq._length *
            sizeof(*src->_u.array_sdefn.array_bound_seq._buffer));
        dst->_u.array_sdefn.array_bound_seq._release = true;
      } else
        dst->_u.array_sdefn.array_bound_seq._release = false;
      dst->_u.array_sdefn.element_identifier =
        ddsi_typeid_dup_impl(src->_u.array_sdefn.element_identifier);
      break;
    case DDS_XTypes_TI_PLAIN_ARRAY_LARGE:
      dst->_u.array_ldefn.header = src->_u.array_ldefn.header;
      dst->_u.array_ldefn.array_bound_seq._length = dst->_u.array_ldefn.array_bound_seq._maximum =
        src->_u.array_ldefn.array_bound_seq._length;
      if (src->_u.array_ldefn.array_bound_seq._length > 0) {
        dst->_u.array_ldefn.array_bound_seq._buffer = ddsrt_memdup(
          src->_u.array_ldefn.array_bound_seq._buffer,
          src->_u.array_ldefn.array_bound_seq._length *
            sizeof(*src->_u.array_ldefn.array_bound_seq._buffer));
        dst->_u.array_ldefn.array_bound_seq._release = true;
      } else
        dst->_u.array_ldefn.array_bound_seq._release = false;
      dst->_u.array_ldefn.element_identifier =
        ddsi_typeid_dup_impl(src->_u.array_ldefn.element_identifier);
      break;
    case DDS_XTypes_TI_PLAIN_MAP_SMALL:
      ...
      dst->_u.map_sdefn.element_identifier =
        ddsi_typeid_dup_impl(src->_u.map_sdefn.element_identifier);
    ...
    case DDS_XTypes_TI_PLAIN_MAP_LARGE:
      ...
      dst->_u.map_ldefn.element_identifier =
        ddsi_typeid_dup_impl(src->_u.map_ldefn.element_identifier);
...
struct DDS_XTypes_TypeIdentifier * ddsi_typeid_dup_impl(
  const struct DDS_XTypes_TypeIdentifier * src)
{
  if (ddsi_typeid_is_none_impl(src)) return NULL;
...
const char * ddsi_typekind_descr(unsigned char disc)
{
  switch (disc) {
    ...
    case DDS_XTypes_TK_MAP:
      return "MAP";
    case DDS_XTypes_TI_STRING8_SMALL:
      return "STRING8_SMALL";
    case DDS_XTypes_TI_STRING8_LARGE:
      return "STRING8_LARGE";
    case DDS_XTypes_TI_STRING16_SMALL:
      return "STRING16_SMALL";
    case DDS_XTypes_TI_STRING16_LARGE:
      return "STRING16_LARGE";
    case DDS_XTypes_TI_PLAIN_SEQUENCE_SMALL:
      return "PLAIN_SEQUENCE_SMALL";
    case DDS_XTypes_TI_PLAIN_SEQUENCE_LARGE:
      return "PLAIN_SEQUENCE_LARGE";
    case DDS_XTypes_TI_PLAIN_ARRAY_SMALL:
      return "PLAIN_ARRAY_SMALL";
    case DDS_XTypes_TI_PLAIN_ARRAY_LARGE:
      return "PLAIN_ARRAY_LARGE";
    case DDS_XTypes_TI_PLAIN_MAP_SMALL:
      return "PLAIN_MAP_SMALL";
    case DDS_XTypes_TI_PLAIN_MAP_LARGE:
      return "PLAIN_MAP_LARGE";
    case DDS_XTypes_TI_STRONGLY_CONNECTED_COMPONENT:
...
static int plain_collection_header_compare(
  struct DDS_XTypes_PlainCollectionHeader a, struct DDS_XTypes_PlainCollectionHeader b)
{
  if (a.equiv_kind != b.equiv_kind) return a.equiv_kind > b.equiv_kind ? 1 : -1;
  if (a.element_flags != b.element_flags) return a.element_flags > b.element_flags ? 1 : -1;
  return 0;
}

static int equivalence_hash_compare(
  const DDS_XTypes_EquivalenceHash a, const DDS_XTypes_EquivalenceHash b)
{
  return memcmp(a, b, sizeof(DDS_XTypes_EquivalenceHash));
}

static int type_object_hashid_compare(
  struct DDS_XTypes_TypeObjectHashId a, struct DDS_XTypes_TypeObjectHashId b)
{
  if (a._d != b._d) return a._d > b._d ? 1 : -1;
  return equivalence_hash_compare(a._u.hash, b._u.hash);
}

static int strongly_connected_component_id_compare(
  struct DDS_XTypes_StronglyConnectedComponentId a,
  struct DDS_XTypes_StronglyConnectedComponentId b)
{
  if (a.scc_length != b.scc_length) return a.scc_length > b.scc_length ? 1 : -1;
  if (a.scc_index != b.scc_index) return a.scc_index > b.scc_index ? 1 : -1;
  return type_object_hashid_compare(a.sc_component_id, b.sc_component_id);
}

static bool type_id_with_size_equal(
  const struct DDS_XTypes_TypeIdentifierWithSize * a,
  const struct DDS_XTypes_TypeIdentifierWithSize * b)
{
  return a->typeobject_serialized_size == b->typeobject_serialized_size &&
         !ddsi_typeid_compare_impl(&a->type_id, &b->type_id);
}

static bool type_id_with_sizeseq_equal(
  const struct dds_sequence_DDS_XTypes_TypeIdentifierWithSize * a,
  const struct dds_sequence_DDS_XTypes_TypeIdentifierWithSize * b)
{
  if (a->_length != b->_length) return false;
  for (uint32_t n = 0; n < a->_length; n++) {
    bool found = false;
    for (uint32_t m = 0; !found && m < b->_length; m++) {
      if (type_id_with_size_equal(&a->_buffer[n], &b->_buffer[m])) found = true;
    }
...
bool ddsi_type_id_with_deps_equal(
  const struct DDS_XTypes_TypeIdentifierWithDependencies * a,
  const struct DDS_XTypes_TypeIdentifierWithDependencies * b, ddsi_type_include_deps_t deps)
{
...
int ddsi_typeid_compare_impl(
  const struct DDS_XTypes_TypeIdentifier * a, const struct DDS_XTypes_TypeIdentifier * b)
{
  int r;
  if (a == NULL && b == NULL) return 0;
  if (a == NULL || b == NULL) return a > b ? 1 : -1;
  if (a->_d != b->_d) return a->_d > b->_d ? 1 : -1;
  if (a->_d <= DDS_XTypes_TK_STRING16) return 0;
  switch (a->_d) {
    case DDS_XTypes_TI_STRING8_SMALL:
    case DDS_XTypes_TI_STRING16_SMALL:
    ...
    case DDS_XTypes_TI_PLAIN_SEQUENCE_SMALL:
      if (
        (r = plain_collection_header_compare(a->_u.seq_sdefn.header, b->_u.seq_sdefn.header)) != 0)
        return r;
      if (
        (r = ddsi_typeid_compare_impl(
           a->_u.seq_sdefn.element_identifier, b->_u.seq_sdefn.element_identifier)) != 0)
        return r;
    ...
    case DDS_XTypes_TI_PLAIN_SEQUENCE_LARGE:
      if (
        (r = plain_collection_header_compare(a->_u.seq_ldefn.header, b->_u.seq_ldefn.header)) != 0)
        return r;
      if (
        (r = ddsi_typeid_compare_impl(
           a->_u.seq_ldefn.element_identifier, b->_u.seq_ldefn.element_identifier)) != 0)
        return r;
    ...
    case DDS_XTypes_TI_PLAIN_ARRAY_SMALL:
      if (
        (r = plain_collection_header_compare(a->_u.array_sdefn.header, b->_u.array_sdefn.header)) !=
        0)
        return r;
      if (a->_u.array_sdefn.array_bound_seq._length != b->_u.array_sdefn.array_bound_seq._length)
        return a->_u.array_sdefn.array_bound_seq._length > b->_u.array_sdefn.array_bound_seq._length
                 ? 1
                 : -1;
      if (a->_u.array_sdefn.array_bound_seq._length > 0)
        if (
          (r = memcmp(
             a->_u.array_sdefn.array_bound_seq._buffer, b->_u.array_sdefn.array_bound_seq._buffer,
             a->_u.array_sdefn.array_bound_seq._length *
               sizeof(*a->_u.array_sdefn.array_bound_seq._buffer))) != 0)
          return r;
      return ddsi_typeid_compare_impl(
        a->_u.array_sdefn.element_identifier, b->_u.array_sdefn.element_identifier);
    case DDS_XTypes_TI_PLAIN_ARRAY_LARGE:
      if (
        (r = plain_collection_header_compare(a->_u.array_ldefn.header, b->_u.array_ldefn.header)) !=
        0)
        return r;
      if (a->_u.array_ldefn.array_bound_seq._length != b->_u.array_ldefn.array_bound_seq._length)
        return a->_u.array_ldefn.array_bound_seq._length > b->_u.array_ldefn.array_bound_seq._length
                 ? 1
                 : -1;
      if (a->_u.array_ldefn.array_bound_seq._length > 0)
        if (
          (r = memcmp(
             a->_u.array_ldefn.array_bound_seq._buffer, b->_u.array_ldefn.array_bound_seq._buffer,
             a->_u.array_ldefn.array_bound_seq._length *
               sizeof(*a->_u.array_ldefn.array_bound_seq._buffer))) != 0)
          return r;
      return ddsi_typeid_compare_impl(
        a->_u.array_ldefn.element_identifier, b->_u.array_ldefn.element_identifier);
    case DDS_XTypes_TI_PLAIN_MAP_SMALL:
      if (
        (r = plain_collection_header_compare(a->_u.map_sdefn.header, b->_u.map_sdefn.header)) != 0)
        return r;
      if (a->_u.map_sdefn.bound != b->_u.map_sdefn.bound)
        return a->_u.map_sdefn.bound > b->_u.map_sdefn.bound ? 1 : -1;
      if (
        (r = ddsi_typeid_compare_impl(
           a->_u.map_sdefn.element_identifier, b->_u.map_sdefn.element_identifier)) != 0)
        return r;
      if (a->_u.map_sdefn.key_flags != b->_u.map_sdefn.key_flags)
        return a->_u.map_sdefn.key_flags != b->_u.map_sdefn.key_flags ? 1 : -1;
      return ddsi_typeid_compare_impl(
        a->_u.map_sdefn.key_identifier, b->_u.map_sdefn.key_identifier);
    case DDS_XTypes_TI_PLAIN_MAP_LARGE:
      if (
        (r = plain_collection_header_compare(a->_u.map_ldefn.header, b->_u.map_ldefn.header)) != 0)
        return r;
      if (a->_u.map_ldefn.bound != b->_u.map_ldefn.bound)
        return a->_u.map_ldefn.bound > b->_u.map_ldefn.bound ? 1 : -1;
      if (
        (r = ddsi_typeid_compare_impl(
           a->_u.map_ldefn.element_identifier, b->_u.map_ldefn.element_identifier)) != 0)
        return r;
      if (a->_u.map_ldefn.key_flags != b->_u.map_ldefn.key_flags)
        return a->_u.map_ldefn.key_flags > b->_u.map_ldefn.key_flags ? 1 : -1;
      return ddsi_typeid_compare_impl(
        a->_u.map_ldefn.key_identifier, b->_u.map_ldefn.key_identifier);
    case DDS_XTypes_TI_STRONGLY_CONNECTED_COMPONENT:
...
{
  dds_ostream_t os = {
    .m_buffer = NULL, .m_index = 0, .m_size = 0, .m_xcdr_version = DDSI_RTPS_CDR_ENC_VERSION_2};
  dds_stream_writeLE(
    (dds_ostreamLE_t *)&os, &dds_cdrstream_default_allocator, (const void *)type_id,
    DDS_XTypes_TypeIdentifier_desc.m_ops);
  *buf = os.m_buffer;
  *sz = os.m_index;
}
...
void ddsi_typeid_fini_impl(struct DDS_XTypes_TypeIdentifier * type_id)
{
  dds_stream_free_sample(
    type_id, &dds_cdrstream_default_allocator, DDS_XTypes_TypeIdentifier_desc.m_ops);
}

void ddsi_typeid_fini(ddsi_typeid_t * type_id) { ddsi_typeid_fini_impl(&type_id->x); }
...
{
  return type_id != NULL &&
         ddsi_typeid_kind_impl(&type_id->x) == DDSI_TYPEID_KIND_FULLY_DESCRIPTIVE;
}

void ddsi_typeid_get_equivalence_hash(
...
void ddsi_typeobj_get_hash_id_impl(
  const struct DDS_XTypes_TypeObject * type_obj, struct DDS_XTypes_TypeIdentifier * type_id)
{
  assert(type_obj);
  assert(type_id);
  ...
  dds_ostream_t os = {
    .m_buffer = NULL, .m_index = 0, .m_size = 0, .m_xcdr_version = DDSI_RTPS_CDR_ENC_VERSION_2};
  dds_stream_writeLE(
    (dds_ostreamLE_t *)&os, &dds_cdrstream_default_allocator, (const void *)type_obj,
    DDS_XTypes_TypeObject_desc.m_ops);
...
dds_return_t ddsi_typeobj_get_hash_id(
  const struct DDS_XTypes_TypeObject * type_obj, ddsi_typeid_t * type_id)
{
...
{
  dds_stream_free_sample(
    typeobj, &dds_cdrstream_default_allocator, DDS_XTypes_TypeObject_desc.m_ops);
}

void ddsi_typeobj_fini(ddsi_typeobj_t * typeobj) { ddsi_typeobj_fini_impl(&typeobj->x); }

static void xt_collection_common_init(
  struct xt_collection_common * xtcc, const struct DDS_XTypes_PlainCollectionHeader * hdr)
{
  xtcc->ek = hdr->equiv_kind;
  xtcc->element_flags = hdr->element_flags;
}

static void xt_sbounds_to_lbounds(
  struct DDS_XTypes_LBoundSeq * lb, const struct DDS_XTypes_SBoundSeq * sb)
{
  lb->_length = sb->_length;
  lb->_maximum = sb->_length;
  lb->_release = true;
  lb->_buffer = ddsrt_malloc(sb->_length * sizeof(*lb->_buffer));
  for (uint32_t n = 0; n < sb->_length; n++) lb->_buffer[n] = (DDS_XTypes_LBound)sb->_buffer[n];
}

static void xt_lbounds_to_sbounds(
  struct DDS_XTypes_SBoundSeq * sb, const struct DDS_XTypes_LBoundSeq * lb)
{
...
static void xt_lbounds_dup(
  struct DDS_XTypes_LBoundSeq * dst, const struct DDS_XTypes_LBoundSeq * src)
{
...
static void DDS_XTypes_AppliedBuiltinMemberAnnotations_copy(
  struct DDS_XTypes_AppliedBuiltinMemberAnnotations * dst,
  const struct DDS_XTypes_AppliedBuiltinMemberAnnotations * src);
static void DDS_XTypes_AppliedAnnotationSeq_copy(
  struct DDS_XTypes_AppliedAnnotationSeq * dst, const struct DDS_XTypes_AppliedAnnotationSeq * src);
static void set_member_detail(
  struct xt_member_detail * dst, const DDS_XTypes_CompleteMemberDetail * src)
{
  ddsrt_strlcpy(dst->name, src->name, sizeof(dst->name));
  get_namehash(dst->name_hash, dst->name);
  if (src->ann_builtin) {
    dst->annotations.ann_builtin =
      ddsrt_calloc(1, sizeof(struct DDS_XTypes_AppliedBuiltinMemberAnnotations));
...
bool ddsi_xt_is_unresolved(const struct xt_type * t)
{
  ...
  return (t->kind == DDSI_TYPEID_KIND_MINIMAL || t->kind == DDSI_TYPEID_KIND_COMPLETE) &&
         t->_d == DDS_XTypes_TK_NONE;
}

bool ddsi_xt_is_resolved(const struct xt_type * t) { return !ddsi_xt_is_unresolved(t); }
...
{
  if (ddsi_xt_is_unresolved(&t->_u.union_type.disc_type->xt)) return DDS_RETCODE_OK;
  uint8_t d = ddsi_xt_unalias(&t->_u.union_type.disc_type->xt)->_d;
  if (
    d != DDS_XTypes_TK_BOOLEAN && d != DDS_XTypes_TK_BYTE && d != DDS_XTypes_TK_CHAR8 &&
    d != DDS_XTypes_TK_CHAR16 && d != DDS_XTypes_TK_INT16 && d != DDS_XTypes_TK_INT32 &&
    d != DDS_XTypes_TK_INT64 && d != DDS_XTypes_TK_UINT16 && d != DDS_XTypes_TK_UINT32 &&
    d != DDS_XTypes_TK_UINT64 && d != DDS_XTypes_TK_ENUM && d != DDS_XTypes_TK_BITMASK) {
...
static dds_return_t xt_valid_struct_member_ids(struct ddsi_domaingv * gv, const struct xt_type * t)
{
  ...
  uint32_t cnt = 0;
  for (const struct xt_type * t1 = t; t1 && ddsi_xt_is_resolved(t1);
       t1 = t1->_u.structure.base_type ? &t1->_u.structure.base_type->xt : NULL)
...
static dds_return_t xt_valid_union_member_ids(struct ddsi_domaingv * gv, const struct xt_type * t)
{
  ...
  DDS_XTypes_MemberId * ids = ddsrt_malloc(cnt * sizeof(*ids));
  for (uint32_t n = 0; n < cnt; n++) ids[n] = t->_u.union_type.members.seq[n].id;
  qsort(ids, cnt, sizeof(*ids), xt_member_id_cmp);
  for (uint32_t n = 0; n < cnt - 1; n++) {
    if (ids[n] == ids[n + 1]) {
...
static dds_return_t xt_valid_enum_values(struct ddsi_domaingv * gv, const struct xt_type * t)
{
  ...
  for (uint32_t n = 0; n < cnt; n++) values[n] = t->_u.enum_type.literals.seq[n].value;
...
static dds_return_t xt_valid_bitmask_positions(struct ddsi_domaingv * gv, const struct xt_type * t)
{
  ...
  for (uint32_t n = 0; n < cnt; n++) positions[n] = t->_u.bitmask.bitflags.seq[n].position;
...
static dds_return_t xt_valid_type_flags(
  struct ddsi_domaingv * gv, uint16_t flags, uint8_t type_kind)
{
  dds_return_t ret = DDS_RETCODE_OK;
  switch (type_kind) {
    case DDS_XTypes_TK_STRUCTURE:
    case DDS_XTypes_TK_UNION:
      if (flags & ~(F | A | M | N | H)) ret = DDS_RETCODE_BAD_PARAMETER;
      if (!(flags & (F | A | M))) ret = DDS_RETCODE_BAD_PARAMETER;
      break;
    case DDS_XTypes_TK_ALIAS:
    case DDS_XTypes_TK_BITSET:
    case DDS_XTypes_TK_SEQUENCE:
    case DDS_XTypes_TK_ARRAY:
    case DDS_XTypes_TK_MAP:
      if (flags) ret = DDS_RETCODE_BAD_PARAMETER;
      break;
    case DDS_XTypes_TK_ENUM:
    case DDS_XTypes_TK_BITMASK:
      // spec says unused, but this flag is actually used for extensibility
      if (flags & ~(F | A)) ret = DDS_RETCODE_BAD_PARAMETER;
      if (!(flags & (F | A))) ret = DDS_RETCODE_BAD_PARAMETER;
      break;
    case DDS_XTypes_TK_ANNOTATION:
  ...
  if (ret != DDS_RETCODE_OK) GVTRACE("invalid flags %" PRIx16 " for type\n", flags);
  return ret;
}
#undef F
#undef A
...
static dds_return_t xt_valid_member_flags(
  struct ddsi_domaingv * gv, uint16_t flags, uint8_t member_flag_kind)
{
  dds_return_t ret = DDS_RETCODE_OK;
  ...
  switch (member_flag_kind) {
    case MEMBER_FLAG_COLLECTION_ELEMENT:
      if (flags & ~(T1 | T2 | X)) ret = DDS_RETCODE_BAD_PARAMETER;
      break;
    case MEMBER_FLAG_STRUCT_MEMBER:
      if (flags & ~(T1 | T2 | O | M | K | X)) ret = DDS_RETCODE_BAD_PARAMETER;
      break;
    case MEMBER_FLAG_UNION_MEMBER:
      if (flags & ~(T1 | T2 | D | X)) ret = DDS_RETCODE_BAD_PARAMETER;
      break;
    case MEMBER_FLAG_UNION_DISC:
      // must-understand not in spec
      if (flags & ~(T1 | T2 | M | K)) ret = DDS_RETCODE_BAD_PARAMETER;
      break;
    case MEMBER_FLAG_ENUM_LITERAL:
      if (flags & ~(D)) ret = DDS_RETCODE_BAD_PARAMETER;
      break;
...
static dds_return_t xt_validate_impl(
  struct ddsi_domaingv * gv, const struct xt_type * t, bool validate_hash_type)
{
  dds_return_t ret;

  if (!validate_hash_type && !xt_is_non_hash(t)) return DDS_RETCODE_OK;

  if (ddsi_xt_is_unresolved(t)) return DDS_RETCODE_OK;
  switch (t->_d) {
    case DDS_XTypes_TK_ANNOTATION:
    ...
    case DDS_XTypes_TK_STRUCTURE:
      ...
      for (uint32_t n = 0; n < t->_u.structure.members.length; n++) {
        if ((ret = xt_valid_member_flags(
               gv, t->_u.structure.members.seq[n].flags, MEMBER_FLAG_STRUCT_MEMBER)))
          return ret;
    ...
    case DDS_XTypes_TK_UNION: {
      if (
        ((ret = xt_valid_union_disc_type(gv, t))) || (ret = xt_valid_union_member_ids(gv, t)) ||
      ...
      for (uint32_t n = 0; n < t->_u.union_type.members.length; n++) {
        ...
        if ((ret = xt_valid_member_flags(gv, flags, MEMBER_FLAG_UNION_MEMBER))) return ret;
    ...
    case DDS_XTypes_TK_ENUM:
      if (
        (ret = xt_valid_type_flags(gv, t->_u.enum_type.flags, t->_d)) ||
        (ret = xt_valid_enum_values(gv, t)))
        return ret;
      if (t->_u.enum_type.bit_bound > 32) return DDS_RETCODE_BAD_PARAMETER;
      for (uint32_t n = 0; n < t->_u.enum_type.literals.length; n++)
        if ((ret = xt_valid_member_flags(
               gv, t->_u.enum_type.literals.seq[n].flags, MEMBER_FLAG_ENUM_LITERAL)))
          return ret;
      break;
    case DDS_XTypes_TK_BITMASK:
      if (
        (ret = xt_valid_type_flags(gv, t->_u.bitmask.flags, t->_d)) ||
        (ret = xt_valid_bitmask_positions(gv, t)))
        return ret;
      if (t->_u.bitmask.bit_bound > 64) return DDS_RETCODE_BAD_PARAMETER;
      for (uint32_t n = 0; n < t->_u.bitmask.bitflags.length; n++)
        if ((ret = xt_valid_member_flags(
               gv, t->_u.bitmask.bitflags.seq[n].flags, MEMBER_FLAG_BIT_FLAG)))
          return ret;
      break;
    case DDS_XTypes_TK_ALIAS:
      if (
        (ret = xt_valid_type_flags(gv, t->_u.alias.flags, t->_d)) ||
      ...
      break;
    case DDS_XTypes_TK_BITSET:
      if ((ret = xt_valid_type_flags(gv, t->_u.bitset.flags, t->_d))) return ret;
      ...
      for (uint32_t n = 0; n < t->_u.bitset.fields.length; n++)
        if ((ret = xt_valid_type_flags(
               gv, t->_u.bitset.fields.seq[n].flags, MEMBER_FLAG_BITSET_MEMBER)))
          return ret;
      break;
    case DDS_XTypes_TK_SEQUENCE:
      if (
        (ret = xt_valid_type_flags(gv, t->_u.seq.c.flags, t->_d)) ||
        (ret =
           xt_valid_member_flags(gv, t->_u.seq.c.element_flags, MEMBER_FLAG_COLLECTION_ELEMENT)) ||
        (ret = xt_validate_impl(gv, &t->_u.seq.c.element_type->xt, false)))
        return ret;
      break;
    case DDS_XTypes_TK_ARRAY:
      if (
        (ret = xt_valid_type_flags(gv, t->_u.array.c.flags, t->_d)) ||
        (ret = xt_valid_member_flags(
           gv, t->_u.array.c.element_flags, MEMBER_FLAG_COLLECTION_ELEMENT)) ||
    ...
    case DDS_XTypes_TK_MAP:
      if (
        (ret = xt_valid_type_flags(gv, t->_u.map.c.flags, t->_d)) ||
        (ret =
           xt_valid_member_flags(gv, t->_u.map.c.element_flags, MEMBER_FLAG_COLLECTION_ELEMENT)) ||
...
static dds_return_t add_minimal_typeobj(
  struct ddsi_domaingv * gv, struct xt_type * xt, const struct DDS_XTypes_TypeObject * to)
{
  ...
  switch (mto->_d) {
    case DDS_XTypes_TK_ALIAS:
      ...
      if (
        (ret = ddsi_type_register_dep(
           gv, &xt->id, &xt->_u.alias.related_type,
           &mto->_u.alias_type.body.common.related_type)) != DDS_RETCODE_OK)
        goto err_to;
    ...
    case DDS_XTypes_TK_STRUCTURE:
      ...
      if (mto->_u.struct_type.header.base_type._d) {
        if (
          (ret = ddsi_type_register_dep(
             gv, &xt->id, &xt->_u.structure.base_type, &mto->_u.struct_type.header.base_type)) !=
          DDS_RETCODE_OK)
          goto err_to;
      } else
        xt->_u.structure.base_type = NULL;
      xt->_u.structure.members.length = mto->_u.struct_type.member_seq._length;
      xt->_u.structure.members.seq =
        ddsrt_calloc(xt->_u.structure.members.length, sizeof(*xt->_u.structure.members.seq));
      for (uint32_t n = 0; n < xt->_u.structure.members.length; n++) {
        xt->_u.structure.members.seq[n].id =
          mto->_u.struct_type.member_seq._buffer[n].common.member_id;
        xt->_u.structure.members.seq[n].flags =
          mto->_u.struct_type.member_seq._buffer[n].common.member_flags;
        if (
          (ret = ddsi_type_register_dep(
             gv, &xt->id, &xt->_u.structure.members.seq[n].type,
             &mto->_u.struct_type.member_seq._buffer[n].common.member_type_id)) != DDS_RETCODE_OK) {
          for (uint32_t m = 0; m < n - 1; m++)
            ddsi_type_unref_locked(gv, xt->_u.structure.members.seq[m].type);
          if (xt->_u.structure.base_type) ddsi_type_unref_locked(gv, xt->_u.structure.base_type);
          ddsrt_free(xt->_u.structure.members.seq);
          goto err_to;
        }
        memcpy(
          xt->_u.structure.members.seq[n].detail.name_hash,
          mto->_u.struct_type.member_seq._buffer[n].detail.name_hash,
    ...
    case DDS_XTypes_TK_UNION:
      ...
      if (
        (ret = ddsi_type_register_dep(
           gv, &xt->id, &xt->_u.union_type.disc_type,
           &mto->_u.union_type.discriminator.common.type_id)) != DDS_RETCODE_OK)
        goto err_to;
      ...
      xt->_u.union_type.members.seq =
        ddsrt_calloc(xt->_u.union_type.members.length, sizeof(*xt->_u.union_type.members.seq));
      for (uint32_t n = 0; n < xt->_u.union_type.members.length; n++) {
        xt->_u.union_type.members.seq[n].id =
          mto->_u.union_type.member_seq._buffer[n].common.member_id;
        xt->_u.union_type.members.seq[n].flags =
          mto->_u.union_type.member_seq._buffer[n].common.member_flags;
        if (
          (ret = ddsi_type_register_dep(
             gv, &xt->id, &xt->_u.union_type.members.seq[n].type,
             &mto->_u.union_type.member_seq._buffer[n].common.type_id)) != DDS_RETCODE_OK) {
          for (uint32_t m = 0; m < n - 1; m++) {
        ...
        xt->_u.union_type.members.seq[n].label_seq._length =
          mto->_u.union_type.member_seq._buffer[n].common.label_seq._length;
        xt->_u.union_type.members.seq[n].label_seq._buffer = ddsrt_memdup(
          mto->_u.union_type.member_seq._buffer[n].common.label_seq._buffer,
          mto->_u.union_type.member_seq._buffer[n].common.label_seq._length *
            sizeof(*mto->_u.union_type.member_seq._buffer[n].common.label_seq._buffer));
        memcpy(
          xt->_u.union_type.members.seq[n].detail.name_hash,
          mto->_u.union_type.member_seq._buffer[n].detail.name_hash,
    ...
    case DDS_XTypes_TK_BITSET:
      ...
      xt->_u.bitset.fields.seq =
        ddsrt_calloc(xt->_u.bitset.fields.length, sizeof(*xt->_u.bitset.fields.seq));
      for (uint32_t n = 0; n < xt->_u.bitset.fields.length; n++) {
        xt->_u.bitset.fields.seq[n].position =
          mto->_u.bitset_type.field_seq._buffer[n].common.position;
        xt->_u.bitset.fields.seq[n].flags = mto->_u.bitset_type.field_seq._buffer[n].common.flags;
        xt->_u.bitset.fields.seq[n].bitcount =
          mto->_u.bitset_type.field_seq._buffer[n].common.bitcount;
        xt->_u.bitset.fields.seq[n].holder_type =
          mto->_u.bitset_type.field_seq._buffer[n].common.holder_type;
        xt->_u.bitset.fields.seq[n].flags = mto->_u.bitset_type.field_seq._buffer[n].common.flags;
        memcpy(
          xt->_u.bitset.fields.seq[n].detail.name_hash,
          mto->_u.bitset_type.field_seq._buffer[n].name_hash,
    ...
    case DDS_XTypes_TK_SEQUENCE:
      ...
      if (
        (ret = ddsi_type_register_dep(
           gv, &xt->id, &xt->_u.seq.c.element_type, &mto->_u.sequence_type.element.common.type)) !=
        DDS_RETCODE_OK)
        goto err_to;
    ...
    case DDS_XTypes_TK_ARRAY:
      ...
      if (
        (ret = ddsi_type_register_dep(
           gv, &xt->id, &xt->_u.array.c.element_type, &mto->_u.array_type.element.common.type)) !=
        DDS_RETCODE_OK)
        goto err_to;
    ...
    case DDS_XTypes_TK_MAP:
      ...
      if (
        (ret = ddsi_type_register_dep(
           gv, &xt->id, &xt->_u.map.c.element_type, &mto->_u.map_type.element.common.type)) !=
        DDS_RETCODE_OK)
        goto err_to;
      xt->_u.map.c.element_flags = mto->_u.map_type.element.common.element_flags;
      if (
        (ret = ddsi_type_register_dep(
           gv, &xt->id, &xt->_u.map.key_type, &mto->_u.map_type.key.common.type)) !=
        DDS_RETCODE_OK) {
    ...
    case DDS_XTypes_TK_ENUM:
      ...
      xt->_u.enum_type.literals.seq =
        ddsrt_calloc(xt->_u.enum_type.literals.length, sizeof(*xt->_u.enum_type.literals.seq));
      for (uint32_t n = 0; n < xt->_u.enum_type.literals.length; n++) {
        xt->_u.enum_type.literals.seq[n].value =
          mto->_u.enumerated_type.literal_seq._buffer[n].common.value;
        xt->_u.enum_type.literals.seq[n].flags =
          mto->_u.enumerated_type.literal_seq._buffer[n].common.flags;
        memcpy(
          xt->_u.enum_type.literals.seq[n].detail.name_hash,
          mto->_u.enumerated_type.literal_seq._buffer[n].detail.name_hash,
    ...
    case DDS_XTypes_TK_BITMASK:
      ...
      xt->_u.bitmask.bitflags.seq =
        ddsrt_calloc(xt->_u.bitmask.bitflags.length, sizeof(*xt->_u.bitmask.bitflags.seq));
      for (uint32_t n = 0; n < xt->_u.bitmask.bitflags.length; n++) {
        xt->_u.bitmask.bitflags.seq[n].position =
          mto->_u.bitmask_type.flag_seq._buffer[n].common.position;
        xt->_u.bitmask.bitflags.seq[n].flags =
          mto->_u.bitmask_type.flag_seq._buffer[n].common.flags;
        memcpy(
          xt->_u.bitmask.bitflags.seq[n].detail.name_hash,
          mto->_u.bitmask_type.flag_seq._buffer[n].detail.name_hash,
...
static dds_return_t add_complete_typeobj(
  struct ddsi_domaingv * gv, struct xt_type * xt, const struct DDS_XTypes_TypeObject * to)
{
  ...
  switch (cto->_d) {
    case DDS_XTypes_TK_ALIAS:
      ...
      if (
        (ret = ddsi_type_register_dep(
           gv, &xt->id, &xt->_u.alias.related_type,
           &cto->_u.alias_type.body.common.related_type)) != DDS_RETCODE_OK)
        goto err_to;
      xt->_u.alias.related_flags = cto->_u.alias_type.body.common.related_flags;
      memcpy(
        &xt->_u.alias.detail.type_name, cto->_u.alias_type.header.detail.type_name,
        sizeof(xt->_u.alias.detail.type_name));
      xt->_u.alias.flags = cto->_u.alias_type.alias_flags;
      xt->_u.alias.related_flags = cto->_u.alias_type.body.common.related_flags;
      break;
    case DDS_XTypes_TK_ANNOTATION:
    ...
    case DDS_XTypes_TK_STRUCTURE:
      ...
      if (cto->_u.struct_type.header.base_type._d) {
        if (
          (ret = ddsi_type_register_dep(
             gv, &xt->id, &xt->_u.structure.base_type, &cto->_u.struct_type.header.base_type)) !=
          DDS_RETCODE_OK)
          goto err_to;
      } else
        xt->_u.structure.base_type = NULL;
      memcpy(
        &xt->_u.structure.detail.type_name, cto->_u.struct_type.header.detail.type_name,
        sizeof(xt->_u.structure.detail.type_name));
      xt->_u.structure.members.length = cto->_u.struct_type.member_seq._length;
      xt->_u.structure.members.seq =
        ddsrt_calloc(xt->_u.structure.members.length, sizeof(*xt->_u.structure.members.seq));
      for (uint32_t n = 0; n < xt->_u.structure.members.length; n++) {
        xt->_u.structure.members.seq[n].id =
          cto->_u.struct_type.member_seq._buffer[n].common.member_id;
        xt->_u.structure.members.seq[n].flags =
          cto->_u.struct_type.member_seq._buffer[n].common.member_flags;
        if (
          (ret = ddsi_type_register_dep(
             gv, &xt->id, &xt->_u.structure.members.seq[n].type,
             &cto->_u.struct_type.member_seq._buffer[n].common.member_type_id)) != DDS_RETCODE_OK) {
          for (uint32_t m = 0; m < n - 1; m++) {
            ddsi_type_unref_locked(gv, xt->_u.structure.members.seq[m].type);
        ...
        set_member_detail(
          &xt->_u.structure.members.seq[n].detail,
          &cto->_u.struct_type.member_seq._buffer[n].detail);
      }
      break;
    case DDS_XTypes_TK_UNION:
      ...
      if (
        (ret = ddsi_type_register_dep(
           gv, &xt->id, &xt->_u.union_type.disc_type,
           &cto->_u.union_type.discriminator.common.type_id)) != DDS_RETCODE_OK)
        goto err_to;
      xt->_u.union_type.disc_flags = cto->_u.union_type.discriminator.common.member_flags;
      memcpy(
        &xt->_u.union_type.detail.type_name, cto->_u.union_type.header.detail.type_name,
        sizeof(xt->_u.union_type.detail.type_name));
      xt->_u.union_type.members.length = cto->_u.union_type.member_seq._length;
      xt->_u.union_type.members.seq =
        ddsrt_calloc(xt->_u.union_type.members.length, sizeof(*xt->_u.union_type.members.seq));
      for (uint32_t n = 0; n < xt->_u.union_type.members.length; n++) {
        xt->_u.union_type.members.seq[n].id =
          cto->_u.union_type.member_seq._buffer[n].common.member_id;
        xt->_u.union_type.members.seq[n].flags =
          cto->_u.union_type.member_seq._buffer[n].common.member_flags;
        if (
          (ret = ddsi_type_register_dep(
             gv, &xt->id, &xt->_u.union_type.members.seq[n].type,
             &cto->_u.union_type.member_seq._buffer[n].common.type_id)) != DDS_RETCODE_OK) {
          for (uint32_t m = 0; m < n - 1; m++) {
            ddsi_type_unref_locked(gv, xt->_u.union_type.members.seq[m].type);
            ddsrt_free(xt->_u.union_type.members.seq[m].label_seq._buffer);
            xt_applied_member_annotations_fini(
              &xt->_u.union_type.members.seq[m].detail.annotations);
          }
          ddsi_type_unref_locked(gv, xt->_u.union_type.disc_type);
          ddsrt_free(xt->_u.union_type.members.seq);
          goto err_to;
        ...
        xt->_u.union_type.members.seq[n].label_seq._length =
          cto->_u.union_type.member_seq._buffer[n].common.label_seq._length;
        xt->_u.union_type.members.seq[n].label_seq._buffer = ddsrt_memdup(
          cto->_u.union_type.member_seq._buffer[n].common.label_seq._buffer,
          cto->_u.union_type.member_seq._buffer[n].common.label_seq._length *
            sizeof(*cto->_u.union_type.member_seq._buffer[n].common.label_seq._buffer));
        set_member_detail(
          &xt->_u.union_type.members.seq[n].detail,
          &cto->_u.union_type.member_seq._buffer[n].detail);
      }
      break;
    case DDS_XTypes_TK_BITSET:
      memcpy(
        &xt->_u.bitset.detail.type_name, cto->_u.bitset_type.header.detail.type_name,
        sizeof(xt->_u.bitset.detail.type_name));
      ...
      for (uint32_t n = 0; n < xt->_u.bitset.fields.length; n++) {
        xt->_u.bitset.fields.seq[n].position =
          cto->_u.bitset_type.field_seq._buffer[n].common.position;
        xt->_u.bitset.fields.seq[n].flags = cto->_u.bitset_type.field_seq._buffer[n].common.flags;
        xt->_u.bitset.fields.seq[n].bitcount =
          cto->_u.bitset_type.field_seq._buffer[n].common.bitcount;
        xt->_u.bitset.fields.seq[n].holder_type =
          cto->_u.bitset_type.field_seq._buffer[n].common.holder_type;
        xt->_u.bitset.fields.seq[n].flags = cto->_u.bitset_type.field_seq._buffer[n].common.flags;
        set_member_detail(
          &xt->_u.bitset.fields.seq[n].detail, &cto->_u.bitset_type.field_seq._buffer[n].detail);
      }
      break;
    case DDS_XTypes_TK_SEQUENCE:
      ...
      if (
        (ret = ddsi_type_register_dep(
           gv, &xt->id, &xt->_u.seq.c.element_type, &cto->_u.sequence_type.element.common.type)) !=
        DDS_RETCODE_OK)
        goto err_to;
    ...
    case DDS_XTypes_TK_ARRAY:
      ...
      if (
        (ret = ddsi_type_register_dep(
           gv, &xt->id, &xt->_u.array.c.element_type, &cto->_u.array_type.element.common.type)) !=
        DDS_RETCODE_OK)
        goto err_to;
    ...
    case DDS_XTypes_TK_MAP:
      ...
      if (
        (ret = ddsi_type_register_dep(
           gv, &xt->id, &xt->_u.map.c.element_type, &cto->_u.map_type.element.common.type)) !=
        DDS_RETCODE_OK)
        goto err_to;
      xt->_u.map.c.element_flags = cto->_u.map_type.element.common.element_flags;
      if (
        (ret = ddsi_type_register_dep(
           gv, &xt->id, &xt->_u.map.key_type, &cto->_u.map_type.key.common.type)) !=
        DDS_RETCODE_OK) {
        ddsi_type_unref_locked(gv, xt->_u.map.c.element_type);
        goto err_to;
      }
    ...
    case DDS_XTypes_TK_ENUM:
      ...
      memcpy(
        &xt->_u.enum_type.detail.type_name, cto->_u.enumerated_type.header.detail.type_name,
        sizeof(xt->_u.enum_type.detail.type_name));
      xt->_u.enum_type.literals.length = cto->_u.enumerated_type.literal_seq._length;
      xt->_u.enum_type.literals.seq =
        ddsrt_calloc(xt->_u.enum_type.literals.length, sizeof(*xt->_u.enum_type.literals.seq));
      for (uint32_t n = 0; n < xt->_u.enum_type.literals.length; n++) {
        xt->_u.enum_type.literals.seq[n].value =
          cto->_u.enumerated_type.literal_seq._buffer[n].common.value;
        xt->_u.enum_type.literals.seq[n].flags =
          cto->_u.enumerated_type.literal_seq._buffer[n].common.flags;
        set_member_detail(
          &xt->_u.enum_type.literals.seq[n].detail,
          &cto->_u.enumerated_type.literal_seq._buffer[n].detail);
      }
      break;
    case DDS_XTypes_TK_BITMASK:
      ...
      memcpy(
        &xt->_u.bitmask.detail.type_name, cto->_u.bitmask_type.header.detail.type_name,
        sizeof(xt->_u.bitmask.detail.type_name));
      xt->_u.bitmask.bitflags.length = cto->_u.bitmask_type.flag_seq._length;
      xt->_u.bitmask.bitflags.seq =
        ddsrt_calloc(xt->_u.bitmask.bitflags.length, sizeof(*xt->_u.bitmask.bitflags.seq));
      for (uint32_t n = 0; n < xt->_u.bitmask.bitflags.length; n++) {
        xt->_u.bitmask.bitflags.seq[n].position =
          cto->_u.bitmask_type.flag_seq._buffer[n].common.position;
        xt->_u.bitmask.bitflags.seq[n].flags =
          cto->_u.bitmask_type.flag_seq._buffer[n].common.flags;
        set_member_detail(
          &xt->_u.bitmask.bitflags.seq[n].detail, &cto->_u.bitmask_type.flag_seq._buffer[n].detail);
      }
      break;
    default:
      ret = DDS_RETCODE_UNSUPPORTED; /* not supported */
...
dds_return_t ddsi_xt_type_add_typeobj(
  struct ddsi_domaingv * gv, struct xt_type * xt, const struct DDS_XTypes_TypeObject * to)
{
  ...
  if (xt->_d != DDS_XTypes_TK_NONE) return DDS_RETCODE_OK;

  if (xt->kind == DDSI_TYPEID_KIND_MINIMAL)
    ret = (to->_d != DDS_XTypes_EK_MINIMAL) ? DDS_RETCODE_BAD_PARAMETER
                                            : add_minimal_typeobj(gv, xt, to);
  else
    ret = (to->_d != DDS_XTypes_EK_COMPLETE) ? DDS_RETCODE_BAD_PARAMETER
  ...
  if (ret != DDS_RETCODE_OK || (ret_validate = ddsi_xt_validate(gv, xt)) != DDS_RETCODE_OK) {
    ...
    GVWARNING(
      "type " PTYPEIDFMT ": ddsi_xt_type_add_typeobj with invalid type object\n",
      PTYPEID(xt->id.x));
  }
...
dds_return_t ddsi_xt_type_init_impl(
  struct ddsi_domaingv * gv, struct xt_type * xt, const struct DDS_XTypes_TypeIdentifier * ti,
  const struct DDS_XTypes_TypeObject * to)
{
  assert(xt);
  assert(ti);
  dds_return_t ret = DDS_RETCODE_OK;
  ...
  if (ti->_d <= DDS_XTypes_TK_STRING16) {
    if (to != NULL) return DDS_RETCODE_BAD_PARAMETER;
    xt->_d = ti->_d;
  } else {
    switch (ti->_d) {
      case DDS_XTypes_TI_STRING8_SMALL:
      ...
      case DDS_XTypes_TI_PLAIN_SEQUENCE_SMALL:
        ...
        if (
          (ret = ddsi_type_register_dep(
             gv, &xt->id, &xt->_u.seq.c.element_type, ti->_u.seq_sdefn.element_identifier)) !=
          DDS_RETCODE_OK)
          goto err;
      ...
      case DDS_XTypes_TI_PLAIN_SEQUENCE_LARGE:
        ...
        if (
          (ret = ddsi_type_register_dep(
             gv, &xt->id, &xt->_u.seq.c.element_type, ti->_u.seq_ldefn.element_identifier)) !=
          DDS_RETCODE_OK)
          goto err;
      ...
      case DDS_XTypes_TI_PLAIN_ARRAY_SMALL:
        ...
        if (
          (ret = ddsi_type_register_dep(
             gv, &xt->id, &xt->_u.array.c.element_type, ti->_u.array_sdefn.element_identifier)) !=
          DDS_RETCODE_OK)
          goto err;
      ...
      case DDS_XTypes_TI_PLAIN_ARRAY_LARGE:
        ...
        if (
          (ret = ddsi_type_register_dep(
             gv, &xt->id, &xt->_u.array.c.element_type, ti->_u.array_ldefn.element_identifier)) !=
          DDS_RETCODE_OK)
          goto err;
      ...
      case DDS_XTypes_TI_PLAIN_MAP_SMALL:
        ...
        if (
          (ret = ddsi_type_register_dep(
             gv, &xt->id, &xt->_u.map.c.element_type, ti->_u.map_sdefn.element_identifier)) !=
          DDS_RETCODE_OK)
          goto err;
        ...
        if (
          (ret = ddsi_type_register_dep(
             gv, &xt->id, &xt->_u.map.key_type, ti->_u.map_sdefn.key_identifier)) !=
          DDS_RETCODE_OK) {
          ddsi_type_unref_locked(gv, xt->_u.map.c.element_type);
      ...
      case DDS_XTypes_TI_PLAIN_MAP_LARGE:
        ...
        if (
          (ret = ddsi_type_register_dep(
             gv, &xt->id, &xt->_u.map.c.element_type, ti->_u.map_ldefn.element_identifier)) !=
          DDS_RETCODE_OK)
          goto err;
        ...
        if (
          (ret = ddsi_type_register_dep(
             gv, &xt->id, &xt->_u.map.key_type, ti->_u.map_ldefn.key_identifier)) !=
          DDS_RETCODE_OK) {
          ddsi_type_unref_locked(gv, xt->_u.map.c.element_type);
          xt->_u.map.c.element_type = NULL;
          goto err;
        ...
        break;
      case DDS_XTypes_EK_MINIMAL:
        if (to != NULL) ret = add_minimal_typeobj(gv, xt, to);
        break;
      case DDS_XTypes_EK_COMPLETE:
        if (to != NULL) ret = add_complete_typeobj(gv, xt, to);
        break;
      case DDS_XTypes_TI_STRONGLY_CONNECTED_COMPONENT:
  ...
  if (ret != DDS_RETCODE_OK || (ret = ddsi_xt_validate(gv, xt)) != DDS_RETCODE_OK) {
    GVWARNING(
      "type " PTYPEIDFMT ": ddsi_xt_type_init_impl with invalid type object\n", PTYPEID(xt->id.x));
    goto err;
  }
...
dds_return_t ddsi_xt_type_init(
  struct ddsi_domaingv * gv, struct xt_type * xt, const ddsi_typeid_t * ti,
  const ddsi_typeobj_t * to)
{
  return ddsi_xt_type_init_impl(gv, xt, &ti->x, &to->x);
}

static void DDS_XTypes_AppliedVerbatimAnnotation_copy(
  struct DDS_XTypes_AppliedVerbatimAnnotation * dst,
  const struct DDS_XTypes_AppliedVerbatimAnnotation * src)
{
  assert(dst);
  if (src) {
...
static void DDS_XTypes_AppliedBuiltinTypeAnnotations_copy(
  struct DDS_XTypes_AppliedBuiltinTypeAnnotations * dst,
  const struct DDS_XTypes_AppliedBuiltinTypeAnnotations * src)
{
  if (src) {
...
static void DDS_XTypes_AppliedAnnotationParameter_copy(
  struct DDS_XTypes_AppliedAnnotationParameter * dst,
  const struct DDS_XTypes_AppliedAnnotationParameter * src)
{
  if (src) {
...
static void DDS_XTypes_AppliedAnnotationParameterSeq_copy(
  struct DDS_XTypes_AppliedAnnotationParameterSeq ** dst,
  const struct DDS_XTypes_AppliedAnnotationParameterSeq * src)
{
  if (src) {
...
static void DDS_XTypes_AppliedAnnotation_copy(
  struct DDS_XTypes_AppliedAnnotation * dst, const struct DDS_XTypes_AppliedAnnotation * src)
{
  if (src) {
...
static void get_member_detail(
  DDS_XTypes_CompleteMemberDetail * dst, const struct xt_member_detail * src)
{
  ddsrt_strlcpy(dst->name, src->name, sizeof(dst->name));
  if (src->annotations.ann_builtin) {
...
static void get_minimal_member_detail(
  DDS_XTypes_MinimalMemberDetail * dst, const struct xt_member_detail * src)
{
...
void ddsi_xt_type_fini(struct ddsi_domaingv * gv, struct xt_type * xt, bool include_typeid)
{
  ...
  xt->_d = DDS_XTypes_TK_NONE;
  if (include_typeid) ddsi_typeid_fini(&xt->id);
}

static void xt_applied_type_annotations_copy(
  struct xt_applied_type_annotations * dst, const struct xt_applied_type_annotations * src)
{
  if (src->ann_builtin) {
...
static void xt_applied_member_annotations_copy(
  struct xt_applied_member_annotations * dst, const struct xt_applied_member_annotations * src)
{
  if (src->ann_builtin) {
...
static void xt_annotation_parameter_copy(
  struct ddsi_domaingv * gv, struct xt_annotation_parameter * dst,
  const struct xt_annotation_parameter * src)
{
  if (src) {
...
static void xt_annotation_parameter_seq_copy(
  struct ddsi_domaingv * gv, struct xt_annotation_parameter_seq * dst,
  const struct xt_annotation_parameter_seq * src)
{
  if (src) {
...
static void xt_collection_common_copy(
  struct ddsi_domaingv * gv, struct xt_collection_common * dst,
  const struct xt_collection_common * src)
{
  if (src) {
    dst->flags = src->flags;
    dst->ek = src->ek;
...
static void DDS_XTypes_LBoundSeq_copy(
  struct DDS_XTypes_LBoundSeq * dst, const struct DDS_XTypes_LBoundSeq * src)
{
  if (src) {
    dst->_maximum = src->_maximum;
    dst->_length = src->_length;
    dst->_buffer = ddsrt_calloc(src->_length, sizeof(*dst->_buffer));
    for (uint32_t n = 0; n < src->_length; n++) dst->_buffer[n] = src->_buffer[n];
    dst->_release = src->_release;
  }
}

static void xt_member_detail_copy(
  struct xt_member_detail * dst, const struct xt_member_detail * src)
{
  if (src) {
    ddsrt_strlcpy(dst->name, src->name, sizeof(dst->name));
    memcpy(dst->name_hash, src->name_hash, sizeof(dst->name_hash));
...
static void xt_struct_member_copy(
  struct ddsi_domaingv * gv, struct xt_struct_member * dst, const struct xt_struct_member * src)
{
  if (src) {
    dst->id = src->id;
    dst->flags = src->flags;
...
static void xt_struct_member_seq_copy(
  struct ddsi_domaingv * gv, struct xt_struct_member_seq * dst,
  const struct xt_struct_member_seq * src)
{
  if (src) {
    dst->length = src->length;
    dst->seq = ddsrt_calloc(src->length, sizeof(*dst->seq));
...
static void DDS_XTypes_UnionCaseLabelSeq_copy(
  struct DDS_XTypes_UnionCaseLabelSeq * dst, const struct DDS_XTypes_UnionCaseLabelSeq * src)
{
  if (src) {
    dst->_maximum = src->_maximum;
    dst->_length = src->_length;
...
static void xt_union_member_copy(
  struct ddsi_domaingv * gv, struct xt_union_member * dst, const struct xt_union_member * src)
{
  if (src) {
    dst->id = src->id;
    dst->flags = src->flags;
...
static void xt_union_member_seq_copy(
  struct ddsi_domaingv * gv, struct xt_union_member_seq * dst,
  const struct xt_union_member_seq * src)
{
  if (src) {
    dst->length = src->length;
    dst->seq = ddsrt_calloc(src->length, sizeof(*dst->seq));
    for (uint32_t n = 0; n < src->length; n++) xt_union_member_copy(gv, &dst->seq[n], &src->seq[n]);
  }
}
...
static void xt_bitfield_seq_copy(struct xt_bitfield_seq * dst, const struct xt_bitfield_seq * src)
{
  if (src) {
    dst->length = src->length;
    dst->seq = ddsrt_calloc(src->length, sizeof(*dst->seq));
    for (uint32_t n = 0; n < src->length; n++) xt_bitfield_copy(&dst->seq[n], &src->seq[n]);
  }
}

static void xt_enum_literal_seq_copy(
  struct xt_enum_literal_seq * dst, const struct xt_enum_literal_seq * src)
{
  if (src) {
    dst->length = src->length;
    dst->seq = ddsrt_calloc(src->length, sizeof(*dst->seq));
    for (uint32_t n = 0; n < src->length; n++) dst->seq[n] = src->seq[n];
  }
}
...
static void xt_bitflag_seq_copy(struct xt_bitflag_seq * dst, const struct xt_bitflag_seq * src)
{
  if (src) {
    dst->length = src->length;
    dst->seq = ddsrt_calloc(src->length, sizeof(*dst->seq));
    for (uint32_t n = 0; n < src->length; n++) xt_bitflag_copy(&dst->seq[n], &src->seq[n]);
  }
}
...
static struct xt_type * xt_dup(struct ddsi_domaingv * gv, const struct xt_type * src)
{
  ...
  switch (src->_d) {
    ...
    case DDS_XTypes_TK_MAP:
      ...
      xt_applied_member_annotations_copy(
        &dst->_u.map.key_annotations, &src->_u.map.key_annotations);
      break;
    case DDS_XTypes_TK_ALIAS:
    ...
    case DDS_XTypes_TK_ANNOTATION:
      ddsrt_strlcpy(
        dst->_u.annotation.annotation_name, src->_u.annotation.annotation_name,
        sizeof(dst->_u.annotation.annotation_name));
    ...
    case DDS_XTypes_TK_UNION:
      ...
      xt_applied_type_annotations_copy(
        &dst->_u.union_type.disc_annotations, &src->_u.union_type.disc_annotations);
...
static struct xt_type * xt_expand_basetype(struct ddsi_domaingv * gv, const struct xt_type * t)
{
  ...
  if (ddsi_xt_is_unresolved(b)) {
    ...
    GVWARNING(
      "assignability check: base type %s unresolved in xt_expand_basetype\n",
  ...
  switch (t->_d) {
    case DDS_XTypes_TK_STRUCTURE: {
      ...
      for (uint32_t i = 0; i < tke->_u.structure.members.length; i++) {
        ...
        if (m->flags & DDS_XTypes_IS_KEY) m->flags &= (DDS_XTypes_MemberFlag)~DDS_XTypes_IS_KEY;
      }
      return tke;
    }
    case DDS_XTypes_TK_UNION: {
...
static bool xt_struct_has_key(const struct xt_type * t)
{
  ...
  for (uint32_t i = 0; i < t->_u.structure.members.length; i++)
    if (t->_u.structure.members.seq[i].flags & DDS_XTypes_IS_KEY) return true;
  return false;
}
    ...
    case DDS_XTypes_TK_STRUCTURE: {
      if (xt_struct_has_key(tkh)) {
        ...
        while (i < l) {
          ...
          if (i < l - 1)
            memmove(
              &tkh->_u.structure.members.seq[i], &tkh->_u.structure.members.seq[i + 1],
              (l - i - 1) * sizeof(*tkh->_u.structure.members.seq));
          l--;
        }
...
{
  DDS_XTypes_CollectionElementFlag plain_flags =
    DDS_XTypes_TRY_CONSTRUCT1 | DDS_XTypes_TRY_CONSTRUCT2 | DDS_XTypes_IS_EXTERNAL;
  return (
    (t->_d == DDS_XTypes_TK_SEQUENCE && !(t->_u.seq.c.element_flags & ~plain_flags)) ||
...
static bool xt_is_plain_collection_equiv_kind(
  const struct xt_type * t, DDS_XTypes_EquivalenceKind ek)
{
  if (!xt_is_plain_collection(t)) return false;
  switch (t->_d) {
    case DDS_XTypes_TK_SEQUENCE:
...
static bool xt_is_equiv_kind_hash_typeid(const struct xt_type * t, DDS_XTypes_EquivalenceKind ek)
{
  return (ek == DDS_XTypes_EK_MINIMAL && t->kind == DDSI_TYPEID_KIND_MINIMAL) ||
         ...
         (t->_d == DDS_XTypes_TI_STRONGLY_CONNECTED_COMPONENT &&
          t->sc_component_id.sc_component_id._d == ek) ||
...
{
  return xt_is_primitive(t) || xt_is_string(t) ||
         (t->_d != DDS_XTypes_TI_STRONGLY_CONNECTED_COMPONENT &&
          xt_is_plain_collection_fully_descriptive_typeid(t));
}
...
static uint32_t xt_get_extensibility(const struct xt_type * t)
{
  ...
  assert(
    ext_flags == DDS_XTypes_IS_FINAL || ext_flags == DDS_XTypes_IS_APPENDABLE ||
    ext_flags == DDS_XTypes_IS_MUTABLE);
  return ext_flags;
}

static bool xt_is_delimited(struct ddsi_domaingv * gv, const struct xt_type * t)
{
  if (xt_is_primitive(t) || xt_is_string(t) || xt_is_enumerated(t)) return true;
  switch (t->_d) {
    case DDS_XTypes_TK_SEQUENCE:
    ...
    case DDS_XTypes_TK_MAP:
      return xt_is_delimited(gv, ddsi_xt_unalias(&t->_u.map.key_type->xt)) &&
             xt_is_delimited(gv, ddsi_xt_unalias(&t->_u.map.c.element_type->xt));
  }
...
static bool xt_is_equivalent_minimal(const struct xt_type * t1, const struct xt_type * t2)
{
  ...
  if (xt_is_fully_descriptive(t1) || xt_is_minimal_hash_typeid(t1)) {
    if (!ddsi_typeid_compare(&t1->id, &t2->id)) return true;
  }
  return false;
}

static bool xt_is_strongly_assignable_from(
  struct ddsi_domaingv * gv, const struct xt_type * t1a, const struct xt_type * t2a,
  const dds_type_consistency_enforcement_qospolicy_t * tce)
{
  const struct xt_type *t1 = ddsi_xt_unalias(t1a), *t2 = ddsi_xt_unalias(t2a);
  if (xt_is_equivalent_minimal(t1, t2)) return true;
  return xt_is_delimited(gv, t2) && ddsi_xt_is_assignable_from(gv, t1, t2, tce);
}

static bool xt_bounds_eq(
  const struct DDS_XTypes_LBoundSeq * a, const struct DDS_XTypes_LBoundSeq * b)
{
  if (!a || !b) return false;
  if (a->_length != b->_length) return false;
...
static bool xt_union_label_selects(
  const struct DDS_XTypes_UnionCaseLabelSeq * ls1, const struct DDS_XTypes_UnionCaseLabelSeq * ls2)
{
...
static bool xt_union_labels_match(
  const struct DDS_XTypes_UnionCaseLabelSeq * ls1, const struct DDS_XTypes_UnionCaseLabelSeq * ls2)
{
  /* UnionCaseLabelSeq is ordered by value (as noted in typeobject idl) */
  for (uint32_t i = 0; i < ls1->_length; i++)
    if (i >= ls2->_length || ls1->_buffer[i] != ls2->_buffer[i]) return false;
  return true;
}
...
static bool xt_is_assignable_from_enum(const struct xt_type * t1, const struct xt_type * t2)
{
  ...
  if (xt_get_extensibility(t1) != xt_get_extensibility(t2)) return false;
  /* Members are ordered by increasing value (XTypes 1.3 spec 7.3.4.5) */
  uint32_t i1 = 0, i2 = 0, i1_max = t1->_u.enum_type.literals.length,
           i2_max = t2->_u.enum_type.literals.length;
  while (i1 < i1_max && i2 < i2_max) {
    struct xt_enum_literal *l1 = &t1->_u.enum_type.literals.seq[i1],
                           *l2 = &t2->_u.enum_type.literals.seq[i2];
    if (l1->value == l2->value) {
      /* FIXME: implement @ignore_literal_names */
      if (!xt_namehash_eq(&l1->detail.name_hash, &l2->detail.name_hash)) return false;
      i1++;
      i2++;
...
static bool xt_is_assignable_from_union(
  struct ddsi_domaingv * gv, const struct xt_type * t1, const struct xt_type * t2,
  const dds_type_consistency_enforcement_qospolicy_t * tce)
{
  assert(t1->_d == DDS_XTypes_TK_UNION);
  assert(t2->_d == DDS_XTypes_TK_UNION);
  if (xt_get_extensibility(t1) != xt_get_extensibility(t2)) return false;
  if (!xt_is_strongly_assignable_from(
        gv, ddsi_xt_unalias(&t1->_u.union_type.disc_type->xt),
        ddsi_xt_unalias(&t2->_u.union_type.disc_type->xt), tce))
    return false;

  /* Rule: Either the discriminators of both T1 and T2 are keys or neither are keys. */
  if (
    (t1->_u.union_type.disc_flags & DDS_XTypes_IS_KEY) !=
    (t2->_u.union_type.disc_flags & DDS_XTypes_IS_KEY))
    return false;
  ...
  for (uint32_t i1 = 0; i1 < i1_max; i1++) {
    ...
    for (uint32_t i2 = i1; i2 < i2_max + i1; i2++) {
      ...
      if (m1->id == m2->id) {
        ...
        if (
          !xt_namehash_eq(&m1->detail.name_hash, &m2->detail.name_hash) &&
          (!tce || !tce->ignore_member_names))
          return false;
      }
      ...
      if ((m1->flags & DDS_XTypes_IS_DEFAULT) && (m2->flags & DDS_XTypes_IS_DEFAULT)) {
        if (!ddsi_xt_is_assignable_from(gv, m1t, m2t, tce)) return false;
      }

      if (m1->id == m2->id && !xt_union_labels_match(&m1->label_seq, &m2->label_seq))
        m2_labels_match = false;
      if (xt_union_label_selects(&m1->label_seq, &m2->label_seq)) t1_selects_t2_member = true;
      if (m2->flags & DDS_XTypes_IS_DEFAULT) def_m2 = m2;
    } /* loop T2 members */
    ...
    if (
      (xt_get_extensibility(t1) == DDS_XTypes_IS_FINAL || (tce && tce->prevent_type_widening)) &&
      (!m2_id_match || !m2_labels_match))
      return false;
    if (t1_selects_t2_member) any_match = true;
  } /* loop T1 members */
  ...
  for (uint32_t i2 = 0; i2 < i2_max; i2++) {
    ...
    if (m2->flags & DDS_XTypes_IS_DEFAULT) continue;
    ...
    for (uint32_t i1 = i2; i1 < i1_max + i2; i1++) {
      ...
      if (xt_union_label_selects(&m2->label_seq, &m1->label_seq)) sel_m1 = m1;
      if (m1->flags & DDS_XTypes_IS_DEFAULT) def_m1 = m1;
    }
    if (
      (sel_m1 || def_m1) && !ddsi_xt_is_assignable_from(
                              gv, ddsi_xt_unalias(sel_m1 ? &sel_m1->type->xt : &def_m1->type->xt),
                              ddsi_xt_unalias(&m2->type->xt), tce))
      return false;
    if (!sel_m1 && tce && tce->prevent_type_widening) return false;
  }
...
static bool xt_is_assignable_from_struct(
  struct ddsi_domaingv * gv, const struct xt_type * t1, const struct xt_type * t2,
  const dds_type_consistency_enforcement_qospolicy_t * tce)
{
  ...
  if (xt_get_extensibility(t1) != xt_get_extensibility(t2)) goto struct_failed;
  if (xt_has_basetype(t1))
    if ((te1 = xt_expand_basetype(gv, t1)) == NULL) goto struct_failed;
  if (xt_has_basetype(t2))
    if ((te2 = xt_expand_basetype(gv, t2)) == NULL) goto struct_failed;
  ...
  for (uint32_t i1 = 0; i1 < i1_max; i1++) {
    ...
    if (ddsi_xt_is_unresolved(m1t)) {
      struct ddsi_typeid_str tidstr;
      GVWARNING(
        "assignability check: member %" PRIu32
        " type %s unresolved in xt_is_assignable_from_struct\n",
        m1->id, ddsi_make_typeid_str(&tidstr, &m1t->id));
      goto struct_failed;
    }

    bool match = false, m1_opt = (m1->flags & DDS_XTypes_IS_OPTIONAL),
    ...
    for (uint32_t i2 = i1; i2 < i2_max + i1; i2++) {
      ...
      if (m1->id == m2->id) {
        ...
        struct xt_type *m1_ke = xt_type_key_erased(gv, m1t), *m2_ke = xt_type_key_erased(gv, m2t);
        ...
        if (!ke_assignable) goto struct_failed;
        ...
        if (
          m2_k && xt_is_string(m2t) && !xt_check_bound(xt_string_bound(m1t), xt_string_bound(m2t)))
          goto struct_failed;
        ...
        if (m2_k && xt_is_enumerated(m2t)) {
          uint32_t ki1 = 0, ki2 = 0, ki1_max = m1t->_u.enum_type.literals.length,
                   ki2_max = m2t->_u.enum_type.literals.length;
        ...
        if (
          m2_k && m2t->_d == DDS_XTypes_TK_SEQUENCE &&
          !xt_check_bound(m1t->_u.seq.bound, m2t->_u.seq.bound))
          goto struct_failed;
        if (
          m2_k && m2t->_d == DDS_XTypes_TK_MAP &&
          !xt_check_bound(m1t->_u.map.bound, m2t->_u.map.bound))
          goto struct_failed;
        ...
        if (m2_k && (m2t->_d == DDS_XTypes_TK_STRUCTURE || m2t->_d == DDS_XTypes_TK_UNION)) {
          struct xt_type *m1_kh = xt_type_keyholder(gv, m1t), *m2_kh = xt_type_keyholder(gv, m2t);
          ...
          ddsrt_free(m2_kh);
          if (!kh_assignable) goto struct_failed;
        }
        ...
        if (m2_k && m2t->_d == DDS_XTypes_TK_UNION) {
          uint32_t ki1_max = m1t->_u.union_type.members.length,
                   ki2_max = m2t->_u.union_type.members.length;
            ...
            for (uint32_t ki2 = ki1; ki2 < ki2_max + ki1; ki2++) {
              ...
              if (xt_union_label_selects(&km1->label_seq, &km2->label_seq)) {
                ...
                if (ddsi_xt_is_unresolved(km1_t) || ddsi_xt_is_unresolved(km2_t)) {
                  struct ddsi_typeid_str tidstr;
                  GVWARNING(
                    "assignability check: union member %" PRIu32
                    " type %s unresolved in xt_is_assignable_from_struct\n",
                    (ddsi_xt_is_unresolved(km1_t) ? km1 : km2)->id,
                    ddsi_make_typeid_str(
                      &tidstr, &(ddsi_xt_is_unresolved(km1_t) ? km1_t : km2_t)->id));
                  goto struct_failed;
                }
    ...
    if (!m1_opt && m1_mu && !match) goto struct_failed;
    /* Rule (for T1 members): "Members marked as key in either T1 or T2 appear (i.e., have a corresponding member of the same member ID)
        in both T1 and T2." */
    if (m1_k && !match) goto struct_failed;
    /* Rules:
    ...
    if (
      (xt_get_extensibility(te1) == DDS_XTypes_IS_APPENDABLE && i1 < i2_max) ||
      xt_get_extensibility(te1) == DDS_XTypes_IS_FINAL) {
      if (i1 >= i2_max) goto struct_failed;
      if (
        m1->id != m2->id ||
        (m1->flags & DDS_XTypes_IS_OPTIONAL) != (m2->flags & DDS_XTypes_IS_OPTIONAL) ||
        !xt_is_strongly_assignable_from(gv, m1t, ddsi_xt_unalias(&m2->type->xt), tce))
        goto struct_failed;
    }
  ...
  for (uint32_t i2 = 0; i2 < i2_max; i2++) {
    ...
    bool match = false;
    if (
      (!(m2->flags & DDS_XTypes_IS_OPTIONAL) && (m2->flags & DDS_XTypes_IS_MUST_UNDERSTAND)) ||
      (m2->flags & DDS_XTypes_IS_KEY) || xt_get_extensibility(te1) == DDS_XTypes_IS_FINAL ||
      (tce && tce->prevent_type_widening && !(m2->flags & DDS_XTypes_IS_OPTIONAL))) {
      for (uint32_t i1 = i2; !match && i1 < i1_max + i2; i1++)
        match = (te1->_u.structure.members.seq[i1 % i1_max].id == m2->id);
      if (!match) goto struct_failed;
    }
  }
  /* Rule: There is at least one member m1 of T1 and one corresponding member m2 of T2 such that m1.id == m2.id */
  if (!any_member_match) goto struct_failed;
  result = true;
...
bool ddsi_xt_is_assignable_from(
  struct ddsi_domaingv * gv, const struct xt_type * rd_xt, const struct xt_type * wr_xt,
  const dds_type_consistency_enforcement_qospolicy_t * tce)
{
  ...
  if (ddsi_xt_is_unresolved(t1) || ddsi_xt_is_unresolved(t2)) {
    struct ddsi_typeid_str tidstr;
    GVWARNING(
      "assignability check: unresolved type %s in ddsi_xt_is_assignable_from\n",
  ...
  if ((t1->_d == DDS_XTypes_TK_STRING8 && t2->_d == DDS_XTypes_TK_STRING8))
    return !tce || tce->ignore_string_bounds ||
           xt_check_bound(t1->_u.str8.bound, t2->_u.str8.bound);
  if ((t1->_d == DDS_XTypes_TK_STRING16 && t2->_d == DDS_XTypes_TK_STRING16))
    return !tce || tce->ignore_string_bounds ||
           xt_check_bound(t1->_u.str16.bound, t2->_u.str16.bound);

  /* Collection types */
  if (t1->_d == DDS_XTypes_TK_ARRAY && t2->_d == DDS_XTypes_TK_ARRAY)
    return xt_bounds_eq(&t1->_u.array.bounds, &t2->_u.array.bounds) &&
           xt_is_strongly_assignable_from(
             gv, &t1->_u.array.c.element_type->xt, &t2->_u.array.c.element_type->xt, tce);
  if (t1->_d == DDS_XTypes_TK_SEQUENCE && t2->_d == DDS_XTypes_TK_SEQUENCE)
    return (!tce || tce->ignore_sequence_bounds ||
            xt_check_bound(t1->_u.seq.bound, t2->_u.seq.bound)) &&
           xt_is_strongly_assignable_from(
             gv, &t1->_u.seq.c.element_type->xt, &t2->_u.seq.c.element_type->xt, tce);
  if (t1->_d == DDS_XTypes_TK_MAP && t2->_d == DDS_XTypes_TK_MAP)
    return xt_is_strongly_assignable_from(
             gv, &t1->_u.map.key_type->xt, &t2->_u.map.key_type->xt, tce) &&
           xt_is_strongly_assignable_from(
             gv, &t1->_u.map.c.element_type->xt, &t2->_u.map.c.element_type->xt, tce);
...
static ddsi_typeid_kind_t ddsi_typeid_kind_impl(const struct DDS_XTypes_TypeIdentifier * type_id)
{
  ...
  if (ddsi_typeid_is_hash_impl(type_id))
    kind =
      ddsi_typeid_is_minimal_impl(type_id) ? DDSI_TYPEID_KIND_MINIMAL : DDSI_TYPEID_KIND_COMPLETE;
  else {
    if (type_id->_d < DDS_XTypes_TI_PLAIN_SEQUENCE_SMALL)
      ...
      switch (type_id->_d) {
        ...
        case DDS_XTypes_TI_PLAIN_MAP_SMALL:
          if (
            (element_kind = ddsi_typeid_kind_impl(type_id->_u.map_sdefn.key_identifier)) ==
...
static void get_plain_collection_element_id(
  const struct xt_type * xt_el, struct DDS_XTypes_TypeIdentifier * ti,
  DDS_XTypes_EquivalenceKind * equiv_kind, ddsi_typeid_kind_t kind)
{
...
static void ddsi_xt_get_non_hash_id(
  const struct xt_type * xt, struct DDS_XTypes_TypeIdentifier * ti, ddsi_typeid_kind_t kind)
{
  assert(xt);
  assert(ti);
    ...
    switch (xt->_d) {
      ...
      case DDS_XTypes_TK_SEQUENCE:
        if (xt->_u.seq.bound <= 255) {
          ...
          ti->_u.seq_sdefn.element_identifier =
            ddsrt_malloc(sizeof(*ti->_u.seq_sdefn.element_identifier));
          get_plain_collection_element_id(
            &xt->_u.seq.c.element_type->xt, ti->_u.seq_sdefn.element_identifier,
          ...
          ti->_u.seq_ldefn.element_identifier =
            ddsrt_malloc(sizeof(*ti->_u.seq_ldefn.element_identifier));
          get_plain_collection_element_id(
            &xt->_u.seq.c.element_type->xt, ti->_u.seq_ldefn.element_identifier,
      ...
      case DDS_XTypes_TK_ARRAY: {
        ...
        if (sdefn) {
          ...
          ti->_u.array_sdefn.element_identifier =
            ddsrt_malloc(sizeof(*ti->_u.array_sdefn.element_identifier));
          get_plain_collection_element_id(
            &xt->_u.array.c.element_type->xt, ti->_u.array_sdefn.element_identifier,
          ...
          ti->_u.array_ldefn.element_identifier =
            ddsrt_malloc(sizeof(*ti->_u.array_ldefn.element_identifier));
          get_plain_collection_element_id(
            &xt->_u.array.c.element_type->xt, ti->_u.array_ldefn.element_identifier,
      ...
      case DDS_XTypes_TK_MAP: {
        ...
        if (xt->_u.map.bound <= 255) {
          ...
          get_plain_collection_element_id(
            &xt->_u.map.key_type->xt, ti->_u.map_sdefn.key_identifier,
            &ti->_u.map_sdefn.header.equiv_kind, kind);
          ti->_u.map_sdefn.element_identifier =
            ddsrt_malloc(sizeof(*ti->_u.map_sdefn.element_identifier));
          get_plain_collection_element_id(
            &xt->_u.map.c.element_type->xt, ti->_u.map_sdefn.element_identifier, &equiv_kind, kind);
          if (
            ti->_u.map_sdefn.header.equiv_kind == DDS_XTypes_EK_BOTH &&
            equiv_kind != DDS_XTypes_EK_BOTH)
          ...
          get_plain_collection_element_id(
            &xt->_u.map.key_type->xt, ti->_u.map_ldefn.key_identifier,
            &ti->_u.map_ldefn.header.equiv_kind, kind);
          ti->_u.map_ldefn.element_identifier =
            ddsrt_malloc(sizeof(*ti->_u.map_ldefn.element_identifier));
          get_plain_collection_element_id(
            &xt->_u.map.c.element_type->xt, ti->_u.map_ldefn.element_identifier, &equiv_kind, kind);
          if (
            ti->_u.map_ldefn.header.equiv_kind == DDS_XTypes_EK_BOTH &&
            equiv_kind != DDS_XTypes_EK_BOTH)
...
void ddsi_xt_get_typeobject_kind_impl(
  const struct xt_type * xt, struct DDS_XTypes_TypeObject * to, ddsi_typeid_kind_t kind)
{
  assert(xt);
  assert(to);
  ...
  if (kind == DDSI_TYPEID_KIND_MINIMAL) {
    ...
    switch (xt->_d) {
      case DDS_XTypes_TK_ALIAS: {
        ...
        ddsi_xt_get_typeid_impl(
          &xt->_u.alias.related_type->xt, &malias->body.common.related_type,
      ...
      case DDS_XTypes_TK_STRUCTURE: {
        ...
        if (xt->_u.structure.base_type)
          ddsi_xt_get_typeid_impl(
            &xt->_u.structure.base_type->xt, &mstruct->header.base_type, DDSI_TYPEID_KIND_MINIMAL);
        mstruct->member_seq._buffer =
          ddsrt_malloc(xt->_u.structure.members.length * sizeof(*mstruct->member_seq._buffer));
        ...
        for (uint32_t n = 0; n < xt->_u.structure.members.length; n++) {
          ...
          mstruct->member_seq._buffer[n].common.member_flags =
            xt->_u.structure.members.seq[n].flags;
          ddsi_xt_get_typeid_impl(
            &xt->_u.structure.members.seq[n].type->xt,
            &mstruct->member_seq._buffer[n].common.member_type_id, DDSI_TYPEID_KIND_MINIMAL);
          get_minimal_member_detail(
            &mstruct->member_seq._buffer[n].detail, &xt->_u.structure.members.seq[n].detail);
        }
        break;
      }
      case DDS_XTypes_TK_UNION: {
        ...
        ddsi_xt_get_typeid_impl(
          &xt->_u.union_type.disc_type->xt, &munion->discriminator.common.type_id,
          DDSI_TYPEID_KIND_MINIMAL);
        munion->discriminator.common.member_flags = xt->_u.union_type.disc_flags;
        munion->member_seq._buffer =
          ddsrt_malloc(xt->_u.union_type.members.length * sizeof(*munion->member_seq._buffer));
        ...
        for (uint32_t n = 0; n < xt->_u.union_type.members.length; n++) {
          ...
          munion->member_seq._buffer[n].common.member_flags =
            xt->_u.union_type.members.seq[n].flags;
          ddsi_xt_get_typeid_impl(
            &xt->_u.union_type.members.seq[n].type->xt,
            &munion->member_seq._buffer[n].common.type_id, DDSI_TYPEID_KIND_MINIMAL);
          munion->member_seq._buffer[n].common.label_seq._length =
            xt->_u.union_type.members.seq[n].label_seq._length;
          munion->member_seq._buffer[n].common.label_seq._buffer = ddsrt_memdup(
            xt->_u.union_type.members.seq[n].label_seq._buffer,
            xt->_u.union_type.members.seq[n].label_seq._length *
              sizeof(*xt->_u.union_type.members.seq[n].label_seq._buffer));
          munion->member_seq._buffer[n].common.label_seq._release = true;
          get_minimal_member_detail(
            &munion->member_seq._buffer[n].detail, &xt->_u.union_type.members.seq[n].detail);
        }
        break;
      }
      case DDS_XTypes_TK_BITSET: {
        ...
        mbitset->field_seq._buffer =
          ddsrt_malloc(xt->_u.bitset.fields.length * sizeof(*mbitset->field_seq._buffer));
        ...
        for (uint32_t n = 0; n < xt->_u.bitset.fields.length; n++) {
          ...
          mbitset->field_seq._buffer[n].common.holder_type =
            xt->_u.bitset.fields.seq[n].holder_type;
          memcpy(
            mbitset->field_seq._buffer[n].name_hash, xt->_u.bitset.fields.seq[n].detail.name_hash,
            sizeof(mbitset->field_seq._buffer[n].name_hash));
        }
        break;
      }
      case DDS_XTypes_TK_SEQUENCE:
        ddsi_xt_get_typeid_impl(
          &xt->_u.seq.c.element_type->xt, &mto->_u.sequence_type.element.common.type,
          DDSI_TYPEID_KIND_MINIMAL);
      ...
      case DDS_XTypes_TK_ARRAY:
        ddsi_xt_get_typeid_impl(
          &xt->_u.array.c.element_type->xt, &mto->_u.array_type.element.common.type,
          DDSI_TYPEID_KIND_MINIMAL);
      ...
      case DDS_XTypes_TK_MAP:
        ddsi_xt_get_typeid_impl(
          &xt->_u.map.c.element_type->xt, &mto->_u.map_type.element.common.type,
          DDSI_TYPEID_KIND_MINIMAL);
        mto->_u.array_type.element.common.element_flags = xt->_u.map.c.element_flags;
        ddsi_xt_get_typeid_impl(
          &xt->_u.map.key_type->xt, &mto->_u.map_type.key.common.type, DDSI_TYPEID_KIND_MINIMAL);
      ...
      case DDS_XTypes_TK_ENUM: {
        ...
        menum->literal_seq._buffer =
          ddsrt_malloc(xt->_u.enum_type.literals.length * sizeof(*menum->literal_seq._buffer));
        ...
        for (uint32_t n = 0; n < xt->_u.enum_type.literals.length; n++) {
          ...
          get_minimal_member_detail(
            &menum->literal_seq._buffer[n].detail, &xt->_u.enum_type.literals.seq[n].detail);
        }
        break;
      }
      case DDS_XTypes_TK_BITMASK: {
        ...
        mbitmask->flag_seq._buffer =
          ddsrt_malloc(xt->_u.bitmask.bitflags.length * sizeof(*mbitmask->flag_seq._buffer));
        ...
        for (uint32_t n = 0; n < xt->_u.bitmask.bitflags.length; n++) {
          ...
          get_minimal_member_detail(
            &mbitmask->flag_seq._buffer[n].detail, &xt->_u.bitmask.bitflags.seq[n].detail);
        }
        break;
      }
      default:
    ...
    switch (xt->_d) {
      case DDS_XTypes_TK_ALIAS: {
        ...
        ddsi_xt_get_typeid_impl(
          &xt->_u.alias.related_type->xt, &calias->body.common.related_type,
      ...
      case DDS_XTypes_TK_STRUCTURE: {
        ...
        if (xt->_u.structure.base_type)
          ddsi_xt_get_typeid_impl(
            &xt->_u.structure.base_type->xt, &cstruct->header.base_type, DDSI_TYPEID_KIND_COMPLETE);

        get_type_detail(&cstruct->header.detail, &xt->_u.structure.detail);
        cstruct->member_seq._buffer =
          ddsrt_malloc(xt->_u.structure.members.length * sizeof(*cstruct->member_seq._buffer));
        ...
        for (uint32_t n = 0; n < xt->_u.structure.members.length; n++) {
          ...
          cstruct->member_seq._buffer[n].common.member_flags =
            xt->_u.structure.members.seq[n].flags;
          ddsi_xt_get_typeid_impl(
            &xt->_u.structure.members.seq[n].type->xt,
            &cstruct->member_seq._buffer[n].common.member_type_id, DDSI_TYPEID_KIND_COMPLETE);
          get_member_detail(
            &cstruct->member_seq._buffer[n].detail, &xt->_u.structure.members.seq[n].detail);
        }
        break;
      }
      case DDS_XTypes_TK_UNION: {
        ...
        ddsi_xt_get_typeid_impl(
          &xt->_u.union_type.disc_type->xt, &cunion->discriminator.common.type_id,
          DDSI_TYPEID_KIND_COMPLETE);
        cunion->discriminator.common.member_flags = xt->_u.union_type.disc_flags;
        cunion->member_seq._buffer =
          ddsrt_malloc(xt->_u.union_type.members.length * sizeof(*cunion->member_seq._buffer));
        ...
        for (uint32_t n = 0; n < xt->_u.union_type.members.length; n++) {
          ...
          cunion->member_seq._buffer[n].common.member_flags =
            xt->_u.union_type.members.seq[n].flags;
          ddsi_xt_get_typeid_impl(
            &xt->_u.union_type.members.seq[n].type->xt,
            &cunion->member_seq._buffer[n].common.type_id, DDSI_TYPEID_KIND_COMPLETE);
          cunion->member_seq._buffer[n].common.label_seq._length =
            xt->_u.union_type.members.seq[n].label_seq._length;
          cunion->member_seq._buffer[n].common.label_seq._buffer = ddsrt_memdup(
            xt->_u.union_type.members.seq[n].label_seq._buffer,
            xt->_u.union_type.members.seq[n].label_seq._length *
              sizeof(*xt->_u.union_type.members.seq[n].label_seq._buffer));
          cunion->member_seq._buffer[n].common.label_seq._release = true;
          get_member_detail(
            &cunion->member_seq._buffer[n].detail, &xt->_u.union_type.members.seq[n].detail);
        }
        break;
      }
      case DDS_XTypes_TK_BITSET: {
        ...
        cbitset->field_seq._buffer =
          ddsrt_malloc(xt->_u.bitset.fields.length * sizeof(*cbitset->field_seq._buffer));
        ...
        for (uint32_t n = 0; n < xt->_u.bitset.fields.length; n++) {
          ...
          cbitset->field_seq._buffer[n].common.holder_type =
            xt->_u.bitset.fields.seq[n].holder_type;
          get_member_detail(
            &cbitset->field_seq._buffer[n].detail, &xt->_u.bitset.fields.seq[n].detail);
        }
        break;
      }
      case DDS_XTypes_TK_SEQUENCE:
        ddsi_xt_get_typeid_impl(
          &xt->_u.seq.c.element_type->xt, &cto->_u.sequence_type.element.common.type,
          DDSI_TYPEID_KIND_COMPLETE);
      ...
      case DDS_XTypes_TK_ARRAY:
        ddsi_xt_get_typeid_impl(
          &xt->_u.array.c.element_type->xt, &cto->_u.array_type.element.common.type,
          DDSI_TYPEID_KIND_COMPLETE);
      ...
      case DDS_XTypes_TK_MAP:
        ddsi_xt_get_typeid_impl(
          &xt->_u.map.c.element_type->xt, &cto->_u.map_type.element.common.type,
          DDSI_TYPEID_KIND_COMPLETE);
        cto->_u.array_type.element.common.element_flags = xt->_u.map.c.element_flags;
        ddsi_xt_get_typeid_impl(
          &xt->_u.map.key_type->xt, &cto->_u.map_type.key.common.type, DDSI_TYPEID_KIND_COMPLETE);
      ...
      case DDS_XTypes_TK_ENUM: {
        ...
        cenum->literal_seq._buffer =
          ddsrt_malloc(xt->_u.enum_type.literals.length * sizeof(*cenum->literal_seq._buffer));
        ...
        for (uint32_t n = 0; n < xt->_u.enum_type.literals.length; n++) {
          ...
          get_member_detail(
            &cenum->literal_seq._buffer[n].detail, &xt->_u.enum_type.literals.seq[n].detail);
        }
        break;
      }
      case DDS_XTypes_TK_BITMASK: {
        ...
        cbitmask->flag_seq._buffer =
          ddsrt_malloc(xt->_u.bitmask.bitflags.length * sizeof(*cbitmask->flag_seq._buffer));
        ...
        for (uint32_t n = 0; n < xt->_u.bitmask.bitflags.length; n++) {
          ...
          get_member_detail(
            &cbitmask->flag_seq._buffer[n].detail, &xt->_u.bitmask.bitflags.seq[n].detail);
        }
        break;
      }
      default:
