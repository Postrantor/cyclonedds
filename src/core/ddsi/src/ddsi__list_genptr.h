...
#define DDSI_LIST_GENERIC_PTR_CODE(linkage_, prefix_, elemT_, equals_)                           \
  ...
  {                                                                                              \
    return (elemT_)generic_ptr_list_iter_first(                                                  \
      (struct generic_ptr_list *)list, (struct generic_ptr_list_iter *)iter);                    \
  }                                                                                              \
  ...
  {                                                                                              \
    return (elemT_)generic_ptr_list_iter_d_first(                                                \
      (struct generic_ptr_list *)list, (struct generic_ptr_list_iter_d *)iter);                  \
  }                                                                                              \
  ...
  {                                                                                              \
    return (elemT_)generic_ptr_list_remove(                                                      \
      (struct generic_ptr_list *)list, (void *)o, (generic_ptr_list_eq_fn)equals_);              \
  }                                                                                              \
