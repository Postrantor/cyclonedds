...
#define DDSI_VENDORID_INIT(vendor)       \
  {                                      \
    {                                    \
      0x01, DDSI_VENDORID_MINOR_##vendor \
    }                                    \
  }
#define DDSI_VENDORID_INIT_UNKNOWN \
  {                                \
    {                              \
      0x00, 0x00                   \
    }                              \
...
inline bool ddsi_vendor_is_adlink(ddsi_vendorid_t vendor)
{
  ...
  return (
    ddsi_vendor_equals(vendor, a) || ddsi_vendor_equals(vendor, b) ||
    ddsi_vendor_equals(vendor, c) || ddsi_vendor_equals(vendor, d) ||
