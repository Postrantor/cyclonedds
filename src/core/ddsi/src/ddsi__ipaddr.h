...
/** @component ip_address */
enum ddsi_locator_from_string_result ddsi_ipaddr_from_string(
  ddsi_locator_t * loc, const char * str, int32_t kind);

/** @component ip_address */
int ddsi_ipaddr_compare(const struct sockaddr * const sa1, const struct sockaddr * const sa2);

/** @component ip_address */
char * ddsi_ipaddr_to_string(
  char * dst, size_t sizeof_dst, const ddsi_locator_t * loc, int with_port,
