...
ddsi_time_t ddsi_wctime_to_ddsi_time(ddsrt_wctime_t t) { return to_ddsi_time(t.v); }
...
ddsi_duration_t ddsi_duration_from_dds(dds_duration_t x) { return to_ddsi_time(x); }

dds_duration_t ddsi_duration_to_dds(ddsi_duration_t x) { return from_ddsi_time(x); }
