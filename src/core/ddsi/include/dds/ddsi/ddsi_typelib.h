...
typedef enum ddsi_type_request { DDSI_TYPE_NO_REQUEST, DDSI_TYPE_SEND_REQUEST } ddsi_type_request_t;
...
DDS_EXPORT bool ddsi_typeinfo_equal(
  const ddsi_typeinfo_t * a, const ddsi_typeinfo_t * b, ddsi_type_include_deps_t deps);

/** @component type_system */
DDS_EXPORT ddsi_typeid_t * ddsi_typeinfo_typeid(
  const ddsi_typeinfo_t * type_info, ddsi_typeid_kind_t kind);
 ...
 */
DDS_EXPORT struct ddsi_type * ddsi_type_lookup(
