...
/* Construct a serdata from a fragchain received over the network
   ...
   - FIXME: get the encoding header out of the serialised data */
typedef struct ddsi_serdata * (*ddsi_serdata_from_ser_t)(
...
typedef struct ddsi_serdata * (*ddsi_serdata_from_ser_iov_t)(
  const struct ddsi_sertype * type, enum ddsi_serdata_kind kind, ddsrt_msg_iovlen_t niov,
  const ddsrt_iovec_t * iov, size_t size);

/* Construct a serdata from a keyhash (an SDK_KEY by definition) */
typedef struct ddsi_serdata * (*ddsi_serdata_from_keyhash_t)(
  const struct ddsi_sertype * type, const struct ddsi_keyhash * keyhash);
...
typedef struct ddsi_serdata * (*ddsi_serdata_from_sample_t)(
  const struct ddsi_sertype * type, enum ddsi_serdata_kind kind, const void * sample);
...
/* Fill buffer with 'size' bytes of serialised data, starting from 'off'
   ...
   - FIXME: get the encoding header out of the serialised data */
typedef void (*ddsi_serdata_to_ser_t)(
  const struct ddsi_serdata * d, size_t off, size_t sz, void * buf);
...
typedef struct ddsi_serdata * (*ddsi_serdata_to_ser_ref_t)(
  const struct ddsi_serdata * d, size_t off, size_t sz, ddsrt_iovec_t * ref);
...
/* Turn serdata into an application sample (or just the key values if only key values are
   ...
   by the caller.) */
typedef bool (*ddsi_serdata_to_sample_t)(
...
typedef bool (*ddsi_serdata_untyped_to_sample_t)(
  const struct ddsi_sertype * type, const struct ddsi_serdata * d, void * sample, void ** bufptr,
  void * buflim);
...
typedef size_t (*ddsi_serdata_print_t)(
  const struct ddsi_sertype * type, const struct ddsi_serdata * d, char * buf, size_t size);
...
typedef void (*ddsi_serdata_get_keyhash_t)(
  const struct ddsi_serdata * d, struct ddsi_keyhash * buf, bool force_md5);
...
typedef struct ddsi_serdata * (*ddsi_serdata_from_iox_t)(
  const struct ddsi_sertype * type, enum ddsi_serdata_kind kind, void * sub, void * buffer);
#endif
...
DDS_EXPORT void ddsi_serdata_init(
  struct ddsi_serdata * d, const struct ddsi_sertype * tp, enum ddsi_serdata_kind kind);
 ...
 *   ddsi_serdata_unref.
 */
struct ddsi_serdata * ddsi_serdata_ref_as_type(
  const struct ddsi_sertype * type, struct ddsi_serdata * serdata);

/** @component typesupport_if */
DDS_INLINE_EXPORT inline struct ddsi_serdata * ddsi_serdata_ref(
...
{
  if (ddsrt_atomic_dec32_ov(&serdata->refc) == 1) serdata->ops->free(serdata);
}
...
/** @component typesupport_if */
DDS_INLINE_EXPORT inline struct ddsi_serdata * ddsi_serdata_from_ser(
  const struct ddsi_sertype * type, enum ddsi_serdata_kind kind,
  const struct ddsi_rdata * fragchain, size_t size)
{
...
/** @component typesupport_if */
DDS_INLINE_EXPORT inline struct ddsi_serdata * ddsi_serdata_from_ser_iov(
  const struct ddsi_sertype * type, enum ddsi_serdata_kind kind, ddsrt_msg_iovlen_t niov,
  const ddsrt_iovec_t * iov, size_t size)
{
...
/** @component typesupport_if */
DDS_INLINE_EXPORT inline struct ddsi_serdata * ddsi_serdata_from_keyhash(
  const struct ddsi_sertype * type, const struct ddsi_keyhash * keyhash)
{
...
/** @component typesupport_if */
DDS_INLINE_EXPORT inline struct ddsi_serdata * ddsi_serdata_from_sample(
  const struct ddsi_sertype * type, enum ddsi_serdata_kind kind, const void * sample)
{
...
/** @component typesupport_if */
DDS_INLINE_EXPORT inline struct ddsi_serdata * ddsi_serdata_to_untyped(
...
/** @component typesupport_if */
DDS_INLINE_EXPORT inline void ddsi_serdata_to_ser(
  const struct ddsi_serdata * d, size_t off, size_t sz, void * buf)
{
...
/** @component typesupport_if */
DDS_INLINE_EXPORT inline struct ddsi_serdata * ddsi_serdata_to_ser_ref(
  const struct ddsi_serdata * d, size_t off, size_t sz, ddsrt_iovec_t * ref)
{
...
/** @component typesupport_if */
DDS_INLINE_EXPORT inline void ddsi_serdata_to_ser_unref(
  struct ddsi_serdata * d, const ddsrt_iovec_t * ref)
{
  d->ops->to_ser_unref(d, ref);
}

/** @component typesupport_if */
DDS_INLINE_EXPORT inline bool ddsi_serdata_to_sample(
  const struct ddsi_serdata * d, void * sample, void ** bufptr, void * buflim)
{
...
/** @component typesupport_if */
DDS_INLINE_EXPORT inline bool ddsi_serdata_untyped_to_sample(
  const struct ddsi_sertype * type, const struct ddsi_serdata * d, void * sample, void ** bufptr,
  void * buflim)
{
...
/** @component typesupport_if */
DDS_INLINE_EXPORT inline bool ddsi_serdata_eqkey(
  const struct ddsi_serdata * a, const struct ddsi_serdata * b)
{
  return a->ops->eqkey(a, b);
}

/** @component typesupport_if */
DDS_INLINE_EXPORT inline bool ddsi_serdata_print(
  const struct ddsi_serdata * d, char * buf, size_t size)
{
  return d->ops->print(d->type, d, buf, size);
}

/** @component typesupport_if */
DDS_INLINE_EXPORT inline bool ddsi_serdata_print_untyped(
  const struct ddsi_sertype * type, const struct ddsi_serdata * d, char * buf, size_t size)
{
  if (d->ops->print)
...
/** @component typesupport_if */
DDS_INLINE_EXPORT inline void ddsi_serdata_get_keyhash(
  const struct ddsi_serdata * d, struct ddsi_keyhash * buf, bool force_md5)
{
...
inline struct ddsi_serdata * ddsi_serdata_from_iox(
  const struct ddsi_sertype * type, enum ddsi_serdata_kind kind, void * sub,
  void * iox_buffer) ddsrt_nonnull_all;

/** @component typesupport_if */
DDS_INLINE_EXPORT inline struct ddsi_serdata * ddsi_serdata_from_iox(
  const struct ddsi_sertype * type, enum ddsi_serdata_kind kind, void * sub, void * iox_buffer)
{
  return type->serdata_ops->from_iox_buffer(type, kind, sub, iox_buffer);
}

inline struct ddsi_serdata * ddsi_serdata_from_loaned_sample(
  const struct ddsi_sertype * type, enum ddsi_serdata_kind kind,
  const char * sample) ddsrt_nonnull_all;

/** @component typesupport_if */
DDS_INLINE_EXPORT inline struct ddsi_serdata * ddsi_serdata_from_loaned_sample(
  const struct ddsi_sertype * type, enum ddsi_serdata_kind kind, const char * sample)
{
